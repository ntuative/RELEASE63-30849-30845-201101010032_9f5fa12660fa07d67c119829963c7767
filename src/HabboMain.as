package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_823:Number = 0.71;
      ...
      private var var_1201:HabboTracking;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_999,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_999,error);
            Core.dispose();
         }
      }
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1201 = HabboTracking.getInstance();
         ...
         {
            _loc1_.addEventListener(AssetLoaderEvent.const_30,this.configLoadedHandler);
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_30,this.configLoadedHandler);
         ...
         {
            Habbo.reportCrash("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_290,null);
         }
      }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.reportCrash("Download external configuration document is null!",Core.const_290,null);
         }
         if(this.var_22)
         {
         ...
         {
            Habbo.reportCrash("Core vanished while downloading config document!",Core.const_290,null);
         }
      }
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1201 && !this.var_1201.disposed)
                  {
                     this.var_1201.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_823 + this.var_22.getNumberOfFilesLoaded() / _loc11_ * const_823;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
