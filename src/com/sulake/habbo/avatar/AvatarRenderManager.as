package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1840:String = "hd-99999-99999";
      ...
      private var var_300:PetDataManager;
      
      private var var_663:PaletteManager;
      
      private var var_583:String;
      
      private var var_265:Map;
      
      private var var_195:AvatarAssetDownloadManager;
      
      private var var_1551:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_583 = RenderMode.const_1528;
         ...
         _loc4_ = new AvatarStructure(this,AvatarType.const_63,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_93.add(AvatarType.const_63,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_300 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_663 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_300.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_195)
         {
            this.var_195.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         _loc2_ = this.var_93.getValue(AvatarType.const_63) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(this.var_195 == null)
               {
                  ...
                  this.var_195 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_195.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_853)
         {
            if(this.var_2111 && this.var_2113 && this.var_2112)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_195.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_195.loadFigureSetData(param1,param2);
      }
      ...
      public function createAvatarImage(param1:String, param2:String, param3:String = null, param4:IAvatarImageListener = null) : IAvatarImage
      {
         ...
         if(this.var_195.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1551)
         {
            this.var_1551 = new AvatarFigureContainer(this.const_1840);
         }
         this.var_195.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1551,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_265 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_265.getKeys())
         {
            _loc4_ = this.var_265.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         ...
         {
            _loc6_ = !this.var_300.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_300.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_93.getValue(AvatarType.const_63) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_265.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_300.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_93.getValue(AvatarType.const_63);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_265.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_265.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         return this.var_300 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_105:
               _loc3_ = this.var_93.getValue(AvatarType.const_105) as AvatarStructure;
               break;
            case AvatarType.const_63:
               _loc3_ = this.var_93.getValue(AvatarType.const_63) as AvatarStructure;
               break;
            default:
