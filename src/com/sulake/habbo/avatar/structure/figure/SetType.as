package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2580 = parseInt(param1.@paletteid);
         this.var_611 = new Dictionary();
         this.var_611["F"] = new Dictionary();
         this.var_611["M"] = new Dictionary();
         this.var_611["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_611["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_611["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_611["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_611[param1.toUpperCase()][Math.min(param2,1)];
      }
