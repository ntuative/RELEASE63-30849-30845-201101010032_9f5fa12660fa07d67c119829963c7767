package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1186:String = "Default";
      
      private static const const_1187:int = 2;
      
      private static const const_1185:String = AvatarSetType.const_33;
      ...
      protected var var_687:Boolean;
      
      private var var_888:IActiveActionData;
      ...
      private var var_597:AvatarFigureContainer;
      
      private var var_598:Boolean;
      
      private var var_178:Array;
      
      private var var_516:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_597 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_597.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1348 = this.var_1347;
         this.var_228 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1185,const_1187);
         this.var_292 = new Array();
         this.var_888 = new ActiveActionData(AvatarAction.const_355);
         this.var_888.definition = this._structure.getActionDefinition(const_1186);
         this.resetActions();
      }
      ...
      {
         return this._structure.getPartColor(this.var_597,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += this.var_1704;
         if(param2 < AvatarDirectionAngle.const_910)
         {
            param2 = AvatarDirectionAngle.const_293 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_293)
         {
            param2 -= NaN;
         }
         if(param1 == AvatarSetType.const_43)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1348);
            if(_loc3_ != null)
            {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_599,param1.id);
      }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_259.definition.geometryType);
         if(this.var_39 == null || _loc4_ != null && (this.var_39.width != _loc4_.width || this.var_39.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_259.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
            this.var_39 = new BitmapData(_loc4_.width,_loc4_.height,true,16777215);
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_599);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_597,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1348 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_599);
                  _loc20_ = this.var_84;
                  _loc21_ = 1;
                  switch(this.var_84)
                  {
               ...
               this.var_39.copyPixels(_loc10_,_loc10_.rect,_loc11_.add(_loc6_),null,null,true);
            }
            _loc7_--;
         }
         this.var_39.unlock();
         ...
         {
            if(this.var_516.paletteIsGrayscale)
            {
               _loc23_ = this.convertToGrayscale(this.var_39);
               if(this.var_39)
               {
                  this.var_39.dispose();
               }
               this.var_39 = _loc23_;
               this.var_39.paletteMap(this.var_39,this.var_39.rect,new Point(0,0),this.var_516.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_599);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_597,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_82)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_599);
                  _loc21_ = this.var_84;
                  _loc22_ = 1;
                  switch(this.var_84)
                  {
         ...
         switch(param1)
         {
            case AvatarAction.const_326:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1406:
                  case AvatarAction.const_1411:
            ...
            case AvatarAction.const_269:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1107:
                  case AvatarAction.const_1081:
                  case AvatarAction.const_1082:
                  case AvatarAction.const_1059:
                     this.addActionData(_loc3_);
                     break;
                  default:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_292.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_516 = null;
         this.var_1704 = 0;
         this.var_259 = this.var_888;
         this.var_259.definition = this.var_888.definition;
         this.setActionToParts(this.var_888);
         this.getCache().resetBodyPartCache(this.var_888);
         return true;
      }
      ...
      {
         this.var_1346 = true;
         if(this.var_1387 == this.var_486)
         {
            return;
         }
         this.var_1387 = this.var_486;
         this.var_1345 = this._structure.sortActions(this.var_292);
         if(this.var_1345 == null)
         {
            this.var_689 = new Array(0,0,0);
         }
         else
         {
            this.var_689 = this._structure.getCanvasOffsets(this.var_1345,this._scale,this.var_84);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1345)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_178 = this.var_178.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1704 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_516 = _loc2_.avatarData;
                     }
                  }
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_235)
               {
                  this.var_887 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1347 = _loc4_.id;
                     this.var_1703 = _loc4_.breed;
                     break;
                  }
               }
            }
