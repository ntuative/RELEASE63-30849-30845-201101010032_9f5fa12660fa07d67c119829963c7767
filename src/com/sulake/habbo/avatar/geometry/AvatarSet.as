package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      private var var_1002:Dictionary;
      
      private var var_1557:Array;
      
      private var var_2127:Array;
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2126 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1002 = new Dictionary();
         this.var_1557 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1002[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_1557.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1557.concat();
         for each(_loc3_ in this.var_1002)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2127 = _loc6_;
      }
      ...
      public function get isMain() : Boolean
      {
         ...
         for each(_loc1_ in this.var_1002)
         {
            if(_loc1_.isMain)
            {
               return true;
