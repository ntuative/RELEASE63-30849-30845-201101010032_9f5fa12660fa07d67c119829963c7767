package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_232)
         {
            for each(_loc2_ in this.var_232 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_193 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_819 >= 0 && this._parts.length > this.var_819)
         {
            _loc2_ = this._parts[this.var_819];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_193[param2],param2);
         this.var_193[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_193 || this.var_193.length == 0)
         {
            return null;
         }
         if(!this.var_232 || this.var_232.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_232[0] as Array;
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_193.length)
         {
            _loc7_ = this.var_232[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_193[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_193[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_193[param1])
         {
            return null;
         }
         return _loc2_[this.var_193[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_232.length <= param1)
         {
            return null;
         }
         return this.var_232[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_819] as AvatarEditorGridPartItem;
      }
