package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      protected var var_33:Dictionary;
      
      protected var var_133:String = "";
      
      protected var var_40:String = "";
      
      protected var var_62:IAvatarEditorCategoryModel;
      
      protected var var_174:Boolean;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            for each(_loc1_ in this.var_33)
            {
               _loc1_.dispose();
               _loc1_ = null;
            }
      ...
      public function showPalettes(param1:String, param2:int) : void
      {
         ...
         var _loc3_:AvatarEditorGridView = this.var_33[param1] as AvatarEditorGridView;
         if(!_loc3_)
         {
            return;
         }
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_1894);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_33[this.var_133];
         if(_loc2_ == null)
         {
            return;
         }
