package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_897:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_719.width,this.var_719.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_719,this.var_719.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1086.width,this.var_1086.height,true,0);
            _loc5_ = this.var_1086.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_897.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_896.width,this.var_896.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_896,this.var_896.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_897)
            {
               switch(this.var_897.clubLevel)
               {
                  case HabboClubLevelEnum.const_46:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_58:
                     _loc4_.style = HabboIconType.const_621;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_53:
                     _loc4_.style = HabboIconType.const_692;
                     _loc4_.visible = true;
               }
            }
            else
