package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_1931:int;
      
      protected var var_259:IActiveActionData;
      
      protected var var_687:Boolean;
      
      protected var var_689:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_228:AvatarImageCache;
      
      protected var var_597:AvatarFigureContainer;
      
      protected var var_516:IAvatarDataContainer;
      ...
      private var var_2504:String = null;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_687)
         {
            ...
            if(this.var_722)
            {
               for each(_loc2_ in this.var_722)
               {
                  _loc2_.dispose();
               }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_43 || param1 == AvatarSetType.const_33)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_285.length == 1 && this.var_84 == this.var_1931)
         {
            return this.var_84 + this.var_486 + this.var_599 % 4;
         }
         if(this.var_285.length == 2)
         {
            for each(_loc1_ in this.var_285)
            {
               ...
               {
                  return this.var_84 + this.var_486 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_599 % 11;
                  return this.var_84 + "_" + this.var_1931 + this.var_486 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2505 || param2 != this.var_2506 || param1 != this.var_2504)
         {
            this.var_2505 = param3;
            this.var_2506 = param2;
            this.var_2504 = param1;
            this.var_1771 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1197 || this.var_39 == null || (this.var_39.width != _loc5_.width || this.var_39.height != _loc5_.height))
         {
            if(this.var_39 != null && !this.var_1197)
            {
               this.var_39.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_599);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_599);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_292.push(new ActiveActionData(param1,param2,this.var_599));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_888);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_486 = "";
         this.var_285 = this._structure.sortActions(this.var_292);
         if(this.var_285 == null)
         {
         ...
         {
            this.var_689 = this._structure.getCanvasOffsets(this.var_285,this._scale,this.var_84);
            for each(_loc4_ in this.var_285)
            {
               this.var_486 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_302)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1386 != _loc5_)
                  {
                     _loc2_ = true;
                  }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_285)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_887 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_271 || _loc1_.actionType == AvatarAction.const_235 || _loc1_.actionType == AvatarAction.const_381)
               {
                  this.var_887 = true;
               }
            }
