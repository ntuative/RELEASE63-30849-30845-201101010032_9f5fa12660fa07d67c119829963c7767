package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1177:IWindowContainer;
      
      public static var var_1440:IWindowContainer;
      
      public static var var_1894:int = 6710886;
      ...
      private var var_447:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_446:IFrameWindow;
      
      private var var_373:Timer;
      
      private var var_2199:Number = 0;
      
      private var var_2200:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1024 = [];
         this.var_1204 = [AvatarEditorFigureCategory.const_686,AvatarEditorFigureCategory.const_43,AvatarEditorFigureCategory.const_218,AvatarEditorFigureCategory.const_756,AvatarEditorFigureCategory.const_1106,AvatarEditorFigureCategory.const_100];
         super();
         ...
         if(var_1177 == null)
         {
            ...
            var_1177 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1440 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1440 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_373 = new Timer(1000);
         this.var_373.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1204;
         }
         for each(_loc6_ in param4)
         {
            this.var_1024.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_373.stop();
            this.var_373.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_373 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1204);
         }
         if(param1.length != this.var_1024.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1024.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2200 = this.canChangeOutfit();
            this.var_373.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_447 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_447.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_447.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1024.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_447.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_447.numSelectables)
               {
                  this.var_447.getSelectableAt(_loc6_).x = this.var_447.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1204;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1594 == AvatarEditorSideCategory.const_100 || this.var_2198))
         {
         ...
         this.setViewToCategory(this.var_311);
      }
      ...
      {
         if(this.var_1594 == AvatarEditorSideCategory.const_100)
         {
            this.var_2198 = false;
            this.setSideContent(AvatarEditorSideCategory.const_597);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_100);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_597:
               break;
            case AvatarEditorSideCategory.const_495:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_495);
               break;
            case AvatarEditorSideCategory.const_100:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_100);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_311 = param1;
         this.var_447.setSelected(this.var_447.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_446)
         {
            ...
            this.var_446 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_446.procedure = this.stripClubDialogEventProc;
            this.var_446.center();
         }
         else
         {
