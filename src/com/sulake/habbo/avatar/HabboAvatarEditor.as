package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1147:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1148:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_982:AvatarEditorHandler;
      ...
      private var var_809:IFigureData;
      ...
      private function init() : void
      {
         ...
         if(!this.var_174)
         {
            ...
            this.var_536["null"] = new FigureData(this);
            this.var_536["null"] = new FigureData(this);
            _loc1_ = this.var_536["null"];
            _loc2_ = this.var_536["null"];
            _loc1_.loadAvatarData(const_1147,FigureData.const_74);
            _loc2_.loadAvatarData(const_1148,FigureData.FEMALE);
            this.var_92 = new Map();
            this.var_432 = new Map();
            this.var_92.add(AvatarEditorFigureCategory.const_686,new BodyModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_43,new HeadModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_218,new TorsoModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_756,new LegsModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_1106,new HotLooksModel(this));
            this.var_432.add(AvatarEditorSideCategory.const_100,new WardrobeModel(this));
            this.var_432.add(AvatarEditorSideCategory.const_495,new ClubPromoModel(this));
            this.var_174 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         this.var_983 = param3;
         var _loc4_:FigureData = this.var_536[param2];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_92)
         {
            for each(_loc5_ in this.var_92)
            {
               _loc5_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_809.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_809.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_229 == null)
            {
               this.var_229 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_54,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_229.addChild(this._view.window);
               if(param5)
               {
                  this.var_229.center();
               }
            ...
            this.var_229.visible = !this.var_229.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_686);
         }
         this.var_1248 = param2;
         return true;
      }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_92.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_432.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_431 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_809 = this.var_431.getFigureData(AvatarType.const_105);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_982 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_536[this.var_907];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1248 != null)
         {
            ...
            this.var_1248.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1524;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_983 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1146)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1440.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_431.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_431.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1177.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_983 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1177.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function hasInvalidClubItems() : Boolean
      {
         ...
         for each(_loc2_ in this.var_92)
         {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_983 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_432.getValue(AvatarEditorSideCategory.const_100);
      }
