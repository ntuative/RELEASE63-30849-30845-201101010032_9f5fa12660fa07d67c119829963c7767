   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_230,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_256,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_62 && var_133 == "")
         {
            var_62.switchCategory(FigureData.TROUSERS);
         }
      }
