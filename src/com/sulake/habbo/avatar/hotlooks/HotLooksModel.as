package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1642:String = "hot_looks";
      
      public static const const_1742:String = "my_looks";
      ...
      {
         super(param1);
         this.var_485 = new Dictionary();
         this.var_485["null"] = new Array();
         this.var_485["null"] = new Array();
         this.var_485["undefined.index"] = 0;
         this.var_485["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_485["null"];
      ...
      private function requestHotLooks() : void
      {
         ...
         _loc3_.addEventListener(AssetLoaderEvent.const_30,this.onHotLooksConfiguration);
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_485[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
