package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_62:HotLooksModel;
      
      private var var_575:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_575 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_575.numGridItems > 0)
         {
            this.var_575.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_62 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_575.removeGridItems();
         for each(_loc2_ in this.var_62.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_575.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_575.getGridItemIndex(param2.parent);
            this.var_62.selectHotLook(_loc3_);
         }
      }
