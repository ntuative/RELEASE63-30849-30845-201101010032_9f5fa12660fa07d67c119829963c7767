package com.sulake.habbo.avatar.pets
{
   public class Breed extends PetEditorInfo implements IBreed
   {
      ...
      private var var_2014:Boolean = true;
      ...
      public function Breed(param1:XML)
      {
         ...
         this.var_2012 = parseInt(param1.@pattern);
         this.var_907 = String(param1.@gender);
         this.var_1277 = Boolean(parseInt(param1.@colorable));
         this.var_2011 = String(param1.@localizationKey);
