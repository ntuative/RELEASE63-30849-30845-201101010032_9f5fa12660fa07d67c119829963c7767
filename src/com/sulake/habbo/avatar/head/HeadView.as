   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_182,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_239,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_243,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_219,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_228,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_62 && var_133 == "")
         {
            var_62.switchCategory(FigureData.const_182);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_hair":
                  this.switchCategory(FigureData.const_182);
                  break;
               case "tab_hat":
                  this.switchCategory(FigureData.const_239);
                  break;
