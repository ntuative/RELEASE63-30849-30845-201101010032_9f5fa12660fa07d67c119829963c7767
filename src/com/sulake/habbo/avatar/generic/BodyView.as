   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_62.controller.gender)
         {
            case FigureData.const_74:
               activateTab(this.const_548);
               inactivateTab(this.const_549);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_549);
               inactivateTab(this.const_548);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_548:
                  var_62.controller.gender = FigureData.const_74;
