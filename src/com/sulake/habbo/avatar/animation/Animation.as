package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1569:AvatarDataContainer;
      
      private var var_1270:Array;
      
      private var var_1568:DirectionDataContainer;
      
      private var var_1567:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1513 = String(param2.@desc);
         }
         else
         {
            this.var_1513 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1269.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1569 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1270.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1568 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1567 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1268.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_667.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.name_3)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@name_3;
               this.var_546.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_755,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
            for each(_loc9_ in _loc7_.fx)
            {
               _loc5_ = param3.getActionDefinition(String(_loc9_.@action));
               _loc11_ = new AnimationLayerData(param3,_loc9_,AnimationLayerData.const_529,_loc6_,_loc5_);
               _loc4_.push(_loc11_);
               if(_loc5_ != null)
               {
               }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_546.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_755)
            {
               _loc3_.push(_loc4_.id);
            }
            else if(_loc4_.type == AnimationLayerData.const_529)
            {
               for each(_loc5_ in this.var_667)
               {
      ...
      public function getLayerData(param1:int, param2:String, param3:String = null) : AnimationLayerData
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param3))
         {
            ...
            if(_loc4_.type == AnimationLayerData.const_529)
            {
               for each(_loc5_ in this.var_667)
               {
