package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1734:Number = 1.0;
      
      private var var_1736:Number = 1.0;
      
      private var var_1735:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1125:Map;
      
      private var var_2527:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_1788 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2526 = parseInt(_loc2_,16);
         this.var_2525 = parseInt(_loc3_,16);
         ...
         this.var_1786 = new ColorTransform(this.var_1734,this.var_1736,this.var_1735,this._alphaMultiplier);
         this.var_1125 = this.generatePaletteMapForGrayscale(this.var_2525,this.var_2526);
      }
      ...
      {
         return this.var_1125.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1125.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1125.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1125.getValue("alphas") as Array;
      }
