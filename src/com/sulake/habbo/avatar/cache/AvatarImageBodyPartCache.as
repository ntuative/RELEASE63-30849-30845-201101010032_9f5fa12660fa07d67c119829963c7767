package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageBodyPartCache
   {
      ...
      private var var_713:IActiveActionData;
      ...
      public function setAction(param1:IActiveActionData, param2:int) : void
      {
         ...
         var _loc3_:AvatarImageActionCache = this.getActionCache(this.var_713);
         if(_loc3_ != null)
         {
      ...
      public function disposeActions(param1:int, param2:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc6_:* = null;
         if(this.var_228 == null || this._disposed)
         {
            return;
         }
         var _loc5_:Array = this.var_228.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_228.getValue(_loc6_) as AvatarImageActionCache;
            if(_loc4_ != null)
            {
      ...
      public function getActionCache(param1:IActiveActionData = null) : AvatarImageActionCache
      {
         ...
         return this.var_228.getValue(param1.id) as AvatarImageActionCache;
      }
      
      public function updateActionCache(param1:IActiveActionData, param2:AvatarImageActionCache) : void
      {
         this.var_228.add(param1.id,param2);
      }
