   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_33)
         {
            ...
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_257,_windowManager,_assetLibrary);
            var_33["null"] = new AvatarEditorGridView(var_62,FigureData.const_172,_windowManager,_assetLibrary);
         ...
         if(var_62 && var_133 == "")
         {
            var_62.switchCategory(FigureData.const_172);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_jacket":
                  this.switchCategory(FigureData.const_257);
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_172);
                  break;
