package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_25:IHabboCommunicationManager;
      
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         this._inventory = param1;
         this.var_25 = this._inventory.communication;
         this.var_25.addHabboConnectionMessageEvent(new FurniListEvent(this.onFurniList));
         this.var_25.addHabboConnectionMessageEvent(new FurniListInsertEvent(this.onFurniListInsert));
         this.var_25.addHabboConnectionMessageEvent(new FurniListRemoveEvent(this.onFurniListRemove));
         this.var_25.addHabboConnectionMessageEvent(new FurniListUpdateEvent(this.onFurniListUpdate));
         this.var_25.addHabboConnectionMessageEvent(new PostItPlacedEvent(this.onPostItPlaced));
         this.var_25.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(this.onAvatarEffects));
         this.var_25.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(this.onAvatarEffectActivated));
         this.var_25.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(this.onAvatarEffectAdded));
         this.var_25.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(this.onAvatarEffectExpired));
         this.var_25.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(this.onClubStatus));
         this.var_25.addHabboConnectionMessageEvent(new BadgesEvent(this.onBadges));
         this.var_25.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(this.onUserBadges));
         this.var_25.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(this.onAchievementReceived));
         this.var_25.addHabboConnectionMessageEvent(new BadgePointLimitsEvent(this.onBadgePointLimits));
         this.var_25.addHabboConnectionMessageEvent(new AchievementsEvent(this.onAchievements));
         this.var_25.addHabboConnectionMessageEvent(new AchievementsScoreEvent(this.onAchievementsScore));
         this.var_25.addHabboConnectionMessageEvent(new TradingAcceptEvent(this.onTradingAccepted,TradingAcceptParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingConfirmationEvent(this.onTradingConfirmation,TradingConfirmationParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(this.onTradingAlreadyOpen,TradingAlreadyOpenParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingCloseEvent(this.onTradingClose,TradingCloseParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingCompletedEvent(this.onTradingCompleted,TradingCompletedParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingItemListEvent(this.onTradingItemList,TradingItemListParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingNotOpenEvent(this.onTradingNotOpen,TradingNotOpenParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingOpenEvent(this.onTradingOpen,TradingOpenParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(this.onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         this.var_25.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(this.onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         this.var_25.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(this.onRoomClosed));
         this.var_25.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(this.onRoomClosed));
         this.var_25.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(this.onRoomClosed));
         this.var_25.addHabboConnectionMessageEvent(new PetInventoryEvent(this.onPets));
         this.var_25.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(this.onPetAdded));
         this.var_25.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(this.onPetRemoved));
         this.var_25.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(this.onPetInventoryUpdated));
         this.var_25.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(this.onMarketplaceConfiguration));
         this.var_25.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(this.onMarketplaceCanMakeOfferResult));
         this.var_25.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(this.onMarketplaceMakeOfferResult));
         this.var_25.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(this.onMarketplaceItemStats));
         this.var_25.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(this.onNotEnoughCredits));
         this.var_25.addHabboConnectionMessageEvent(new UserRightsMessageEvent(this.onUserRights));
      }
      ...
      private function getConnection() : IConnection
      {
         ...
         return this.var_25.getHabboMainConnection(null);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_78);
         ...
         if(_loc4_.getSelectedItemIndex(FurniModel.const_45) == -1)
         {
            _loc4_.toggleItemSelection(FurniModel.const_45,0);
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_78,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_780);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_262);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_373);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this._inventory.toggleInventorySubPage(InventorySubCategory.const_278);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_142)
            {
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_45,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_157);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_352);
         var _loc4_:FurniModel = this._inventory.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_352))
         {
