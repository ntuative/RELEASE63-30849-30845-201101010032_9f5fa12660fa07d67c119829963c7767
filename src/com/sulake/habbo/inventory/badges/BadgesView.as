package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1146:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1147 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1147.procedure = this.inactiveGridEventProc;
         this.var_1146 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1146.procedure = this.activeGridEventProc;
      }
      ...
      private function updateListViews() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               this.var_1147.addGridItem(_loc2_.window);
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            this.var_1146.addGridItem(_loc2_.window);
      ...
      private function updateActionView() : void
      {
         ...
         else
         {
            ...
            this.setBadgeName(this.var_62.controller.localization.getBadgeName(_loc2_.type));
            this.setBadgeDescriptionText(this.var_62.controller.localization.getBadgeDesc(_loc2_.type));
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_1147.getGridItemIndex(param1.window);
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = this.var_1146.getGridItemIndex(param1.window);
