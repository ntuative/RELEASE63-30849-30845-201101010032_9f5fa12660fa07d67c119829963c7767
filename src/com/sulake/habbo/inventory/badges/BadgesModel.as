package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1856:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_863.length)
         {
            if(this.var_863[_loc2_] == param1)
            {
               this.var_863.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_370.getBadgeImage(param1);
      ...
      private function getBadge(param1:String) : Badge
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_239.length)
         {
            _loc3_ = this.var_239[_loc2_];
      ...
      public function setBadgeSelected(param1:String) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_239.length)
         {
            _loc2_ = this.var_239[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_239.length)
               {
                  if((this.var_239[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_239[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_262 && this._controller.isVisible)
         {
