package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1864:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_46)
         {
            _loc1_ = this.var_46.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_46.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_17 != null)
         {
            this.var_17.events.removeEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_484,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_46.getValue(InventoryCategory.const_78));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_46.getValue(InventorySubCategory.const_278));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_46.getValue(InventoryCategory.const_780));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_46.getValue(InventoryCategory.const_262));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_46.getValue(InventoryCategory.const_373));
      }
      
      public function get recyclerModel() : RecyclerModel
      {
         return RecyclerModel(this.var_46.getValue(InventorySubCategory.RECYCLER));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(this.var_46.getValue(InventoryCategory.const_157));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_46.getValue(InventoryCategory.const_352) as MarketplaceModel;
      }
      ...
      {
         return this.var_110.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_110.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_110.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_110.clubHasEverBeenMember;
      }
      ...
      {
         this.var_110.clubPeriods = param1;
         this.var_110.clubDays = param2;
         this.var_110.clubHasEverBeenMember = param3;
         this.var_110.isVIP = param4;
      ...
      {
         this.var_370 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      {
         this.var_17 = IRoomSessionManager(param2);
         this.var_17.events.addEventListener(RoomSessionEvent.const_81,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_484,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_89:
               this.var_1089 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_484:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_370 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_17 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_46.add(InventoryCategory.const_352,_loc1_);
         ...
         this.var_46.add(InventoryCategory.const_78,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_370);
         this.var_46.add(InventoryCategory.const_262,_loc3_);
         ...
         this.var_46.add(InventoryCategory.const_780,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_370);
         this.var_46.add(InventoryCategory.const_373,_loc5_);
         ...
         this.var_46.add(InventorySubCategory.const_278,_loc6_);
         ...
         this.var_46.add(InventorySubCategory.RECYCLER,_loc7_);
         ...
         this.var_46.add(InventoryCategory.const_157,_loc8_);
         this.var_174 = true;
         if(this.var_2427)
         {
            this.requestData();
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_46.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_46.length)
         {
            _loc3_ = this.var_46.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_278:
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = this.var_46.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_899.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_899.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_899.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_899.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:IInventoryModel = this.var_46.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1864);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_964));
      }
