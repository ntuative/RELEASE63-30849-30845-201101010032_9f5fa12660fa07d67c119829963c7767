package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      private var var_639:ThumbListManager;
      
      private var var_640:ThumbListManager;
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         this.var_639 = new ThumbListManager(this._assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
         this.var_640 = new ThumbListManager(this._assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
         ...
         _loc11_.procedure = this.method_5;
         this._view.procedure = this.windowEventProc;
      }
      ...
      public function updateListViews() : void
      {
         ...
         this.var_640.updateImageFromList();
         this.var_639.updateImageFromList();
         var _loc1_:IBitmapWrapperWindow = this._view.findChildByName("inactive_items_image") as IBitmapWrapperWindow;
         var _loc2_:BitmapData = this.var_640.getListImage();
         ...
         var _loc4_:BitmapData = this.var_639.getListImage();
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:Effect = this.var_62.getSelectedEffect(-1);
         if(_loc3_ == null)
         {
            _loc1_.disable();
      ...
      private function activeThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc4_ = this.var_639.resolveIndexFromImageLocation(_loc3_);
            _loc5_ = this.var_62.getItemInIndex(_loc4_,1);
            if(_loc5_ != null)
            {
               this.var_62.toggleEffectSelected(_loc5_.type);
            }
         }
      }
      ...
      private function method_5(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = new Point(WindowMouseEvent(param1).localX,WindowMouseEvent(param1).localY);
            _loc4_ = this.var_640.resolveIndexFromImageLocation(_loc3_);
            _loc5_ = this.var_62.getItemInIndex(_loc4_,0);
            if(_loc5_ != null)
            {
               this.var_62.toggleEffectSelected(_loc5_.type);
            }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = this.var_62.getSelectedEffect(0);
               if(_loc3_ != null)
               {
                  this.var_62.requestEffectActivated(_loc3_.type);
               }
            }
         }
      }
