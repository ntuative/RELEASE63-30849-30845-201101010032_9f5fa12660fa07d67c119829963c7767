package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1876:int = 0;
      
      private const const_864:int = 1;
      
      private const const_1566:int = 2;
      
      private const const_1565:int = 3;
      
      private const const_1567:int = 42;
      
      private const const_1564:int = 120;
      ...
      private var var_649:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_451.add(FurniModel.const_41,new FurniGridView(this.var_62,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_451.add(FurniModel.const_45,new FurniGridView(this.var_62,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.switchCategory(FurniModel.const_41);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_62.isTradingOpen;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModel.const_45:
               ...
               this.var_374 = FurniModel.const_45;
               break;
            case FurniModel.const_41:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_374 = FurniModel.const_41;
               break;
            case FurniModel.const_364:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_374 = FurniModel.const_364;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_62.furniCategorySwitch();
         this.showCategoryGrid(this.var_374);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_451.getValue(this.var_374);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_374);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_864;
         }
         ...
         if(this.var_2205 == _loc2_)
         {
            return;
         }
         this.var_2205 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_41,FurniModel.const_45];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_451.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_451.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_451.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_62.getSelectedItemIndex();
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_374);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_358)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_368)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_316)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_142)
               {
         ...
         var _loc12_:Boolean = this.var_62.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_62.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_62.canUserOfferToTrade())
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_649 && this.var_649.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1564)
         {
            _loc3_ = this.const_1564;
         }
      ...
      {
         var _loc3_:GroupItem = this.var_62.getGroupItemInIndex(this.var_62.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_62.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_62.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_62.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_62.requestCatalogOpen();
                  break;
               default:
         ...
         else if(param1.type == WindowEvent.const_59)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_364);
            }
         }
      }
   }
