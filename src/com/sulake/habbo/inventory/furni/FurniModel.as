package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_45:String = "wall";
      
      public static const const_364:String = "pets";
      
      private static const const_1163:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_200,this.onObjectPlaced);
         this._catalog = param7;
         this.var_555 = new Timer(const_1163,1);
         this.var_555.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2204 = XML(_loc9_.content);
         this.clearFurniList();
         this._view = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine);
         this._view.switchCategory(const_41);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_200,this.onObjectPlaced);
               }
            ...
            {
               this.var_555.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_555.stop();
               this.var_555 = null;
            }
            if(this.var_180 != null)
            {
               this.var_180.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_180.stop();
               this.var_180 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_358)
         {
         ...
         else if(param3 == FurniCategory.const_368)
         {
         ...
         else if(param3 == FurniCategory.const_316)
         {
         ...
         if(this.var_847 == null)
         {
            this.var_847 = this._windowManager.buildFromXML(this.var_2204) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_847.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_41,const_45];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_180 = new Timer(param1,1);
            this.var_180.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_180.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_78 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_364:
                  this._controller.toggleInventoryPage(InventoryCategory.const_157);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_352);
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_41,const_45];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_41,const_45];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_450.add(const_41,new Array());
         this.var_450.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_142)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = this.getCategoryContent(const_45);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_278;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_368 || _loc3_.category == FurniCategory.const_358 || _loc3_.category == FurniCategory.const_316)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1294 && param1.type == RoomEngineObjectEvent.const_200)
         {
            this.var_1294 = false;
         }
      }
      ...
      {
         return this.var_450.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_278:
               ...
               break;
            case InventorySubCategory.const_1008:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_450.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_450.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_617)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
