package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_39:
               this.var_1285.setSelectedGridItem(this);
               this.var_1286 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1286 = false;
                  this.var_1285.placePetToRoom(this.var_1264.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1854) : uint(this.const_1853);
      }
