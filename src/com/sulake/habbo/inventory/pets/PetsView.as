package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_339:PetsGridItem;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_339);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_603.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_452.removeGridItem(_loc2_.window);
         if(this.var_339 == _loc2_)
         {
            this.var_339 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_603 == null || this.var_603.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_603.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_603.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_603.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_603.reset();
         var _loc1_:Map = this.var_62.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_339.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_62.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_59)
         {
            ...
            {
               case "tab_floor":
                  this.var_62.switchCategory(FurniModel.const_41);
                  break;
               case "tab_wall":
                  this.var_62.switchCategory(FurniModel.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_339 != null)
         {
            this.var_339.setSelected(false);
         }
         this.var_339 = param1;
         if(this.var_339 != null)
         {
            this.var_339.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = this._avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_49,this);
            if(_loc13_ == null)
            {
               return;
            }
         ...
         if(this.var_62.roomSession != null)
         {
            _loc8_ = this.var_62.roomSession.arePetsAllowed;
            _loc9_ = this.var_62.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
