package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_1157:Dictionary;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_53 = IItemListWindow(this._view.getChildByName("achievements_itemlist"));
         this.var_411 = new Timer(1000,1);
         this.var_411.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_370.events.addEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_411)
            {
               this.var_411.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_411.reset();
               this.var_411 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_411.running);
         this.var_1157[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1157[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_370.getBadgeImage(param2.badgeId);
            this.var_1157[param2.badgeId] = _loc4_;
         }
