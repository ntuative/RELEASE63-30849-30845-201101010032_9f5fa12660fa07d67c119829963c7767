package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1332:uint = 9;
      
      public static const const_173:uint = 0;
      
      public static const const_188:uint = 1;
      
      public static const const_365:uint = 2;
      
      public static const const_280:uint = 3;
      
      public static const const_420:uint = 4;
      
      public static const const_241:uint = 5;
      ...
      public function TradingModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager)
      {
         ...
         this.var_50 = new TradingView(this,param2,param4,param5,param6);
      }
      
      public function get running() : Boolean
      {
         return this._state != const_173;
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_50 && !this.var_50.disposed)
            {
               this.var_50.dispose();
               this.var_50 = null;
            }
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_730 = true;
         this.state = const_188;
         this.var_50.setup(param1,param3,param4,param6);
         this.var_50.updateItemList(this.var_752);
         this.var_50.updateItemList(this.var_1425);
         this.var_50.updateUserInterface();
         this.var_50.clearItemLists();
      ...
      public function close() : void
      {
         if(this.var_730)
         {
            if(this._state != const_173 && this._state != const_241)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_173;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_1008);
            this.var_730 = false;
         }
         this.var_50.setMinimized(false);
      }
      
      public function categorySwitch(param1:String) : void
      {
         this.var_50.setMinimized(param1 != InventoryCategory.const_78);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_753 + " OTHER: " + this.var_1162);
         ...
         {
            case const_173:
               if(param1 == const_188 || param1 == const_241)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_287.length)
         {
            _loc2_ = this.var_287.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         return this.var_50.getWindowContainer();
      }
      ...
      {
         this.var_50.startConfirmCountdown();
      }
      
      public function cancelConfirmCountdown() : void
      {
         this.var_50.cancelConfirmCountdown();
      }
      
      public function confirmCountdownReady() : void
      {
         if(this._state == const_365)
         {
      ...
      {
         this.var_50.updateItemImage(param1,param2);
      }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_50.alertPopup(TradingView.const_1067);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1162 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_50.updateUserInterface();
         }
         else if(param1 is TradingConfirmationEvent)
         {
            ...
            this.state = const_365;
         }
         else if(param1 is TradingCompletedEvent)
         {
            Logger.log("TRADING::TradingCompletedEvent");
            this.state = const_241;
         }
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_50.alertPopup(TradingView.const_1041);
            }
            this.close();
         }
         ...
         {
            this.var_50.showOtherUserNotification("${inventory.trading.warning.others_account_disabled}");
         }
         else if(param1 is TradingYouAreNotAllowedEvent)
         {
            this.var_50.showOwnUserNotification("${inventory.trading.warning.own_account_disabled}");
         }
         else
         {
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_287.length < const_1332)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_142)
            {
               _loc6_ = String(param2) + "poster" + param5;
            }
            if(this.var_287.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
