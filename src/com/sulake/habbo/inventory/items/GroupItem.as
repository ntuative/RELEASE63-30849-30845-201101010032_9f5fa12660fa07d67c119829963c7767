package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1263:Number;
      
      protected var var_777:int = 0;
      
      protected var var_631:BitmapData;
      
      protected var var_2377:int;
      
      protected var var_1448:Boolean;
      
      protected var var_1933:Boolean;
      
      protected var var_2678:BitmapData;
      
      private const const_1854:int = 8947848;
      
      private const const_1853:int = 13421772;
      
      private const const_1590:Number = 1;
      
      private const const_1591:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         if(this._mainCategory == FurniModel.const_41)
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1263));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1926);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_777 = _loc1_.id;
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_617)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1591;
               _loc1_.blend = this.const_1591;
            }
            else
            {
               this._window.blend = this.const_1590;
               _loc1_.blend = this.const_1590;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1933 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2678;
               _loc5_.visible = true;
            }
            else
            {
