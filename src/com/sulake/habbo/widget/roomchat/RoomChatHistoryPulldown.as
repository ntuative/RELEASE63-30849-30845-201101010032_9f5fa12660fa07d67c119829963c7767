package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_868:int = 150;
      
      private static const const_867:int = 250;
      ...
      private var var_2552:BitmapData;
      ...
      private var var_2547:BitmapData;
      
      private var var_2551:BitmapData;
      
      private var var_2548:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_34 = param3;
         this.var_2552 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1809 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2550 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1807 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1808 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2547 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2551 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_67 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_294,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,param3.width,param3.height - const_77),null,0,0) as IBitmapWrapperWindow;
         this.var_34.addChild(this.var_67);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_54,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_34.height - const_77,param3.width,const_77),null,0) as IWindowContainer;
         this.var_34.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_798,HabboWindowStyle.const_37,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_77),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_465:
               this.var_67.blend += param1 / const_867;
               this._window.blend += param1 / const_867;
               ...
               break;
            case const_853:
               this.var_67.blend -= param1 / const_868;
               this._window.blend -= param1 / const_868;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_34.height - const_77;
            this._window.width = this.var_34.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_34.height - const_77;
            this._region.width = this.var_34.width - this.var_2548;
         }
         if(this.var_67 != null)
         {
            this.var_67.rectangle = this.var_34.rectangle;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2549 == this._window.width)
         {
            return;
         }
         this.var_2549 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2550;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1807;
            _loc2_.disposesBitmap = false;
            this.var_2548 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2552,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1809,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1809,_loc9_);
         ...
         this.var_67.bitmap = this.var_2551;
