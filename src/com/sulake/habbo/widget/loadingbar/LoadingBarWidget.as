package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_491:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_491.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_491 = null;
         }
         if(this.var_39 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_99,this.onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_99,this.onShowLoadingBar);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_300,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_99,this.onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_99,this.onShowLoadingBar);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_300,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         this.var_1182 = param1.clickUrl;
         var _loc2_:IDisplayObjectWrapper = this._window.findChildByName("image") as IDisplayObjectWrapper;
         if(_loc2_ == null)
         {
            return;
         }
         var _loc3_:int = Math.max(0,this.var_39.width - _loc2_.width);
         var _loc4_:int = Math.max(0,this.var_39.height - _loc2_.height);
         this._window.scale(_loc3_,_loc4_);
         if(this.var_491 == null)
         {
            this.var_491 = new Sprite();
            this.var_491.addChild(new Bitmap(this.var_39));
            this.var_491.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_491.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_39;
            }
         }
         _loc2_.setDisplayObject(this.var_491);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_99)
         {
            return;
         }
         if(!this.createWindow())
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_300)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1182 != "")
         {
            HabboWebTools.openWebPage(this.var_1182);
         }
      }
   }
}
