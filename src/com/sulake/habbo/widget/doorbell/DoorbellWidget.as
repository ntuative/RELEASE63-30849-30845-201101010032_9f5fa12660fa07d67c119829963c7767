package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1154:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_757,this.onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_138,this.onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_40,this.onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_757,this.onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_138,this.onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_40,this.onDoorbellHandled);
      }
      ...
      public function addUser(param1:String) : void
      {
         ...
         if(this._users.length >= const_1154)
         {
            this.deny(param1);
            return;
         }
