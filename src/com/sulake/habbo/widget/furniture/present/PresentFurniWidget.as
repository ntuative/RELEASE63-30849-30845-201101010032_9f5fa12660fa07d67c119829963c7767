package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1197:Number = 100;
      
      private static const const_1198:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_83,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_518,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_421,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_438,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_510,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_83,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_518,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_421,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_438,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_510,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_66:
               ...
               this.showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_421:
               if(!this.var_326)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_438:
               if(!this.var_326)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_510:
               if(!this.var_326)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_518:
               if(!this.var_326)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_83:
               if(!this.var_326)
               {
                  return;
               }
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_54,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1197,const_1198,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_326 || this.var_327 == -1 || !this._controller)
         {
            return;
         }
         this.var_326 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_151,this.var_327);
