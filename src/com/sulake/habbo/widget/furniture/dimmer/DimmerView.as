package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_581:DimmerViewColorGrid;
      
      private var var_395:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_54,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1197,const_1198,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_581 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_395 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_251 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_251.numTabItems)
         {
            _loc6_ = this.var_251.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_36,true);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1360 = _loc2_.light;
         if(this.var_395 != null)
         {
            this.var_395.setValue(this.var_1360);
         }
         this.var_424 = this.colors.indexOf(_loc2_.color);
         if(this.var_581 != null)
         {
            this.var_581.setSelectedColorIndex(this.var_424);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_251.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_251.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_251.selector.getSelected();
         return this.var_251.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1359 = XML(_loc1_.content);
         return this.var_1359;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_395 != null)
         {
            this.var_395.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_581 != null)
         {
            this.var_581.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
