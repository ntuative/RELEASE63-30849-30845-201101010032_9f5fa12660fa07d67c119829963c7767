package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1208:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      
      private static const const_1207:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_587,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_627,this.onHide);
         param1.addEventListener(RoomWidgetDimmerStateUpdateEvent.const_57,this.onDimmerState);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_587,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_627,this.onHide);
         param1.removeEventListener(RoomWidgetDimmerStateUpdateEvent.const_57,this.onDimmerState);
      }
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         this.var_1102 = param1.selectedPresetId - 1;
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2083 = param1.presetId;
         this.var_1101 = param1.effectId;
         this._color = param1.color;
         this.var_1103 = param1.brightness;
         if(this._view != null)
         {
            this._view.update();
         }
         if(!this.validateBrightness(this.var_1103,this.var_1101))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1103,this.var_1101 == 2);
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.var_1102 + 1;
         ...
         var _loc6_:DimmerFurniWidgetPresetItem = this._presets[this.var_1102] as DimmerFurniWidgetPresetItem;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1103,this.var_1101 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
