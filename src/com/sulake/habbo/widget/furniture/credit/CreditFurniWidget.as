package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetCreditFurniUpdateEvent.const_588,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetCreditFurniUpdateEvent.const_588,this.onObjectUpdate);
      }
      
      private function onObjectUpdate(param1:RoomWidgetCreditFurniUpdateEvent) : void
      {
         this.hideInterface();
         this.var_1151 = param1.objectId;
         this.var_1841 = param1.creditValue;
         this.showInterface();
      }
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(this.var_1841));
         ...
         this._window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_54,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1197,const_1198,2,2),null,0) as IWindowContainer;
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_648,this.var_1151);
