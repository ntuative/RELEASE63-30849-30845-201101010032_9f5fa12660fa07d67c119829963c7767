package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_824:String = "Boy";
      
      private static const const_825:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_370,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_959,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_349,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_370,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_959,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_349,this.onUpdate);
      }
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_370:
               this.showGenderSelectionInterface(param1);
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_349:
               this.hideEditorInterface();
         }
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2019 = param1.objectCategory;
         ...
         this._window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_54,HabboWindowStyle.const_37,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_644 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      {
         this.requestEditor(FigureData.const_74);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_115,true);
         this.var_644 = _loc4_;
         this.var_644.offset(100,100);
         var _loc6_:IWindow = this.var_644.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_361,param1,this.var_327,this.var_2019,this._roomId,this._roomCategory,_loc5_);
