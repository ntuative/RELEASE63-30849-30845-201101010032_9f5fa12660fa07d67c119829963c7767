package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1554:int = 3;
      
      private const const_1835:int = 0;
      
      private const const_1833:int = 1;
      
      private const const_1829:int = 2;
      
      private const const_1830:int = 3;
      
      private const const_1832:int = 4;
      
      private const const_1831:String = "xmas10_dialog_bg_png";
      
      private const const_1834:String = "xmas10_dialog_telepair_png";
      
      private const const_385:String = "xmas10_present_dialog_img_png";
      
      private const const_1828:String = "xmas10_dialog_newbiegift_png";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_407,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_699,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_579,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_407,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_407:
               _loc2_ = this.const_1553;
               this.var_1206 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_579:
               _loc3_ = param1.firstClickUserName;
               if(_loc3_ && _loc3_ != "")
               {
                  _loc2_ = this.const_1554;
                  this._localizations.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc3_);
               }
               else
               {
                  _loc2_ = this.const_1552;
               }
               this.var_1206 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_699:
               _loc2_ = this.const_1555;
               this.var_327 = param1.objectId;
               this.var_1206 = param1.data;
         ...
         if(this.var_1207 != _loc2_ && this._window)
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_1207 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1207)
            {
               ...
               case this.const_1555:
                  ...
                  else if(this._status == this.const_1833)
                  {
                     ...
                     _loc2_ = this.const_1834;
                  }
                  else if(this._status == this.const_1829)
                  {
                  ...
                  else if(this._status == this.const_1832)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("xmas10viral","client.show.not_enough_fb_friends");
            ...
            if(_loc6_)
            {
               _loc5_ = (assets.getAssetByName(this.const_1831) as BitmapDataAsset).content as BitmapData;
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_664);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         HabboWebTools.facebookViralGiftPost(_loc2_,_loc3_,this.var_1206,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_151);
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_641,"ViralGift",param1,param2,param3);
