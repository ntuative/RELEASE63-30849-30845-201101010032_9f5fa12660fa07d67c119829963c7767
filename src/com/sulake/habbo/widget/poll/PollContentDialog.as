package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1122;
         if(this.var_1122 < this.var_912.length)
         {
            _loc1_ = this.var_912[this.var_1122] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_912.length);
                  _loc2_.text = _loc6_;
               }
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.testStateFlag(WindowState.const_47))
                        {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_403)
         {
            ...
            this.var_403 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_403.center();
            this.var_403.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_912[this.var_1122] as Dictionary;
         ...
         switch(type)
         {
            case 1:
               ...
               {
                  this._widget.windowManager.alert("${win_error}","${poll_alert_answer_missing}",0,function(param1:IAlertDialog, param2:Event):void
                  {
                     param1.dispose();
                  });
                  return;
               ...
               {
                  this._widget.windowManager.alert("${win_error}","${poll_alert_invalid_selection}",0,function(param1:IAlertDialog, param2:Event):void
                  {
                     param1.dispose();
                  });
                  return;
