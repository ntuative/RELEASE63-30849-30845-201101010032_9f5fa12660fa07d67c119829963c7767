package com.sulake.habbo.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1156:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_254 = new PollOfferDialog(this._id,param1,this.var_1156);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         this.hideOffer();
         this.hideContent();
         this.var_1656 = param2;
         this.var_254 = new PollContentDialog(this._id,param1,param3,this.var_1156);
      }
      ...
      {
         this.var_1156.windowManager.alert("${poll_thanks_title}",this.var_1656,0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
