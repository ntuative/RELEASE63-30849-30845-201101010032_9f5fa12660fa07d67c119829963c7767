package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_872:int = 16;
      
      private static const const_1233:int = 40;
      
      private static const const_1593:int = 5;
      
      private static const const_1234:int = 20;
      ...
      private var var_437:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1149 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2599 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2598 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_345 = new Timer(1000,1);
         this.var_345.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_345.reset();
            this.var_345.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         }
         this.var_345 = null;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_54,HabboWindowStyle.const_37,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_148,this.windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_44,this.onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_104,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_377,this.onWindowMoved);
         this.var_1837 = true;
         this.var_497 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2600 = _loc2_.width + const_872 + _loc6_.width + const_1234;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1233,_loc8_.width) + const_872);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_437 = param1 - this.var_2600;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_437);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_437);
         }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_39,this.windowMouseEventProcessor);
         }
      }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1149 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_497 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_497.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_497 = _loc2_.text;
            if(!this.var_613)
            {
               this.var_613 = true;
               this.var_345.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_613);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_437)
         {
