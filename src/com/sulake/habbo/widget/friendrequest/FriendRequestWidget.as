package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_404,this.eventHandler);
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_433,this.eventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_404,this.eventHandler);
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_433,this.eventHandler);
      }
      ...
      private function eventHandler(param1:RoomWidgetFriendRequestUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFriendRequestUpdateEvent.const_404:
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_769,param1));
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_574,param1));
         this.removeRequest(param1);
      }
