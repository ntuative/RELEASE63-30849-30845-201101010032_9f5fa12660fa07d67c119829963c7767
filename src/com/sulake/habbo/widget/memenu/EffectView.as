package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_804:IWindow;
      
      private var var_437:Number;
      
      private var var_805:ITextWindow;
      
      private var var_185:Timer;
      
      private var var_806:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_185 = new Timer(1000);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_804 != null)
         {
            if(this.var_158.isActive)
            {
               ...
               this.var_804.width = _loc2_ * this.var_437;
            }
            else
            {
               this.var_804.width = 0;
               this.var_185.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_805.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_805.text;
            if(this.var_158.isActive)
            {
               ...
               this.var_805.text = _loc1_;
            }
            else
            {
               this.var_805.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_806 = this._window.findChildByName("effect_hilite");
            this.var_806.visible = false;
         }
         this.var_805 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_804 = this._window.findChildByName("loader_bar");
         if(this.var_804 != null)
         {
            this.var_437 = this.var_804.width;
            this.var_185.start();
            this.onUpdate();
         }
