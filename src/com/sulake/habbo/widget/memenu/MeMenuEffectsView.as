package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuEffectsView implements IMeMenuView
   {
      ...
      public static const const_978:Number = 55;
      ...
      public function updateEffects(param1:Array) : Boolean
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            this.var_893.push(_loc6_);
            _loc6_.window.y = _loc2_ * const_978;
            _loc2_++;
         }
         _loc4_ = this._effectsContainer.height;
         _loc5_ = this.var_893.length * const_978;
      ...
      public function selectEffect(param1:EffectView) : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_818,param1.effect.type));
         }
         else
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_637,param1.effect.type));
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_893)
         {
            _loc1_.dispose();
            _loc1_ = null;
         }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case "moreEffects_btn":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_948));
               break;
            case "hideEffects_btn":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_785));
               break;
            default:
