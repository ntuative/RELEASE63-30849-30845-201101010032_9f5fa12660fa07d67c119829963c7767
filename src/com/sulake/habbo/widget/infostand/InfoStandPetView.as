package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1849:int = 158;
      
      private const const_1847:int = 16;
      
      private const const_1850:uint = 11184810;
      
      private const const_1848:uint = 6710886;
      
      private const const_1844:uint = 3355443;
      
      private const const_1851:String = "level";
      
      private const const_1845:String = "experience";
      
      private const const_1843:String = "energy";
      
      private const const_1846:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1851,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1845,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1843,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1846,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_564 = param1.id;
         this.var_1264.remove(param1.id);
         this.var_1264.add(param1.id,param1);
         if(this.var_177 && this.var_177.isVisible() && param1.isOwnPet)
         {
            this.var_177.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         this.var_177.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1849,this.const_1847,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1850);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1844);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1848);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_177 == null)
         {
            this.var_177 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1264.getValue(this.var_564) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_177.showWindow(true);
            this.var_177.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = this.var_192.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_192.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_177 && this.var_177.getPetId() == this.var_564)
               {
                  this.var_177.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_500,this._widget.petData.ownerId);
