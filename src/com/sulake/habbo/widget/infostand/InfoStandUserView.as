package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_48:IItemListWindow;
      
      protected var var_61:IItemListWindow;
      
      private var var_192:IBorderWindow;
      
      private var var_1065:TagListRenderer;
      
      private var var_119:IBorderWindow;
      
      private var var_2093:int;
      
      private const const_828:int = 5;
      
      private const const_1560:int = 39;
      
      private const const_1561:int = 7829367;
      
      private const const_1562:int = 16777215;
      
      private const const_1839:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1065 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_48 == null || this.var_192 == null || this.var_61 == null)
         {
            return;
         }
         this.var_61.width = this.var_61.scrollableRegion.width;
         this.var_48.height = this.var_48.scrollableRegion.height;
         this.var_192.height = this.var_48.height + 20;
         this._window.width = Math.max(this.var_192.width,this.var_61.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_192.width < this.var_61.width)
         {
            this.var_192.x = this._window.width - this.var_192.width;
            this.var_61.x = 0;
         }
         else
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_192 = this._window.getListItemByName("info_border") as IBorderWindow;
         this.var_61 = this._window.getListItemByName("button_list") as IItemListWindow;
         var _loc4_:* = [];
         this.var_61.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         ...
         {
            this.var_48 = this.var_192.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc6_:IBitmapWrapperWindow = this.var_192.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_192.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < this.var_61.numListItems)
            {
               _loc13_ = this.var_61.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_192.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = this.var_192.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_119.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_119.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_119.x = _loc5_.left - this.var_119.width;
         this.var_119.y = _loc5_.top + (_loc5_.height - this.var_119.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_119.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_119.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_119.x = _loc7_.left - this.var_119.width;
         this.var_119.y = _loc7_.top + (_loc7_.height - this.var_119.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_119 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_119 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_48.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         _loc2_.height = _loc2_.textHeight + this.const_828;
         _loc2_.visible = param1.length > 0;
      }
      
      public function set image(param1:BitmapData) : void
      {
         var _loc2_:IWindowContainer = this.var_48.getListItemByName("image_and_badges_container") as IWindowContainer;
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc3_:ITextWindow = this.var_48.getListItemByName("motto_text") as ITextWindow;
         var _loc4_:IWindowContainer = this.var_48.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            ...
            {
               _loc3_.textColor = this.const_1562;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_828;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_315,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_315,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_48.getListItemByName("score_value") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:ITextWindow = this.var_48.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_48.getListItemByName("handitem_spacer") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = this.var_48.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_48.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:IWindowContainer = this.var_48.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = this.var_48.getListItemByName("tags_spacer") as IWindowContainer;
         if(_loc3_ == null || _loc4_ == null)
         {
            return;
         }
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1065.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc3_:IWindowContainer = this.var_48.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc3_:* = null;
         var _loc1_:IWindowContainer = this.var_48.getListItemByName("image_and_badges_container") as IWindowContainer;
         var _loc2_:int = 0;
         while(_loc2_ < 5)
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_178);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_61.getListItemByName(param1) as IRegionWindow;
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_178:
               this.var_61.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_203:
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this.var_61.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_953:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_935:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc2_:ITextWindow = this.var_48.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:String = _loc2_.text;
         if(param1.keyCode == Keyboard.ENTER)
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2093 > this.const_1839 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2093 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1561;
            if(_loc3_.length >= this.const_1560)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1560 - 1);
            }
         }
      }
