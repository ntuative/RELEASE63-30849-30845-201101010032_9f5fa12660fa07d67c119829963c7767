package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandBotView extends InfoStandUserView
   {
      ...
      override protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         _loc3_ = var_48.getListItemByName("score_spacer") as ITextWindow;
         var_48.removeListItem(_loc3_);
         _loc3_ = var_48.getListItemByName("score_text") as ITextWindow;
         var_48.removeListItem(_loc3_);
         _loc3_ = var_48.getListItemByName("score_value") as ITextWindow;
         var_48.removeListItem(_loc3_);
      }
      ...
      override protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         var_61.visible = param1.canBeKicked;
      }
      ...
      override protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_.name == "kick")
         {
            ...
            _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_409,_loc3_));
         }
      }
   }
}
