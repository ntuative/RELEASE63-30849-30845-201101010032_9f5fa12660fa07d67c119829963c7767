package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_61.numListItems)
            {
               _loc4_ = this.var_61.getListItemAt(_loc5_);
               _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClicked);
               _loc5_++;
            }
         }
         this.var_810 = this.var_192.findChildByTag("catalog");
         if(this.var_810 != null)
         {
            this.var_810.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_48.getListItemByName("image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_48.getListItemByName("description_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_48.getListItemByName("expiration_text") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_48.getListItemByName("expiration_spacer") as IWindowContainer;
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         this.var_61.visible = _loc2_ || _loc3_ || _loc4_;
         this.updateWindow();
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            if(!this.var_48.getListItemByName("catalog_button"))
            {
               this.var_48.addListItem(this.var_810);
            }
            this.var_810.visible = param1;
         }
         else
         {
            this.var_48.removeListItem(this.var_810);
         }
      }
   }
}
