package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1841:int = 5;
      
      private const const_1842:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_134:Function;
      
      private var _offsetX:int;
      
      private var var_1000:int;
      
      private var var_1001:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1000 = 0;
         this.var_1001 = param2.rectangle.clone();
         this.var_1001.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1001.width)
         {
            return false;
         }
         if(this.var_1000 + param1.height > this.var_1001.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1001.width)
         {
            this._offsetX = 0;
            this.var_1000 += param1.height + this.const_1842;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1000);
         this._offsetX += param1.width + this.const_1841;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1403 != null && this.var_1403.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_134);
