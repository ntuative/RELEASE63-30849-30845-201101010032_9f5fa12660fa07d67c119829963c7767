package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_1659:Dictionary;
      ...
      {
         this.var_1659 = new Dictionary();
         this.var_2282 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1660 = (param2 & 0) > 0;
         if(!this.var_1660)
         {
            lock();
         }
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1660)
            {
               if("false" == this._configuration.getKey("use.default.localizations","false"))
               {
                  ...
                  events.addEventListener(LocalizationEvent.const_143,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_143,this.onLocalizationLoaded);
         if(this._configuration.keyExists("external.override.texts.txt"))
         {
            ...
            events.addEventListener(LocalizationEvent.const_143,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_143,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_1659[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1659[param1];
      }
      ...
      {
         return this.var_2282[Math.max(0,param1 - 1)];
      }
   }
}
