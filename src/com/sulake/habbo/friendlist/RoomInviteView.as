package com.sulake.habbo.friendlist
{
   ...
   public class RoomInviteView extends AlertView
   {
      ...
      public function RoomInviteView(param1:HabboFriendList)
      {
         ...
         this.var_184 = param1.categories.getSelectedFriends();
      }
      ...
      {
         friendList.registerParameter("friendlist.invite.summary","count","" + this.var_184.length);
         this.var_811 = ITextFieldWindow(param1.findChildByName("message_input"));
      ...
      private function sendMsg() : void
      {
         ...
         for each(_loc3_ in this.var_184)
         {
