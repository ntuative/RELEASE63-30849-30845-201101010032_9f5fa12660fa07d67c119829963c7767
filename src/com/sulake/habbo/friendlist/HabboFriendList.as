package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_145:String = "face";
      ...
      private var var_990:IAvatarRenderManager;
      
      private var var_683:ISessionDataManager;
      
      private var var_2242:FriendListLookAndFeel;
      
      private var var_404:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1626:OpenedToWebPopup;
      
      private var var_1957:int;
      
      var var_92:FriendCategories;
      
      private var var_307:FriendRequests;
      
      private var var_1625:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_932:IHabboNotifications;
      
      private var var_562:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2242 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_92 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1625 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_562.stop();
            this.var_562.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_562 = null;
         }
         ...
         if(this.var_990)
         {
            this.var_990.release(new IIDAvatarRenderManager());
            this.var_990 = null;
         }
         if(this.var_932)
         {
            this.var_932.release(new IIDHabboNotifications());
            this.var_932 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_683)
         {
            this.var_683.release(new IIDSessionDataManager());
            this.var_683 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1626 = new OpenedToWebPopup(this);
         }
         this.var_1626.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_92.findFriend(param1);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_94);
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_92.getFriendCount(param1,param2);
      }
      
      public function refreshToolBarIcon() : void
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_96,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_307.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_294,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_990.createAvatarImage(param1,AvatarScaleType.const_82,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "ClubGiftController";
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_990 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_932 = param2 as IHabboNotifications;
      ...
      {
         this.var_683 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_307 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_92.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_1038,this.getText("friendlist.friends")));
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_317,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_92.addFriend(new Friend(_loc4_));
         }
         this.var_404 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_562)
         {
            this.var_562 = new Timer(120000);
            this.var_562.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_562.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.FRIENDLIST));
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_38,this.onHabboToolbarEvent);
         if(this.var_92.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_92.findCategory(FriendCategory.const_317);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_404.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_339));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_307.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_307.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_404.findTab(FriendListTab.const_93).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_307.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_404.findTab(FriendListTab.const_93);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1625.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_92.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_92.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_404.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_683 || !this.var_307)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_683.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_307.vipLimit;
         }
         else if(this.var_683.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_307.clubLimit;
         }
         if(_loc2_ > this.var_307.limit)
         {
            this.var_307.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.var_92.getAllFriends();
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_145) as IBitmapWrapperWindow;
