package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_591:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2561:IContainerButtonWindow;
      
      private var var_2563:IContainerButtonWindow;
      
      private var var_2562:IContainerButtonWindow;
      
      private var var_2564:IContainerButtonWindow;
      
      private var var_53:IItemListWindow;
      
      private var var_396:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_396 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2561 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2563 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2562 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2564 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_94).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_53.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
            ...
            this.var_53.addListItem(_loc6_);
         }
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_591);
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_94,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_591);
         _loc4_.procedure = this.onCategoryClick;
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc4_.procedure = this.onFriendClick;
         _loc4_.visible = true;
         if(param2.selected)
         {
            _loc4_.color = this._friendList.laf.getSelectedEntryBgColor();
         }
         ITextWindow(param2.view.findChildByName("name")).textColor = this._friendList.laf.getFriendTextColor(param2.selected);
         var _loc5_:* = param2.name;
         if(param2.realName != null && param2.realName != "")
         {
            _loc5_ = _loc5_ + " (" + param2.realName + ")";
         }
         this._friendList.refreshText(_loc3_,"name",true,_loc5_);
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_94,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2561,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2563,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2562,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2564,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_396.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_396.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_396.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_292)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_292 && _loc4_.online)
            {
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_94,param4);
         _loc6_.visible = true;
      }
