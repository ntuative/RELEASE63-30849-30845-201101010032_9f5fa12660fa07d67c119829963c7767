package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1789:int = "F".charCodeAt(0);
      
      public static const const_1603:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_907 = param1.gender;
         this.var_735 = param1.online;
         this.var_1542 = param1.followingAllowed && param1.online;
         this.var_597 = param1.figure;
         this.var_1540 = param1.motto;
         this.var_1543 = param1.lastAccess;
         this.var_1377 = param1.categoryId;
         this.var_1541 = param1.realName;
