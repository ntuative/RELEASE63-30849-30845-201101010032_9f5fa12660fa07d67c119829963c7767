package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1594:String = "noconvinfo";
      
      private static const const_1595:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1412:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1412 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.FRIENDLIST,this.var_16));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_906 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_242 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1412.prepare(this.var_906);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_924,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1002,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_584,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_819,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_584,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_819,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1411 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1411.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1839 == -1 ? 0 : int(this.var_16.height - this.var_1839);
         var _loc4_:int = this.var_1840 == -1 ? 0 : int(this.var_16.width - this.var_1840);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_242.y = Util.getLowestPoint(this.var_16.content);
         this.var_242.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_954,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_584,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_924,false);
         ...
         this.var_1839 = this.var_16.height;
         this.var_1840 = this.var_16.width;
