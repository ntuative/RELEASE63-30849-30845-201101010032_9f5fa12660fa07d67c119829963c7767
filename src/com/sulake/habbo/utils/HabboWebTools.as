package com.sulake.habbo.utils
{
   ...
   public class HabboWebTools
   {
      ...
      public static const const_1522:String = "advertisement";
      ...
      public static function facebookViralGiftPost(param1:String, param2:String, param3:String, param4:String) : void
      {
         if(false)
         {
            ExternalInterface.call("FlashExternalInterface.postXmasViral",param1,param2,param3,param4);
         }
         else
         {
