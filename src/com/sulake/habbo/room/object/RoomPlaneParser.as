package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1620:Number = 0.0;
      
      private var var_1035:Number = 0.0;
      
      private var var_122:Number = 0.0;
      
      private var var_797:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_142.push(_loc4_);
            _loc3_++;
         }
         this._width = param1;
         this._height = param2;
         this.var_456 = this._width;
         this.var_458 = -1;
         this.var_457 = this._height;
         this.var_459 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         {
            _loc4_ = this.var_142[param2] as Array;
            ...
            if(param3 >= 0)
            {
               ...
               if(param2 < this.var_457)
               {
                  this.var_457 = param2;
               }
               if(param2 > this.var_459)
               {
                  this.var_459 = param2;
               }
            }
            ...
            {
               if(param1 == this.var_456 || param1 == this.var_458)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_457;
                  while(_loc6_ < this.var_459)
                  {
               ...
               if(param2 == this.var_457 || param2 == this.var_459)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_456;
                  while(_loc8_ < this.var_458)
                  {
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_142[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(this.var_142);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         this.var_797 = getFloorHeight(this.var_142);
         if(!param1)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_142.length)
         {
            _loc4_ = this.var_142[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_154,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_274,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1035);
         this.addPlane(RoomPlaneData.const_154,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_154,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_122) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_154,Vector3d.sum(param1,Vector3d.product(param3,-this.var_122 / param3.length)),Vector3d.product(param3,(param3.length + this.var_122) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1035 / param2.length);
               this.addPlane(RoomPlaneData.const_154,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_142 == null || param1 == this.var_142)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_142.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_142[_loc3_] as Array;
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_174,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_174,_loc13_,new Vector3d(0,0,-this.var_122),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_122,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,this.var_122,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_174,_loc13_,new Vector3d(0,0,-this.var_122),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_122,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,this.var_122,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_174,_loc13_,new Vector3d(0,0,-this.var_122),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_122,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,this.var_122,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_174,_loc13_,new Vector3d(0,0,-this.var_122),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_122,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,this.var_122,param11);
                  }
               }
            }
         }
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_121[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_914;
         }
         var _loc2_:RoomPlaneData = this.var_121[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_121[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
