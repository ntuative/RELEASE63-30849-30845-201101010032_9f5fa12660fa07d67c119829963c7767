   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_121 != null)
         {
            ...
            {
               _loc2_ = this.var_121[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_284);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_382);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_795);
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(this._assetLibrary == null)
         {
            this._assetLibrary = new AssetLibrary("furniture cuboid visualization - " + _loc4_.getInstanceId());
         }
         if(param1 == null)
         {
            return;
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_121.length)
         {
            _loc6_ = false;
            ...
            _loc9_ = this.var_121[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1714;
               }
