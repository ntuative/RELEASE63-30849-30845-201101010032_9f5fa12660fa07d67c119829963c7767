package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_206:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_206 = this.var_570[param1];
               _loc3_ = true;
            }
            else if(param1 != var_217)
            {
               if(this.var_206)
               {
                  this.var_206.reset();
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_206)
         {
            this.var_206.setAnimation(param1);
         }
      ...
      {
         if(this.var_206 && this.var_206.controlsSprite(param1))
         {
            return this.var_206.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1085);
         if(_loc3_.length == 0)
         {
