package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_314:int = 1000;
      ...
      private var var_1301:int = 360;
      
      private var var_681:DirectionData = null;
      
      private var var_238:Map;
      
      private var _colors:Map;
      
      private var var_1034:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_681 = new DirectionData(param1);
         this.var_238 = new Map();
      ...
      public function dispose() : void
      {
         ...
         if(this.var_238 != null)
         {
            ...
            {
               _loc2_ = this.var_238.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_681,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_238.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_681);
            this.defineDirection(_loc3_,_loc8_);
            this.var_238.add(String(_loc7_),_loc3_);
            this.var_1619 = -1;
            this.var_1034 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_1089);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_909);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1301 / 2) % 360 / this.var_1301;
         if(this.var_238.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_238.getKey(_loc5_)) * this.var_1301;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_238.getKey(_loc4_));
         }
         return const_1424;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_238.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_681;
         }
         this.var_1619 = param1;
         this.var_1034 = _loc2_;
         return this.var_1034;
      }
