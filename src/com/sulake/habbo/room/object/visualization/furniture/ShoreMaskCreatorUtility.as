package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      private static const const_1174:int = 3;
      ...
      {
         return param1 + param2 * const_1174;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_128,const_70,const_65,const_128,const_70,const_65];
                     _loc8_ = [const_70,const_70,const_70,const_65,const_65,const_65];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
