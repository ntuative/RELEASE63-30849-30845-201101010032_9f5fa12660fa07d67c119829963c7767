package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1334:String = "cone";
      
      public static const const_1287:String = "plane";
      
      public static const const_1358:String = "sphere";
      ...
      private var var_891:Number = 0.1;
      
      private var var_1710:Number;
      
      private var var_245:Number;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_324)
         {
            _loc1_.dispose();
         }
         this.var_324 = null;
      ...
      public function reset() : void
      {
         ...
         this.var_892 = 0;
         this.var_919 = false;
         this.init(0,0,0,this._direction,this.var_2371,this.var_891,this.var_2375,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1076.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_919 = true;
         if(this.var_892 < this.var_1351)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2370)
         {
            switch(this.var_2374)
            {
               case const_1334:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_891,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_324.push(_loc4_);
            ++this.var_892;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1076.length);
         return this.var_1076[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_892 < this.var_1351)
         {
            if(this.age % this.var_2373 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_892 < this.var_1351)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_245) * this.x - (1 - this.var_245) * this.lastX;
            this.y = (2 - this.var_245) * this.y - (1 - this.var_245) * this.lastY + this.var_1710 * this.var_891 * this.var_891;
            this.z = (2 - this.var_245) * this.z - (1 - this.var_245) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         var _loc1_:* = [];
         for each(_loc2_ in this.var_324)
         {
            _loc2_.update();
            _loc3_ = _loc2_.x;
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_245) * _loc2_.x - (1 - this.var_245) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_245) * _loc2_.y - (1 - this.var_245) * _loc2_.lastY + this.var_1710 * this.var_891 * this.var_891;
            _loc2_.z = (2 - this.var_245) * _loc2_.z - (1 - this.var_245) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_324.splice(this.var_324.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
