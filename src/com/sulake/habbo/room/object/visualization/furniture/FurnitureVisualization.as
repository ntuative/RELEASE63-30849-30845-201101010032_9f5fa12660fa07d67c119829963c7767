package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1536:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2667:Number = NaN;
      
      protected var var_2668:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1182:String = null;
      ...
      private var var_1538:Boolean = true;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1537 != spriteCount)
         {
            createSprites(this.var_1537);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param1 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,this.var_2668,param2);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1089:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_909:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_417 != _loc3_.getUpdateID() || param1 != var_217 || param2 != this.var_2667)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2668 = _loc3_.getNumber(RoomObjectVariableEnum.const_207);
            ...
            this.var_1182 = _loc3_.getString(RoomObjectVariableEnum.const_360);
            if(this.var_1182 == null || this.var_1182.indexOf("http") != 0)
            {
               this.var_1182 = null;
            }
      ...
      {
         if(this.var_2095 != param1 || this.var_2094 != param2)
         {
            this.var_821 = [];
            this.var_820 = [];
            this.var_654 = [];
            ...
            this.var_1537 = this._data.getLayerCount(param2) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param1 >= FurnitureVisualizationData.const_968.length)
         {
            return "";
         }
         var _loc3_:String = this.var_821[param1];
         var _loc4_:Boolean = this.var_820[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param1 < spriteCount - 1)
            {
               _loc6_ = FurnitureVisualizationData.const_968[param1];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_821[param1] = _loc3_;
            this.var_820[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_657[param1] != null && !this.var_1538)
         {
