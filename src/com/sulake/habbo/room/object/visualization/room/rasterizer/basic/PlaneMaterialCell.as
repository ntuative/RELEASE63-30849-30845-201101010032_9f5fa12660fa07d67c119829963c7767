package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_28:BitmapData = null;
      
      private var var_538:PlaneTexture;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_538 != null)
         {
            _loc2_ = this.var_538.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_538 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  if(this.var_28 != null)
                  {
                     if(this.var_28.width != _loc2_.width || this.var_28.height != _loc2_.height)
                     {
                        this.var_28.dispose();
                        this.var_28 = null;
                     }
                     ...
                     {
                        this.var_28.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(this.var_28 == null)
                  {
                     this.var_28 = _loc2_.clone();
                  }
                  _loc3_ = Math.min(this.var_992,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_992,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_992,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_822[_loc6_ % this.var_822.length] as IGraphicAsset;
                     if(_loc7_ != null && _loc8_ != null)
                     {
                        ...
                        if(_loc9_ != null)
                        {
                           ...
                           if(_loc10_ != null)
                           {
                              ...
                              this.var_28.draw(_loc10_,_loc12_);
                           }
                        }
                     }
                     _loc6_++;
