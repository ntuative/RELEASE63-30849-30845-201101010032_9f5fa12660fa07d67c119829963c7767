package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1514:int = 13421772;
      
      private static const const_845:int = 16777215;
      
      private static const const_848:int = 13421772;
      
      private static const const_846:int = 10066329;
      
      private static const const_847:int = 10066329;
      
      public static const const_1271:int = 16777215;
      
      public static const const_1272:int = 13421772;
      
      public static const const_1482:int = 10066329;
      ...
      private var var_703:Rectangle = null;
      
      private var var_477:RoomPlaneBitmapMaskParser = null;
      
      private var var_1550:String = null;
      
      private var _floorType:String = null;
      
      private var var_1549:String = null;
      
      private var var_2379:String = null;
      
      private var var_1080:uint = 16777215;
      
      private var var_2381:int = 255;
      
      private var var_2380:int = 255;
      
      private var var_2384:int = 255;
      ...
      private const const_1863:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_477 = new RoomPlaneBitmapMaskParser();
         this.var_281["null"] = false;
         this.var_281["null"] = true;
         this.var_281["null"] = true;
         this.var_281["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_121.length)
            {
               _loc4_ = this.var_121[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_703 = super.boundingRectangle;
         }
         return new Rectangle(this.var_703.x,this.var_703.y,this.var_703.width,this.var_703.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_121.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_121[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_112 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_906);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1064);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_154)
            {
               ...
               {
                  _loc13_.color = const_847;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_845;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_848;
               }
               else
               {
                  _loc13_.color = const_846;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1313)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_112,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1863 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_325.length)
            {
               _loc10_ = this.var_580[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_325[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_90)
               {
                  if(this.var_1713)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2384 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2380 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2381 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1640)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1381 || _loc3_.y != this.var_2383 || _loc3_.z != this.var_2385 || param1.scale != this.var_2382))
            {
               this.var_1381 = _loc3_.x;
               this.var_2383 = _loc3_.y;
               this.var_2385 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_218 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1123);
            if(_loc3_ != this.var_2379)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2379 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_764));
            if(_loc4_ != this.var_1080)
            {
               this.var_1080 = _loc4_;
               this.var_2384 = this.var_1080 & 255;
               this.var_2380 = this.var_1080 >> 8 & 255;
               this.var_2381 = this.var_1080 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1013));
            if(_loc5_ != this.var_1713)
            {
               this.var_1713 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_218 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_747);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_599);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_754);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_594));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_679));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_612));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_121.length)
         {
            _loc5_ = this.var_121[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_112 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_281["null"] || param2 != this.var_281["null"] || param3 != this.var_281["null"])
         {
            this.var_281["null"] = param1;
            this.var_281["null"] = param2;
            this.var_281["null"] = param3;
            this.var_325 = [];
            this.var_580 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_325;
         if(this.var_325.length == 0)
         {
            _loc6_ = this.var_121;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_325.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_197)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_281[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_325.push(_loc12_);
                        this.var_580.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1714;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_477.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         {
            _loc3_ = this.var_121[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_477.maskCount)
         {
            _loc10_ = this.var_477.getMaskType(_loc8_);
            _loc11_ = this.var_477.getMaskLocation(_loc8_);
            _loc12_ = this.var_477.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_121.length)
               {
                  _loc3_ = this.var_121[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_112 || _loc3_.type == RoomPlane.const_90)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_112 || _loc3_.type == RoomPlane.const_90 && _loc12_ == RoomPlaneBitmapMaskData.const_236)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_121[_loc18_] as RoomPlane;
