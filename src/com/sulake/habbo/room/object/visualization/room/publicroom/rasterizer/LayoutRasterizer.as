package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_829:Boolean = true;
      ...
      private var var_1005:Point = null;
      
      private var var_1265:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_830)
         {
            this.var_830 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1265 = this.var_38.getValue(this.var_830);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2145 = new Vector3d(-0.5,0.5,0);
         this.var_829 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2145);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1005.x = _loc3_.x;
         this.var_1005.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_38.getValue(this.var_830);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1561 = RoomObjectVariableEnum.const_916;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1561 = RoomObjectVariableEnum.const_899;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1006 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1006 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_38.getValue(this.var_830);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2144 && param3 == this.var_2143)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1006 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1006 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1561);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1265.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1244.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1005.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1005.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_367.indexOf(_loc10_) >= 0 && this.var_829)
            {
               param1 = this.var_367.indexOf(_loc10_);
               if(this.var_545[param1] != "")
               {
                  _loc9_ = this.var_1244.getAsset(this.var_545[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_544[param1] != -1)
               {
                  param2.alpha = this.var_544[param1];
               }
               this.var_367.splice(param1,1);
               this.var_545.splice(param1,1);
               this.var_544.splice(param1,1);
      ...
      {
         this.var_829 = true;
         var _loc3_:int = this.var_367.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_367.push(param1);
            this.var_545.push(param2);
            this.var_544.push(-1);
         }
         else
         {
            this.var_545[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_367.push(param1);
            this.var_545.push("");
            this.var_544.push(param2);
         }
         else
         {
            this.var_544[_loc3_] = param2;
         }
      }
   }
}
