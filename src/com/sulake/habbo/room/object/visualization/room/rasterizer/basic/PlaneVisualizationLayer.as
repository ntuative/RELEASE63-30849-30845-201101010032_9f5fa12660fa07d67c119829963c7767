package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneVisualizationLayer implements IDisposable
   {
      ...
      public static const const_1110:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean) : BitmapData
      {
         ...
         if(this._material != null)
         {
            if(_loc9_)
            {
               _loc10_ = this._material.render(null,param2,param3,param4,param5,this.offset,this.align == const_114);
            }
            else
            {
               _loc10_ = this._material.render(param1,param2,param3,param4,param5,this.offset,this.align == const_114);
            }
