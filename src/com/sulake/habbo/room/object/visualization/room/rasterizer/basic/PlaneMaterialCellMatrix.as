package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_240:int = 2;
      ...
      public static const const_1353:int = const_376;
      ...
      public static const const_270:int = const_114;
      ...
      private var var_28:BitmapData;
      
      private var var_648:Vector3d = null;
      
      private var var_588:int = 0;
      
      private var var_1507:Boolean = false;
      
      private var var_1745:Boolean = true;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_648 != null)
         {
            this.var_648.assign(new Vector3d());
         }
         this.var_588 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_333.length)
         {
            _loc2_ = this.var_333[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_333.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_333[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_333[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_28 != null)
            {
               if(this.var_28.width == param2 && this.var_28.height == param3 && Vector3d.isEqual(this.var_648,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_588,param6,param7);
                     return param1;
                  }
                  return this.var_28;
               }
         ...
         else if(this.var_28 != null)
         {
            if(this.var_28.width == param2 && this.var_28.height == param3)
            {
               this.var_28.fillRect(this.var_28.rect,16777215);
            }
            else
            {
               this.var_28.dispose();
         ...
         this.var_1507 = true;
         this.var_648.assign(param4);
         if(!param5)
         {
            this.var_588 = param3;
            if(this.var_28 == null)
            {
               this.var_28 = new BitmapData(param2,param3,true,4294967295);
            }
            else
            {
               this.var_28.fillRect(this.var_28.rect,4294967295);
            }
            if(param1 != null)
            {
         ...
         {
            this.var_588 = param3;
            this.var_28 = new BitmapData(param2,param3,true,16777215);
         }
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_333.length)
         {
            _loc11_ = this.var_333[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
         ...
         {
            case const_240:
               _loc10_ = this.renderRepeatBorders(this.var_28,_loc8_);
               break;
            case const_255:
               _loc10_ = this.renderRepeatCenter(this.var_28,_loc8_);
               break;
            case const_238:
               _loc10_ = this.renderRepeatFirst(this.var_28,_loc8_);
               break;
            case const_223:
               _loc10_ = this.renderRepeatLast(this.var_28,_loc8_);
               break;
            case REPEAT_MODE_RANDOM:
               _loc10_ = this.renderRepeatRandom(this.var_28,_loc8_);
               break;
            default:
               _loc10_ = this.renderRepeatAll(this.var_28,_loc8_);
         }
         this.var_588 = _loc10_;
         if(param1 != null)
         {
      ...
      {
         if(param1 == null || this.var_28 == null || param1 == this.var_28)
         {
            return;
         }
         if(!param4)
         ...
         var _loc5_:* = null;
         if(this.var_1746 == const_114)
         {
            _loc5_ = new Rectangle(0,0,this.var_28.width,this.var_588);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_28.height - this.var_588,this.var_28.width,this.var_588);
         }
         param1.copyPixels(this.var_28,_loc5_,new Point(0,param3),null,null,true);
      }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_333.length == 1)
         {
            _loc4_ = this.var_333[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
