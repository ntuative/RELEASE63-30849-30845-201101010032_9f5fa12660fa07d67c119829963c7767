package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneData
   {
      ...
      public static const const_914:int = 0;
      
      public static const const_174:int = 1;
      
      public static const const_154:int = 2;
      
      public static const const_274:int = 3;
      
      public static const const_1313:int = 4;
      ...
      private var var_2394:Vector3d = null;
      ...
      public function RoomPlaneData(param1:int, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Array)
      {
         ...
         {
            this.var_552 = Vector3d.crossProduct(param3,param4);
            _loc6_ = 0;
            _loc7_ = 0;
            _loc8_ = 0;
            _loc9_ = 0;
            ...
            this.var_2394 = new Vector3d(_loc6_,_loc7_,_loc8_);
         }
      ...
      public function getSecondaryNormal(param1:int) : IVector3d
      {
         ...
         _loc2_.assign(this.var_1284[param1] as IVector3d);
         return _loc2_;
      }
