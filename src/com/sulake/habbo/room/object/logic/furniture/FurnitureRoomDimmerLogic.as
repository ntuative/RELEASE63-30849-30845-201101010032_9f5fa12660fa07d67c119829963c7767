package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1452)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_95,_loc1_,_loc2_);
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = object.getModelController().getString(RoomObjectVariableEnum.const_92);
            if(_loc2_ != null && _loc2_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_92,"");
