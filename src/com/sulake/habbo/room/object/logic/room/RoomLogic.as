package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1581:int = 255;
      
      private var var_1282:uint = 16777215;
      
      private var var_1580:int = 255;
      
      private var var_1013:uint = 16777215;
      
      private var var_1579:int = 255;
      
      private var var_1012:int = 0;
      
      private var var_1582:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_906,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_764,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_594,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_679,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_612,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1012)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1581;
            if(_loc2_ - this.var_1012 >= this.var_1582)
            {
               _loc3_ = this.var_1013;
               _loc4_ = this.var_1579;
               this.var_1012 = 0;
            }
            else
            {
               _loc7_ = this.var_1282 >> 16 & 255;
               _loc8_ = this.var_1282 >> 8 & 255;
               _loc9_ = this.var_1282 & 255;
               _loc10_ = this.var_1013 >> 16 & 255;
               _loc11_ = this.var_1013 >> 8 & 255;
               _loc12_ = this.var_1013 & 255;
               _loc13_ = (_loc2_ - this.var_1012) / this.var_1582;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1580 + (this.var_1579 - this.var_1580) * _loc13_;
               this._color = _loc3_;
               this.var_1581 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_764,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_743:
               param2.setString(RoomObjectVariableEnum.const_599,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_582:
               param2.setString(RoomObjectVariableEnum.const_747,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_631:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_490:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_236)
               {
                  _loc5_ = "null";
               }
               this.var_477.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_710:
               _loc4_ = this.var_477.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_477.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1123,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_997:
               param2.setNumber(RoomObjectVariableEnum.const_594,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_957:
               param2.setNumber(RoomObjectVariableEnum.const_679,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_612,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1013,int(param1.bgOnly));
         this.var_1282 = this._color;
         this.var_1580 = this.var_1581;
         this.var_1013 = _loc3_;
         this.var_1579 = _loc4_;
         this.var_1012 = getTimer();
         this.var_1582 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_441,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1412,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1425,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1365,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_441,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_154 || _loc13_ == RoomPlaneData.const_274)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
