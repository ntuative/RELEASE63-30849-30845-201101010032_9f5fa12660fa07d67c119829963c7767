package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_337,"");
         _loc2_.setString(RoomObjectVariableEnum.const_647,"");
      ...
      {
         super.update(param1);
         if(this.var_1380 > 0 && param1 > this.var_1380)
         {
            this.adDelayTimeout();
            this.var_1380 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1028:
                  _loc2_.setString(RoomObjectVariableEnum.const_337,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_647,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_459,Number(true));
                  this.var_1380 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_934);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_647);
            ...
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_426)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_331,_loc5_,_loc6_));
               }
         }
      }
   }
