package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_607,param1,param2,param3,param4));
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_125:
               this.handleObjectStateChange(param1 as RoomObjectStateChangeEvent,param2,param3);
               break;
            case RoomObjectStateChangeEvent.const_567:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_57:
               ...
               break;
            case RoomObjectMoveEvent.const_397:
               this.handleSelectedObjectMove(param1,param2,param3);
               break;
            case RoomObjectMoveEvent.const_414:
            ...
            case RoomObjectWidgetRequestEvent.const_131:
            case RoomObjectWidgetRequestEvent.const_136:
            case RoomObjectWidgetRequestEvent.const_95:
            case RoomObjectWidgetRequestEvent.const_129:
               this.handleObjectWidgetRequestEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_425:
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF:
            case RoomObjectFurnitureActionEvent.const_525:
            case RoomObjectFurnitureActionEvent.const_473:
            case RoomObjectFurnitureActionEvent.const_543:
            case RoomObjectFurnitureActionEvent.const_412:
            case RoomObjectFurnitureActionEvent.const_427:
               this.handleObjectActionEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START:
            case RoomObjectFurnitureActionEvent.const_472:
            ...
            case RoomObjectFurnitureActionEvent.const_445:
               this.handleObjectJukeboxEvent(param1,param2,param3);
               break;
            case RoomObjectRoomAdEvent.const_275:
            case RoomObjectRoomAdEvent.const_434:
            case RoomObjectRoomAdEvent.const_336:
            case RoomObjectRoomAdEvent.const_331:
               this.handleObjectRoomAdEvent(param1,param2,param3);
               break;
            case RoomObjectRoomActionEvent.const_534:
            case RoomObjectRoomActionEvent.const_1087:
            case RoomObjectRoomActionEvent.const_517:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_244:
               this.handleRoomObjectMouseClick(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_406:
               this.handleRoomObjectMouseMove(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_506:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  else if(_loc8_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc8_ == RoomObjectCategoryEnum.const_27)
                  {
                     if(param1.ctrlKey)
                     {
                  ...
                  if(_loc10_ != null)
                  {
                     ...
                     if(_loc13_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_146,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_75)
         {
            _loc14_ = this.getMouseEventId(RoomObjectCategoryEnum.const_146,MouseEvent.CLICK);
            _loc15_ = this.getMouseEventId(RoomObjectCategoryEnum.OBJECT_CATEGORY_USER,MouseEvent.CLICK);
            if(_loc14_ != _loc10_ && _loc15_ != _loc10_)
            {
               _loc16_ = this._roomEngine.events;
               if(_loc16_ != null)
               {
                  _loc16_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_489,param2,param3,-1,RoomObjectCategoryEnum.const_146));
               }
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_478);
               }
               else
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_527);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
      ...
      private function handleRoomObjectMouseDown(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc8_ == RoomObjectCategoryEnum.const_27)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_713,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = true;
            if(_loc5_.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE)
            {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_27)
            {
               _loc7_ = false;
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            if(_loc5_.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE && _loc8_ != null)
            {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_27 && _loc9_ != null)
            {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER && _loc8_ != null)
            {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_815);
         ...
         if(_loc7_ != null)
         {
            switch(param1.type)
            {
               ...
               case RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_STICKIE:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_121:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_121,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_130:
               ...
               case RoomObjectWidgetRequestEvent.const_117:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_131:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_131,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_136:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_136,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_95:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_95,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_129:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_605));
               break;
            case RoomObjectFurnitureActionEvent.const_472:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_768));
               break;
            case RoomObjectFurnitureActionEvent.const_418:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_530));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_505:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_782));
               break;
            case RoomObjectFurnitureActionEvent.const_445:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_530));
         }
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_284);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_382);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_284);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_382);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_284);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_795);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_1051);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_286,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1295,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_478));
            }
            else
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_527));
            }
         }
      }
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_815);
         }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:int, param4:int, param5:String) : Boolean
      {
         ...
         switch(param5)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_MOVE_TO:
               ...
               if(this._roomEngine.connection)
               {
                  if(param4 == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE)
                  {
                  ...
                  else if(param4 == RoomObjectCategoryEnum.const_27)
                  {
                     _loc9_ = int(_loc6_.getDirection().x) % 360;
                     ...
                     if(this._roomEngine.connection && _loc11_)
                     {
                        ...
                        {
                           this._roomEngine.connection.send(new PickupObjectMessageComposer(param3,param4));
                           this._roomEngine.connection.send(new PlaceObjectMessageComposer(param3,RoomObjectCategoryEnum.const_27,_loc12_,0,0,0));
                        }
                     }
                  }
               }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc5_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc8_ = _loc12_.x;
                  _loc9_ = _loc12_.y;
               }
               else if(_loc5_ == RoomObjectCategoryEnum.const_27)
               {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER && _loc3_.typeId == RoomObjectTypeEnum.const_248)
               {
         ...
         {
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_200,param1,param2,_loc4_,_loc5_));
         }
      }
      ...
      private function changeObjectState(param1:int, param2:int, param3:int, param4:String, param5:int, param6:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc7_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE)
            {
               if(!param6)
               {
            ...
            else if(_loc7_ == RoomObjectCategoryEnum.const_27)
            {
