package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_766:String = "RCL_LOADER_READY";
      
      private static const const_310:String = "RCL_PUBLICROOM_";
      
      private static const const_1589:int = 0;
      
      private static const const_864:int = 1;
      
      private static const name_2:int = 2;
      
      private static const const_391:String = "place_holder";
      
      private static const const_556:String = "wall_place_holder";
      
      private static const const_1221:String = const_391;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_866:String = "tile_cursor";
      
      private static const const_865:String = "selection_arrow";
      ...
      private var var_1399:IEventDispatcher = null;
      
      private var var_687:Boolean = false;
      
      private var var_2543:Boolean = false;
      
      private var var_604:Map = null;
      ...
      public function RoomContentLoader()
      {
         this.var_607 = [];
         this._wallItems = [];
         this.var_2540 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2545 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_864)
         {
            return;
         }
         this.var_1399 = param1;
         this.var_2542 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2546 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2544 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2541 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_864;
         this.initFurniData();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_406.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_406.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_728.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_604.add(_loc3_,_loc4_);
               if(this.var_607.indexOf(_loc7_) < 0)
               {
                  this.var_607.push(_loc7_);
               }
            }
            ...
            _loc8_ = this.var_605.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_605.remove(_loc7_);
               this.var_605.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2543)
         {
            ...
            {
               this.var_1399.dispatchEvent(new Event(const_766));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_490 != null)
         {
            ...
            this.var_490.add(param1,param2);
         }
         if(this.var_488 != null)
         {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_607.indexOf(param1) >= 0)
         {
         ...
         {
            return RoomObjectCategoryEnum.const_75;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_75;
         ...
         {
            return RoomObjectCategoryEnum.const_307;
         }
         return RoomObjectCategoryEnum.const_146;
      }
      ...
      {
         return [const_391,const_556,ROOM_CONTENT,const_866,const_865];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_604.getValue(param1) as String;
      ...
      {
         if(this.var_728.getValue(param1) != null)
         {
            return this.var_728.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_187 != null && this.var_187.hasWorldType(const_310 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_179 || param1 == RoomObjectVisualizationEnum.const_63 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_605.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2541;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2544 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_607.indexOf(_loc4_) == -1)
                     {
                        this.var_607.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_346,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1398.getValue(param1) != null)
         {
            this.var_187 = this.var_1398.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2540.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1503);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2545.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1398.add(_loc5_,_loc8_);
               this.var_187 = _loc8_;
               this.extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_346,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_512,_loc5_);
         }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_729.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_729.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_729.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_204 && _loc5_ != RoomObjectLogicEnum.const_179)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_422.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_406.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_406.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_406[_loc2_] != null)
         {
            _loc3_ = this.var_406.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_310 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_310 + param1) == RoomObjectCategoryEnum.const_75)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_187.getWorldHeightScale(const_310 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_187 != null)
         {
            return this.var_187.getWorldScale(const_310 + param1);
         }
         return 32;
      }
