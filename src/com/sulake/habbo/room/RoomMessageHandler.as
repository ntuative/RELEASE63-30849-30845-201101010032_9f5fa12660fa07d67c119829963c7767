package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1747:Boolean = true;
      
      private var var_1376:int = -1.0E9;
      
      private var var_712:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_712 = new Object();
         super();
         this.var_12 = param1;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_712.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_712.objectData);
            this.var_712.objectData = null;
         }
         else
         {
            this.var_712.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_712.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_712.objectData = _loc6_;
         }
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.getUserCount())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               this.var_12.addObjectUser(_loc4_,_loc5_,_loc7_.id,_loc8_,_loc9_,_loc7_.dir,_loc7_.userType);
               if(_loc7_.webID == this.var_2441)
               {
               ...
               this.var_12.updateObjectUserState(_loc4_,_loc5_,_loc7_.id,_loc10_);
            }
            _loc6_++;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_625);
         var _loc8_:int = 0;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1054:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1093:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1122,_loc3_.status);
         }
      }
