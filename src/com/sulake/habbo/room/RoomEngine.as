package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_559:String = "temporary_room";
      
      private static const const_312:int = -1;
      
      private static const const_560:String = "room";
      
      private static const const_879:int = -2;
      
      private static const const_1239:String = "tile_cursor";
      
      private static const const_877:int = -3;
      
      private static const const_1240:String = "selection_arrow";
      
      private static const const_878:String = "overlay";
      
      private static const const_311:String = "object_icon_sprite";
      
      private static const const_394:int = 15;
      ...
      private var var_23:IRoomObjectFactory = null;
      
      private var var_422:IRoomObjectVisualizationFactory = null;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_23 != null)
         {
            this.var_23.release(new IIDRoomObjectFactory());
            this.var_23 = null;
         }
         if(this.var_422 != null)
         {
            this.var_422.release(new IIDRoomObjectVisualizationFactory());
            this.var_422 = null;
         }
         if(this.var_42 != null)
         {
         ...
         if(this.var_347 != null)
         {
            ...
            {
               _loc2_ = this.var_347.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_347.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_347.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = this.var_42.getRoom(this.getRoomIdentifier(this.var_98,this.var_97));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_347.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_98 || _loc6_ != this.var_97 || !this.var_1155)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_563) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_808) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_694) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_683) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_23 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_422 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_14 != null)
         {
            this.var_14.visualizationFactory = this.var_422;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_42 != null)
         {
            ...
            this.var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_307);
            this.var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_75);
            this.var_42.setContentLoader(this.var_14);
         }
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            events.addEventListener(RoomContentLoader.const_766,this.onContentLoaderReady);
            this.var_14.initialize(events,this._habboConfiguration);
         }
         this.initializeRoomManager();
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_766)
         {
            this.var_2613 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_273.events.addEventListener(AdEvent.const_399,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_14.sessionDataManager = this.var_370;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_23 != null)
         {
            if(this.var_23.events != null)
            {
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_244,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_406,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_506,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_125,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_567,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_127,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_118,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_STICKIE,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_121,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_130,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_117,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_131,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_136,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_95,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_129,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_425,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_525,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_427,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_473,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_543,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_412,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_472,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_418,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_505,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_445,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_57,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_397,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_414,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_275,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_434,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_336,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_331,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_534,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_1087,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_517,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_23 == null || this.var_422 == null || this.var_42 == null || this.var_929 == null || this._communication == null || this._habboConfiguration == null || !this.var_2613)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_499 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_703,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_348.length)
            {
               _loc3_ = this.var_348.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_996,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_482,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_422,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_996);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_499)
         {
            _loc5_ = this.var_348.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_348.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_643,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         {
            _loc12_ = this.var_14.getPublicRoomContentType(param6);
            _loc9_ = _loc7_.createRoomObject(const_312,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_952,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_790,1,true);
            _loc13_ = parseInt(this._habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_934,_loc13_,true);
            if(this.var_14 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_312,const_560,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_790,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_625,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_563,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_694,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_808,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_683,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1064,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_743,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_582,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_631,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_490,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_236);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_650,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_589,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_650,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_589,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_992,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1076,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_879,const_1239,RoomObjectCategoryEnum.const_307);
         _loc7_.createRoomObject(const_877,const_1240,RoomObjectCategoryEnum.const_307);
         return _loc7_;
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_312,RoomObjectCategoryEnum.const_75);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_348.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_348.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_743,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_582,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_631,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1349,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_957,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_997,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_347.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_776,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_979;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_625);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_650);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_589);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_992);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1076);
      ...
      {
         var _loc8_:int = param2 - this.var_1419;
         var _loc9_:int = param3 - this.var_1418;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1155 = true;
               this.var_930 = false;
               this.var_2614 = this.var_1419;
               this.var_2612 = this.var_1418;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1155)
            {
               if(!this.var_930)
               {
                  _loc8_ = param2 - this.var_2614;
                  _loc9_ = param3 - this.var_2612;
                  if(_loc8_ <= -const_394 || _loc8_ >= const_394 || _loc9_ <= -const_394 || _loc9_ >= const_394)
                  {
                     this.var_930 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_97,param1);
         if(_loc9_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc9_);
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_311);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_489,this.var_98,this.var_97,-1,RoomObjectCategoryEnum.const_146));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_69 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_312,const_560);
                     this.var_69.handleRoomObjectEvent(_loc14_,this.var_98,this.var_97);
                  }
               }
            }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_878) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = this.getRoomObjectImage(this.var_98,this.var_97,param1,param2,new Vector3d(),1,null);
         }
         else if(this.var_14 != null)
         {
            ...
            {
               _loc8_ = this.var_14.getActiveObjectType(param1);
               _loc9_ = this.var_14.getActiveObjectColorIndex(param1);
            }
            else if(param2 == RoomObjectCategoryEnum.const_27)
            {
               _loc8_ = this.var_14.getWallItemType(param1,param4);
               _loc9_ = this.var_14.getWallItemColorIndex(param1);
            }
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_97,this.var_1417);
         if(_loc7_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc7_);
            this.removeOverlayIconSprite(_loc10_,const_311);
            _loc11_ = this.addOverlayIconSprite(_loc10_,const_311,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1419 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1418 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_97,this.var_1417);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_311);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_97,this.var_1417);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_311);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_69 != null)
         {
            return this.var_69.modifyRoomObject(this.var_98,this.var_97,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_69 != null)
         {
            ...
            {
               return this.var_69.modifyWallItemData(this.var_98,this.var_97,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_69 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_69.deleteWallItem(this.var_98,this.var_97,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_98,this.var_97);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_790) != 0)
         {
            return false;
         }
         if(this.var_69 != null)
         {
            return this.var_69.initializeRoomObjectInsert(this.var_98,this.var_97,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_69 != null)
         {
            this.var_69.cancelRoomObjectInsert(this.var_98,this.var_97);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_877,RoomObjectCategoryEnum.const_307);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_879,RoomObjectCategoryEnum.const_307);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_207,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_334,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_360,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1115,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_933,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1050,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_296,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         {
            _loc13_ = this.var_14.getPublicRoomContentType(_loc10_) + "_";
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_207,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_334,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_360,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_979,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_296,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1083) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_963);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_490,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_710,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_296,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_318);
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_565,this.var_98,this.var_97,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_69 != null)
         {
            this.var_69.handleRoomObjectEvent(param1,this.var_98,this.var_97);
         }
      }
      ...
      public function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(this.var_14 != null)
         {
            ...
            _loc8_ = String(this.var_14.getActiveObjectColorIndex(param1));
         }
      ...
      public function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(this.var_14 != null)
         {
            _loc7_ = this.var_14.getWallItemType(param1,param5);
            _loc8_ = String(this.var_14.getWallItemColorIndex(param1));
         }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_207));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_430);
                     break;
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_171);
               }
            }
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!this.var_499 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = this.var_42.getRoom(const_559);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_42.createRoom(const_559,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_207,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_430,param8);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_171,param2);
               break;
            case RoomObjectCategoryEnum.const_75:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_174,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_154,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_154,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_599,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_747,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_754,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_490,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            this.var_1154.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1025,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_98,this.var_97,const_312,RoomObjectCategoryEnum.const_75,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_42.getRoom(const_559);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1025);
               ...
               _loc13_ = this.var_1154.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_92);
            if(_loc7_ != null)
            {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_337,param1.image,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_916,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_899,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1028,RoomObjectVariableEnum.const_337,param1.clickUrl);
