package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_386:uint = 3;
      
      private static const const_1153:uint = 1;
      ...
      private var var_826:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_301:Array;
      
      private var var_1260:IEventDispatcher;
      
      private var var_998:Boolean = false;
      
      private var var_1552:ProfilerOutput;
      
      private var var_1258:ProfilerAgentTask;
      
      private var var_1259:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_826 = new WindowRenderer(this._skinContainer);
         this.var_176 = new Array(const_386);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_386)
         {
            this.var_176[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_826,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_229 = this.var_176[const_1153];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_229.getMouseCursor().defineCustomCursorType(MouseCursorType.const_369,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_229.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1392,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1552)
            {
               this.var_1552 = new ProfilerOutput(context,this,this.var_826);
            }
            this.var_1552.profiler = _loc3_;
            this.var_1258 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1258);
            this.var_1259 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1259);
            this.var_998 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_176)
            {
               while(this.var_176.length > 0)
               {
                  IDisposable(this.var_176.pop()).dispose();
               }
            }
            this.var_176 = null;
            if(this.var_301)
      ...
      {
         return this.var_229.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_229.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_301[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_301[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_176[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_176[param2].getDesktopWindow();
      ...
      {
         return this.var_176[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_176[param1].getDesktopWindow().getChildAt(this.var_229.getDesktopWindow().numChildren - 1);
      }
      
      public function getWindowContext(param1:uint) : IWindowContext
      {
         return this.var_176[param1];
      }
      
      public function getDesktop(param1:uint) : IDesktopWindow
      {
         var _loc2_:IWindowContext = this.var_176[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_352.length > 0)
         {
            this.var_1260.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_386 - 1;
            while(_loc2_ >= 0)
            {
               this.var_176[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_998)
         ...
         this.var_1260.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_386)
         {
            this.var_176[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_998)
         {
         ...
         if(WindowContext.var_352.length > 0)
         {
            WindowContext.var_352.flush();
         }
         this.var_1260.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1359,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1489,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1310,param2.name + ": " + param2.toString());
            }
         }
      }
   }
