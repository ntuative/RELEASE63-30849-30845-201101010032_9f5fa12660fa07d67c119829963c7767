package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialogWithLink extends AlertDialog implements IAlertDialogWithLink
   {
      ...
      protected var var_1921:String = "";
      
      protected var var_1922:String = "";
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_link":
                  HabboWebTools.navigateToURL(this.var_1922,"_empty");
                  return;
            }
         }
      ...
      public function set linkTitle(param1:String) : void
      {
         ...
         if(_window)
         {
            IButtonWindow(_window.findChildByTag("LINK")).caption = this.var_1921;
         }
      }
