package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_1056:String = "-1";
      
      private var var_278:ToolbarBarMenuAnimator;
      
      private var var_1055:ToolbarIconBouncer;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         this.var_1055 = new ToolbarIconBouncer(0.8,1);
         super();
         this.var_468 = param1;
         ...
         this.var_313 = this._region.findChildByName("label") as ITextWindow;
      }
      ...
      public function set exists(param1:Boolean) : void
      {
         ...
         if(this._region != null)
         {
            this._region.visible = this.var_1058;
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         this.var_2324 = int(param1.@window_offset_from_icon);
         this.var_2166 = int(param1.@window_margin);
         this.var_2700 = param1.@label;
         ...
         if(_loc2_.length() > 0)
         {
            ...
            {
               this.var_1056 = param1.@state_default;
            }
            _loc3_ = 0;
            while(_loc3_ < _loc2_.length())
            {
               ...
               this.var_1059.push(_loc5_.id);
               this.var_1674.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(this.var_1329 == "-1")
                  {
                     this.var_1329 = _loc5_.id;
                  }
                  if(this.var_1056 == "-1")
                  {
                     this.var_1056 = _loc5_.id;
                  }
               }
               _loc3_++;
            }
         }
         this._state = this.var_1056;
      }
      ...
      private function setAnimator() : void
      {
         ...
         if(_loc1_ != null && this.var_1058)
         {
            if(_loc1_.frames == null)
            {
               return;
            }
            this.var_571 = new ToolbarIconAnimator(_loc1_,this._assetLibrary,this._icon,this._x,this.var_159,this._bitmapData);
            if(this.var_571.frameCount > 0)
            {
               this.var_874 = new Timer(_loc1_.timer);
               this.var_874.addEventListener(TimerEvent.TIMER,this.updateAnimator);
               this.var_874.start();
            }
            if(_loc1_.bounce)
            {
               this.var_1055.reset(-7);
               this.var_1328.reset();
               this.var_1328.start();
            }
         }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = this.var_1057[this.var_692.indexOf(param1)];
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         ...
         {
            this.var_278.animateWindowIn(this,param1,param2,this.var_691,param3,param4,this.getMenuYieldList(param1));
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer, param3:String) : void
      {
         if(this.var_278 != null)
         {
            this.var_278.animateWindowOut(this,param1,param2,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_278 != null)
         {
            this.var_278.positionWindow(this,param1,param2,this.var_691,param3,this.getMenuYieldList(param1));
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_278 != null)
         {
            this.var_278.hideWindow(param1,param2,this.var_691,param3);
         }
      }
      ...
      {
         return this.var_1674[this.var_1059.indexOf(param1)];
      }
      ...
      private function setLabel() : void
      {
         ...
         {
            this.var_313.caption = "${toolbar.icon.label." + _loc1_.label + "}";
         }
         else
         {
            this.var_313.caption = "${toolbar.icon.label." + this.var_1327.toLowerCase() + "}";
         }
         this.updateRegion();
      }
      ...
      {
         return this.var_2166 + this.var_468.windowMargin;
      }
      ...
      {
         if(this.var_1055 != null && this._icon != null)
         {
            this.var_1055.update();
            this._icon.y = this.var_1055.location;
         }
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(this.var_278)
               {
                  this.var_278.repositionWindow(this.var_691,true);
               }
      ...
      private function updateRegion() : void
      {
         ...
         this.var_313.y = this._icon.height;
         this._region.width = Math.max(this._icon.width,this.var_313.width);
         this._region.height = this._icon.height + this.var_313.height;
         this._icon.x = (this._region.width - this._icon.width) / 2;
         this.var_313.x = (this._region.width - this.var_313.width) / 2;
         var _loc1_:Boolean = this.var_468.orientation == "LEFT" || this.var_468.orientation == "RIGHT";
         if(_loc1_)
         {
            this._x = (this.var_468.toolbarUsableWidth - this._region.width) / 2;
            this.var_159 = this.var_1152 + (this.var_468.iconSize - this._region.height) / 2;
         }
         else
         {
            this._x = this.var_1152 + (this.var_468.iconSize - this._region.width) / 2;
            this.var_159 = (this.var_468.toolbarUsableWidth - this._region.height) / 2;
         }
