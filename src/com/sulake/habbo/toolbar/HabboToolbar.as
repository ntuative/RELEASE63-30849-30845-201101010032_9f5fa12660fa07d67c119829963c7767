package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1315:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_262.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "ClubGiftController")
         {
            this.var_1315 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_103,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1042,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_156,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_455,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_980,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_995,this.onHideWindowEvent);
         this._state = true;
