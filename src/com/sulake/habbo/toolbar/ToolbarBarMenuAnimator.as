package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_198:Boolean = true;
      
      private static const const_1204:Number = 25;
      
      private static const const_1227:Number = 90;
      
      private static const const_851:int = 50;
      
      private static const const_1203:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1369:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_585 = new Object();
         this.var_586 = new Array();
         this.var_587 = new Array();
         super();
         this._windowManager = param1;
         this.var_1369 = param2;
         this.var_707 = new Timer(const_1204);
         this.var_707.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_330[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_851 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_851 || param1.desktop.height - param1.y < const_1203;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1369.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_330.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1369.getIconLoc(param1.iconId);
      ...
      {
         return this.var_586[this.var_587.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_587[this.var_586.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_587.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_587.splice(_loc3_,1);
            this.var_586.splice(_loc3_,1);
         }
         this.var_586.push(param1.name);
         this.var_587.push(param2);
         param1.addEventListener(WindowEvent.const_377,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_233,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_585[_loc3_] == null)
            {
               this.var_585[_loc3_] = new Array();
            }
            if(this.var_585[_loc3_].indexOf(param1) < 0)
            {
               this.var_585[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_330.indexOf(param1) > -1)
         {
            if(const_198)
            {
            ...
            else
            {
               ...
               this.var_330.splice(this.var_330.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_586.length)
         {
            if(this.var_586[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_587[_loc2_];
               if(this.var_585[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_585[_loc3_].length)
                  {
                     this.repositionWindow(this.var_585[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         if(this.var_330.length == 0)
         {
            this.var_707.stop();
         }
         var _loc7_:int = 0;
         while(_loc7_ < this.var_330.length)
         {
            _loc2_ = this._itemList[this.var_330[_loc7_]];
            if(_loc2_.active)
            {
