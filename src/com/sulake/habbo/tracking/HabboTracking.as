package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_58:IRoomWidgetFactory;
      ...
      private var var_186:IHabboFriendList;
      
      private var var_1100:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_163:IHabboHelp;
      ...
      private var var_250:PerformanceTracker = null;
      
      private var var_592:FramerateTracker = null;
      
      private var var_249:LatencyTracker = null;
      
      private var var_593:LagWarningLogger = null;
      
      private var var_594:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_250 = new PerformanceTracker();
         this.var_592 = new FramerateTracker();
         this.var_249 = new LatencyTracker();
         this.var_593 = new LagWarningLogger();
         this.var_594 = new ToolbarClickTracker(this);
         this.var_1379 = new Array(const_854);
         var _loc4_:int = 0;
         while(_loc4_ < const_854)
         {
            this.var_1379[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1476,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1291,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1512,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_685,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1101,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1100)
            {
               this.var_1100.release(new IIDHabboWindowManager());
               this.var_1100 = null;
            }
            if(this.var_273)
            {
            ...
            if(this.var_58)
            {
               this.var_58.release(new IIDHabboRoomWidget());
               this.var_58 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_186)
            {
               if(!this.var_186.disposed)
               {
                  Component(this.var_186).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_186).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_186).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_186).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_186).events.removeEventListener(HabboFriendListTrackingEvent.const_339,this.onFriendlistTrackingEvent);
               }
               this.var_186.release(new IIDHabboFriendList());
               this.var_186 = null;
            }
            if(this.var_163)
            {
               if(!this.var_163.disposed)
               {
                  this.var_163.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_163.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_163.release(new IIDHabboHelp());
               this.var_163 = null;
            }
            if(this._toolbar)
            {
               ...
               {
                  this._toolbar.events.removeEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_249 != null)
            {
               this.var_249.configuration = this._configuration;
            }
            if(this.var_250 != null)
            {
               this.var_250.configuration = this._configuration;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1516);
            if(this._configuration)
            {
               if(this.var_593 != null)
               {
                  this.var_593.configure(this._configuration);
               }
               if(this.var_592 != null)
               {
                  this.var_592.configure(this._configuration);
               }
               if(this.var_594 != null)
               {
                  this.var_594.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_143);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_629,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_199,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_166,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_217,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_745,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_64,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_479,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_249 != null)
            {
               this.var_249.communication = this._communication;
               this.var_249.connection = param1;
            }
            if(this.var_593 != null)
            {
               this.var_593.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_745)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1317);
         }
         else if(param1.type == HabboHotelViewEvent.const_479)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1428);
         }
         else if(param1.type == HabboHotelViewEvent.const_64)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1520);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1378);
               break;
            case HabboCommunicationEvent.const_629:
               this.trackLoginStep(HabboLoginTrackingStep.const_1445,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_199:
               this.trackLoginStep(HabboLoginTrackingStep.const_199);
               break;
            ...
            case HabboCommunicationEvent.const_251:
               ...
               break;
            case HabboCommunicationEvent.const_217:
               this.trackLoginStep(HabboLoginTrackingStep.const_217);
         }
         if(this._communication)
         {
      ...
      {
         this.var_1100 = IHabboWindowManager(param2);
         if(this.var_1100)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1379)
                  {
                  ...
                  if(this.var_250 != null)
                  {
                     _loc4_["null"] = this.var_250.flashVersion;
                     _loc4_["null"] = this.var_250.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1007);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1007,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_186 = param2 as IHabboFriendList;
         Component(this.var_186).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_186).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_186).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_186).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_186).events.addEventListener(HabboFriendListTrackingEvent.const_339,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_58 = param2 as IRoomWidgetFactory;
         Component(this.var_58).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_58).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_58).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_58).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_163 = param2 as IHabboHelp;
         this.var_163.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_163.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2458)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1351);
            this.var_2458 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1101,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_685,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_275,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_273 = param2 as IAdManager;
         this.var_273.events.addEventListener(AdEvent.const_399,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._toolbar = param2 as IHabboToolbar;
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_594)
         {
            this.var_594.track(param1.iconName);
         }
      }
      ...
      {
         this.var_593.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_484 > -1 && _loc2_ < this.var_484)
         {
            ++this.var_1756;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1756);
         }
         if(this.var_484 > -1 && _loc2_ - this.var_484 > 15000)
         {
            ++this.var_1757;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1757);
         }
         this.var_484 = _loc2_;
         if(this.var_250 != null)
         {
            this.var_250.update(param1,this.var_484);
         }
         if(this.var_249 != null)
         {
            this.var_249.update(param1,this.var_484);
         }
         if(this.var_592 != null)
         {
            this.var_592.trackUpdate(param1,this,this.var_484);
         }
         if(this.var_593 != null)
         {
            this.var_593.update(this.var_484);
         }
      }
   }
}
