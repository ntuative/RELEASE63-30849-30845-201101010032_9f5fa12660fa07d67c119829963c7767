package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         this.var_716 = main.component.userRegistry.getRegistry();
         if(this.var_716.length == 0)
         {
         ...
         {
            user = this.var_716.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > this.var_716.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = this.var_716.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
