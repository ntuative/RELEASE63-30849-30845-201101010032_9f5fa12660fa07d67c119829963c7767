package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1172:int = 0;
      
      private static const const_388:int = 1;
      ...
      override public function render() : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc7_ != 0)
            {
               this.var_686.push(_loc7_);
            }
         }
         _loc6_ = 0;
         while(_loc6_ < this.var_686.length)
         {
            _loc8_ = this.var_686[_loc6_];
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_686 == null || _loc3_ < 0 || _loc3_ >= this.var_686.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_686[_loc3_];
            main.showUI(HabboHelpViewEnum.const_697);
            main.tellUI(HabboHelpViewEnum.const_697,null);
         }
      }
   }
}
