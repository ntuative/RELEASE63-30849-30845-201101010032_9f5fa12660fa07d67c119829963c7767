package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1280:uint = 13232628;
      
      private static var var_1577:uint = 11129827;
      ...
      private var var_1011:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_363;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_444 = param1;
         if(this.var_1576 == this.var_444)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1575 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_674)
         {
            this.var_674 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_674)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_673)
         {
            this.var_673 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_673)
            {
               return;
            }
            this._window.content.addChild(this.var_673);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_673.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_444;
         }
         this.showView(this.var_673);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_444);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_767:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_768:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_765:
               break;
            case ChangeUserNameResultMessageEvent.var_766:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_764:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_945 || param1 == ChangeUserNameResultMessageEvent.var_946)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1011 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1011.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1280;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_444 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_444 != _loc5_)
               {
                  this.var_1576 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_444);
               break;
