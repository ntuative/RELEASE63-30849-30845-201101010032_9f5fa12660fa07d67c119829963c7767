package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialCallGuideBotView implements ITutorialUIView
   {
      ...
      public function TutorialCallGuideBotView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_47.prepareForTutorial();
         this.var_47.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_48,this.onShowMenuEvent);
      }
      ...
      {
         return TutorialUI.const_514;
      }
      
      public function dispose() : void
      {
         this.setToolbarIconHighlight(false);
         this.var_47.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_48,this.onShowMenuEvent);
      }
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_96,HabboToolbarIconEnum.HELP);
         if(param1)
         {
         ...
         this.var_47.help.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_664 = this.var_47.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_664.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
            _loc2_ = BitmapDataAsset(this.var_47.assets.getAssetByName("tutorial_highlight_blue_arrow"));
            _loc1_.bitmap = (_loc2_.content as BitmapData).clone();
         }
         this.var_47.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.HELP_ARROW,this.var_664));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_47.showView(TutorialUI.const_85);
               }
         }
      }
   }
