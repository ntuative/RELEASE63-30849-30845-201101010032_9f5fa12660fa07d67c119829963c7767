package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new UserChangeMessageEvent(this.onUserChange));
         ...
         _loc3_.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_344)
            {
               this._component.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_2202 = _loc5_.id;
            }
            _loc4_++;
         }
         this._component.tellUI(HabboHelpViewEnum.const_817);
      }
      ...
      {
         this._component.showUI(HabboHelpViewEnum.const_319);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_162);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_540);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_285,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this._component.tellUI(HabboHelpViewEnum.const_208,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_737);
         this._component.tellUI(HabboHelpViewEnum.const_737,_loc5_);
      }
      ...
      private function onStartRegistration(param1:StartRegistrationEvent) : void
      {
         this._component.initRegistrationUI();
      }
   }
}
