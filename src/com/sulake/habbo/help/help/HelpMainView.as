package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends SearchViewController implements IHelpViewController
   {
      ...
      private static const const_1202:int = 60;
      ...
      override public function render() : void
      {
         ...
         var _loc2_:IWindow = container.findChildByName("help_habboway_text");
         if(_loc2_ != null)
         {
            _loc2_.setParamFlag(WindowParam.const_28);
            _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onHabboWay);
         }
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1202)
         {
         ...
         if(_loc7_ != null)
         {
            _loc8_ = assetLibrary.getAssetByName("guidebot_icon_png").content as BitmapData;
            _loc7_.bitmap = new BitmapData(_loc7_.width,_loc7_.height,true);
            _loc7_.bitmap.copyPixels(_loc8_,_loc8_.rect,new Point(0,0));
         }
         super.render();
         this.update();
      }
      ...
      {
         main.showUI(HabboHelpViewEnum.const_540);
      }
      
      private function onHabboWay(param1:WindowMouseEvent) : void
      {
         var _loc2_:String = main.getText("help.button.habboway.url","");
         if(_loc2_ != "")
         {
            this.openWebPage(_loc2_);
         }
      }
      ...
      private function onCallForHelp(param1:WindowMouseEvent) : void
      {
         ...
         main.showUI(HabboHelpViewEnum.const_319);
      }
      
      private function onReportUser(param1:WindowMouseEvent) : void
      {
         main.component.callForHelpData.reportedUserId = 0;
         main.showUI(HabboHelpViewEnum.const_817);
      }
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            main.showUI(HabboHelpViewEnum.const_208);
            main.tellUI(HabboHelpViewEnum.const_208,_loc6_);
         }
      }
