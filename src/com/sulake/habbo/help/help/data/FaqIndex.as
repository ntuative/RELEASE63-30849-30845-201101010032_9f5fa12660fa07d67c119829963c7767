package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_748:FaqCategory;
      
      private var var_747:FaqCategory;
      ...
      {
         super();
         this.var_746 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_748 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_747 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_748.hasItem(param1))
         {
            this.var_748.getItem(param1).answerText = param2;
         }
         if(this.var_747.hasItem(param1))
         {
            this.var_747.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_748.hasItem(param1))
         {
            return this.var_748.getItem(param1);
         }
         if(this.var_747.hasItem(param1))
         {
            return this.var_747.getItem(param1);
         }
         var _loc2_:int = 0;
