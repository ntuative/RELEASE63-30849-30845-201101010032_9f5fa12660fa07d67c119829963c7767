package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1570:int = 0;
      
      private static const const_1571:int = 0;
      ...
      {
         this.var_311 = this._defaultViewId;
         this.var_464 = new Array();
         this.var_566 = new Array();
         super();
         this._component = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012312337));
         this._toolbar = param5;
         this.var_95 = new Map();
         this.var_95.add(HabboHelpViewEnum.const_1513,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_162,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_540,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_285,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_208,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_737,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_319,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_697,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_229,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_95.add(HabboHelpViewEnum.const_930,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_95.add(HabboHelpViewEnum.const_975,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_817,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_464.length == 0 || param1 != this.var_311)
            {
               this.var_464.push(this.var_311);
            }
         }
         this.var_311 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_311);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_229:
               this.showUI(HabboHelpViewEnum.const_229);
               break;
            case CallForHelpResultEnum.const_1034:
               this.showUI(HabboHelpViewEnum.const_975);
               break;
            case CallForHelpResultEnum.const_1009:
               this.showUI(HabboHelpViewEnum.const_930);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_95.getValue(HabboHelpViewEnum.const_162) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_436));
      }
      ...
      {
         return this.var_95.getValue(this.var_311);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1644 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1643;
         this._window.width = _loc1_.width + this.var_1644;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_464.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_311 == HabboHelpViewEnum.const_162)
         {
            return;
         }
         if(this.var_566.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_566.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_566.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_310.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_566[1],this.var_566[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_566[0],this.var_566[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_311 == HabboHelpViewEnum.const_162 || this.var_464.length == 0)
         {
            return;
         }
         if(this.var_310 == null)
         {
            ...
            this.var_310 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_310.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_310.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_310 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_310 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_310 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
