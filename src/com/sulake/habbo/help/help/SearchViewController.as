package com.sulake.habbo.help.help
{
   ...
   public class SearchViewController extends HelpViewController
   {
      ...
      private static const const_1173:int = 3;
      ...
      override public function render() : void
      {
         ...
         if(container != null)
         {
            ...
            if(_loc1_ != null)
            {
               ...
               _loc1_.addEventListener(WindowKeyboardEvent.const_148,this.windowKeyEventProcessor);
               _loc1_.addEventListener(WindowEvent.const_181,this.onInputClick);
            }
