package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function render() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.setParamFlag(WindowParam.const_28);
         ...
         if(_loc2_ != null)
         {
            _loc2_.setParamFlag(WindowParam.const_28);
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(param1 != null)
         {
            this.var_212 = FaqItem(param1);
         }
         if(this.var_212 == null)
         {
            return;
         }
         if(!this.var_212.hasAnswer)
         {
            main.sendMessage(new GetFaqTextMessageComposer(this.var_212.questionId));
            return;
         }
         var _loc3_:FaqCategory = this.var_212.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = this.var_212.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = this.hackHTML(this.var_212.answerText);
         }
         if(_loc3_ != null)
         {
            _loc5_ = _loc3_.getItemByIndex(this.var_212.index + 1);
         }
         ...
         if(_loc4_ != null)
         {
            if(_loc5_ != null)
            {
               ...
               _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onNextEntry);
            }
            else
            {
               _loc4_.text = "";
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_212 != null)
         {
            _loc2_ = this.var_212.category;
            main.showUI(HabboHelpViewEnum.const_285);
            main.tellUI(HabboHelpViewEnum.const_285,_loc2_);
         }
      }
      ...
      private function onNextEntry(param1:WindowMouseEvent) : void
      {
         ...
         {
            main.tellUI(HabboHelpViewEnum.const_208,this.getNextItem());
         }
      }
      
      private function onFaqAnswerClick(param1:WindowLinkEvent) : void
      {
         HabboWebTools.openWebPage(param1.link,"_blank");
      }
      
      private function getNextItem() : FaqItem
      {
         var _loc1_:FaqIndex = main.getFaq();
         if(_loc1_ == null || this.var_212 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = this.var_212.category;
         if(_loc2_ == null)
         {
            return null;
         }
         return _loc2_.getItemByIndex(this.var_212.index + 1);
      }
   }
}
