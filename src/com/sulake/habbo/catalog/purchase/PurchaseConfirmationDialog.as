package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_87:IPurchasableOffer;
      ...
      private var var_572:IWindowContainer;
      
      private var var_316:int = -1;
      
      private const const_1858:int = 10;
      ...
      private const const_1584:uint = 4.293848814E9;
      
      private const const_1583:uint = 4.294967295E9;
      
      private const const_1859:uint = 4.291613146E9;
      ...
      {
         if(this.var_87 == null || this.var_87.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_87.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_87.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_87 is Offer)
            {
               _loc10_ = this.var_87.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_87 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
      ...
      {
         var _loc1_:IProductData = this._catalog.getProductData(this.var_87.localizationId);
         ...
         var _loc3_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,this.var_87);
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1683 = _loc1_.stuffTypes;
            this.var_694 = _loc1_.boxTypes;
            this.var_693 = _loc1_.ribbonTypes;
            this.var_1064 = this.var_1683[0];
            this.var_315 = this.var_694[0];
            this.var_317 = this.var_693[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_317 < 0)
         {
            this.var_317 = this.var_693.length - 1;
         }
         if(this.var_317 > this.var_693.length - 1)
         {
            this.var_317 = 0;
         }
         if(this.var_315 < 0)
         {
            this.var_315 = this.var_694.length - 1;
         }
         if(this.var_315 > this.var_694.length - 1)
         {
            this.var_315 = 0;
         }
         var _loc1_:int = this.var_694[this.var_315] * 1000 + this.var_693[this.var_317];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_87.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1064,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1333 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1683;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1064);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_694[this.var_315]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_693[this.var_317]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_87,this.var_1334,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_87.offerId,this.var_1334);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2332 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_211)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1858)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2332 = _loc3_.text;
               break;
            case WindowMouseEvent.const_39:
               ...
               break;
            case WindowKeyboardEvent.const_315:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_316 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_316 + 1);
                     break;
      ...
      {
         if(this.var_241 == null || !this.var_241.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_241.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_316) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_419:
               this.showSelectors(false);
               break;
            case WindowEvent.const_746:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_241 == null)
         {
            this.var_241 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_572 == null)
         {
            this.var_572 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_572.procedure = this.suggestionsEventHandler;
         }
         if(this.var_241 == null || this.var_572 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_241.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_572.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_316) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_316);
         }
         this.var_316 = param1;
         if(this.var_316 < 0)
         {
            this.var_316 = _loc2_.numListItems - 1;
         }
         if(this.var_316 >= _loc2_.numListItems)
         {
            this.var_316 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_316) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1859;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1584) : uint(this.const_1583);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_241.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1064;
               }
            }
            _loc4_++;
         }
