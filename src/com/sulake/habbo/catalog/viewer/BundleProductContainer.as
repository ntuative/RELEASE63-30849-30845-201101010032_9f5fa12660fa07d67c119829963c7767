package com.sulake.habbo.catalog.viewer
{
   ...
   public class BundleProductContainer extends ProductContainer implements IProductContainer, IItemGrid
   {
      ...
      private static const const_1199:int = 6;
       
      
      private var var_1361:BitmapData;
      ...
      public function BundleProductContainer(param1:Offer, param2:Array)
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1361 = _loc3_.content as BitmapData;
         }
         else
         {
            this.var_1361 = new BitmapData(1,1,true,16777215);
         }
      }
      ...
      {
         setIconImage(this.var_1361.clone());
      }
      ...
      public function populateItemGrid(param1:IItemGridWindow, param2:IScrollbarWindow, param3:XML) : void
      {
         ...
         if(param2 != null)
         {
            param2.visible = offer.productContainer.products.length > const_1199;
         }
      }
