package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1546:String = "ctlg_";
       
      
      protected var var_1941:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1039:ICatalogViewer;
      ...
      private var var_1413:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1414:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1413 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_1546 + param1;
         ...
         this.var_1941 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1941) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1350) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_1414 = new ItemGridCatalogWidget(_loc1_);
            this.var_58.push(this.var_1414);
         }
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1298) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1285) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new ColourGridCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1279) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new TraxPreviewCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1333) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1509) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new PetsCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1515) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new BotCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1284) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1524) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1361) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new ClubGiftWidget(_loc1_,this._catalog.getClubGiftController()));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1485) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1413;
            _loc2_.init();
         }
         this.var_1413.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1413.dispatchEvent(param1);
      }
   }
}
