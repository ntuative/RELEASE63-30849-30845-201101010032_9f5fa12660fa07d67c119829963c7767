package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_270:CatalogObjectMover;
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_189)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_189)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               if(this.var_270 != null)
               {
                  this.var_270.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_270 == null)
               {
                  this.var_270 = new CatalogObjectMover();
                  this.var_270.mainContainer = window;
                  this.var_270.roomEngine = _loc3_;
               }
               this.var_270.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
      ...
      private function onSlotMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(event.type == WindowMouseEvent.const_55)
         {
      ...
      public function updateRecycleButton(param1:Boolean) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc2_.enable();
               _loc2_.procedure = this.onRecycleButtonEvent;
            }
            else
            {
               _loc2_.disable();
