package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_1117 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_1117 != null)
         {
            this.var_1117.addEventListener(WindowKeyboardEvent.const_315,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_1117.text));
      }
   }
}
