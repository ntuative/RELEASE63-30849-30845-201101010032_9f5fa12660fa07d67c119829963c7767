package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1550:String = "PublicRoomObjectMessageData";
      ...
      private var _floorType:String = "PublicRoomObjectMessageData";
      ...
      private var var_1549:String = "1.1";
      
      private var var_1685:int = -1;
      
      private var var_1684:int = -1;
      
      private var var_319:BitmapData = null;
      
      private var var_318:BitmapData = null;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1337[this.var_388];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1336[this.var_390];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1335[this.var_391];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1549);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_880[this.var_388];
         ...
         _loc6_ = this.var_1336[this.var_390];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_876[this.var_391];
         for each(_loc1_ in this._configuration.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_470];
               if(_loc13_ != null)
               {
                  this.var_1549 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1335[this.var_391];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_196:
               ...
               if(this.var_388 < 0)
               {
                  this.var_388 = this.var_880.length - 1;
               }
               if(this.var_388 == this.var_880.length)
               {
                  this.var_388 = 0;
               }
               this.var_389 = 0;
               this.var_878 = 0;
               _loc5_ = this.var_880[this.var_388];
               for each(_loc8_ in this._configuration.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_878 = _loc8_.children().length();
                  }
               }
            ...
            case const_197:
               ...
               for each(_loc9_ in this._configuration.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_877 = _loc9_.children().length();
                  }
               }
            ...
            case const_90:
               ...
               if(this.var_391 < 0)
               {
                  this.var_391 = this.var_876.length - 1;
               }
               if(this.var_391 >= this.var_876.length)
               {
                  this.var_391 = 0;
               }
               this.var_470 = 0;
               this.var_879 = 0;
               _loc7_ = this.var_876[this.var_391];
               for each(_loc10_ in this._configuration.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_879 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1550,this.var_1549,64,this,"window_romantic_wide");
         ...
         {
            this.var_1685 = _loc2_.id;
            this.var_1684 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_319 != null && this.var_318 != null)
         {
            this.setRoomImage(this.var_319,this.var_318);
         }
      }
   }
}
