package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : void
      {
         ...
         var _loc7_:* = null;
         super.init();
         this.var_81 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_255.getValue(_loc5_) == null)
            {
               this.var_255.add(_loc5_,new Map());
            }
            _loc7_ = this.var_255.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_255.getWithIndex(this.var_290);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_755);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_255.getWithIndex(this.var_290);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_755);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_290;
         if(this.var_290 >= this.var_255.length)
         {
            this.var_290 = 0;
         }
         var _loc2_:Map = this.var_255.getWithIndex(this.var_290);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_290 < 0)
         {
            this.var_290 = this.var_255.length - 1;
         }
         var _loc2_:Map = this.var_255.getWithIndex(this.var_290);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_81 != null)
         {
            ...
            _loc3_ = new Point((this.var_81.width - param1.width) / 2,(this.var_81.height - param1.height) / 2);
            this.var_81.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
