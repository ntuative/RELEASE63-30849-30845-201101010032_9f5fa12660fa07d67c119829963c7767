package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_195:int = 31;
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            _loc2_ = this._controller.purse.pastClubDays >= this.const_195 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = this._controller.purse.pastClubDays % this.const_195;
            _loc4_ = this._controller.purse.pastClubDays / this.const_195;
         ...
         if(_loc6_)
         {
            _loc2_ = this._controller.purse.pastVipDays >= this.const_195 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this._controller.purse.pastVipDays % this.const_195;
            _loc4_ = this._controller.purse.pastVipDays / this.const_195;
            this._controller.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this._controller.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            _loc5_ = this.createListItem(_loc1_,_loc7_);
            if(_loc5_)
            {
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(!param2.isSelectable && _loc6_ > 0)
         {
            ...
            if(_loc6_ >= this.const_195)
            {
               _loc7_ += ".long";
            }
            _loc12_ = _loc6_ % this.const_195;
            _loc13_ = _loc6_ / this.const_195;
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_204)
         {
            this.var_204 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_204)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_204.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         this.var_204.setGlobalPosition(_loc6_.subtract(new Point(this.var_204.width / 2,this.var_204.height / 2)));
         this.var_204.visible = true;
