package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_81:IBitmapWrapperWindow;
      
      private var var_1596:Point;
      
      private var var_448:IItemGridWindow;
      
      private var var_1291:IScrollbarWindow;
      ...
      {
         this.var_845 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1025 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1596 = new Point(this.var_81.x,this.var_81.y);
         this.var_448 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1291 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1597 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_448 != null)
         {
            ...
            this.var_448.destroyGridItems();
         }
         if(this.var_1291 != null)
         {
            this.var_1291.visible = false;
         }
         ...
         this.var_845.text = _loc4_;
         this.var_1025.text = _loc5_;
         this.var_845.height = this.var_845.textHeight + 5;
         this.var_1025.y = this.var_845.y + this.var_845.height;
         this.var_1025.height = Math.max(130,this.var_1025.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_498:
                  _loc6_ = this.var_1597.clone();
                  if(this.var_448 != null)
                  {
                     this.var_448.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_448,this.var_1291,this.var_1630);
                     this.var_448.scrollV = 0;
                  }
                  break;
               case Offer.const_533:
               case Offer.const_415:
                  _loc8_ = _loc2_.productContainer.firstProduct;
                  switch(_loc8_.productType)
                  {
                     case ProductTypeEnum.const_87:
                        _loc9_ = page.viewer.roomEngine.getFurnitureImage(_loc8_.productClassId,new Vector3d(90,0,0),64,this,_loc8_.extraParam);
                        _loc2_.previewCallbackId = _loc9_.id;
                        break;
                     case ProductTypeEnum.const_79:
                        _loc9_ = page.viewer.roomEngine.getWallItemImage(_loc8_.productClassId,new Vector3d(90,0,0),64,this,_loc8_.extraParam);
                        _loc2_.previewCallbackId = _loc9_.id;
                        break;
                     case ProductTypeEnum.const_234:
                        ...
                        _loc6_ = new BitmapData(this.var_81.width,this.var_81.height,false,_loc13_);
                        _loc14_ = null;
                        _loc15_ = page.viewer.catalog as HabboCatalog;
                        if(_loc15_.avatarRenderManager != null)
                        {
                           _loc17_ = _loc15_.sessionDataManager.figure;
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_49);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_43,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_269,AvatarAction.const_398);
                              _loc16_.appendAction(AvatarAction.const_302,_loc8_.productClassId);
                              _loc16_.endActionAppends();
                              _loc16_.updateAnimationByFrames(1);
                              _loc16_.updateAnimationByFrames(1);
                              _loc14_ = _loc16_.getImage(AvatarSetType.const_33,true);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_81);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2201)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_81 != null && true)
         {
            ...
            if(this.var_81.bitmap == null)
            {
               this.var_81.bitmap = new BitmapData(this.var_81.width,this.var_81.height,true,16777215);
            }
            this.var_81.bitmap.fillRect(this.var_81.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_81.width - param1.width) / 2,(this.var_81.height - param1.height) / 2);
            this.var_81.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_81.invalidate();
            this.var_81.x = this.var_1596.x;
            this.var_81.y = this.var_1596.y;
            if(param3 != null)
            {
               this.var_81.x += param3.x;
               this.var_81.y += param3.y;
            }
         }
         if(param2)
         {
