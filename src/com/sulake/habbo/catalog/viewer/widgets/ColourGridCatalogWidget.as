package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1758 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1382.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_339 = null;
         for each(_loc1_ in this.var_1382)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1758) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(this.var_719.width,this.var_719.height,true,0);
               _loc3_.bitmap.copyPixels(this.var_719,this.var_719.rect,new Point(0,0));
            }
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_896.width,this.var_896.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_896,this.var_896.rect,new Point(0,0),null,null,true);
