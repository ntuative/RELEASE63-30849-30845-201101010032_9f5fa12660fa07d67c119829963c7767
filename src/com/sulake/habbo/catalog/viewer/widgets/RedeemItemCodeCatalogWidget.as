package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1106:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1106.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1107 != null)
         {
            this.var_1107.removeEventListener(WindowKeyboardEvent.const_148,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1106 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1106 != null)
         {
            this.var_1106.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1107 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1107 != null)
         {
            this.var_1107.addEventListener(WindowKeyboardEvent.const_148,this.windowKeyEventProcessor);
         }
      }
