package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1861:int = 40;
      
      private const const_1862:int = 10;
      
      private var var_700:Array;
      
      private var var_1350:MarketPlaceOfferData;
      
      private var _itemList:IItemListWindow;
      
      private var var_579:IWindowContainer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_476)
         {
            this.var_476.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_476 = null;
         }
      }
      ...
      public function displayMainView() : void
      {
         ...
         this.selectSearchCategory("search_by_value");
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_700 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_700 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_700));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_579)
         {
            _loc3_ = this.getAssetXML("marketplace_offers_item");
            if(!_loc3_)
            {
               return;
            }
            _loc4_ = this.marketPlace.windowManager;
            if(_loc4_ == null)
            {
               return;
            }
            this.var_579 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_579)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1577,_loc2_.length);
         if(!this.var_476)
         {
            this.var_476 = new Timer(25);
            this.var_476.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1075 = 0;
         this.populateList();
         this.var_476.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1075 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1075));
            ++this.var_1075;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_579 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_579.clone() as IWindowContainer;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!this.marketPlace || !param2 || !this._itemList || !this._offers)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1576);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_700.length)
         {
            _loc4_ = this.var_700[_loc6_.selection];
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_104)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1862;
                  break;
               case "search_input":
                  _loc8_ = this.const_1861;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1350.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_59)
