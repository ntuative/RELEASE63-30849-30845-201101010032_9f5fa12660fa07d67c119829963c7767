package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_328:CatalogViewer;
      
      private var var_329:ICatalogNavigator;
      
      private var var_110:Purse;
      
      private var var_89:RecyclerLogic;
      
      private var var_124:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_209:PurchaseConfirmationDialog;
      
      private var var_282:ChargeConfirmationDialog;
      ...
      private var var_2396:Boolean = true;
      
      private var var_2397:Boolean = true;
      
      private var var_1727:Boolean = false;
      
      private var var_2395:GiftWrappingConfiguration;
      
      private var var_1082:ClubGiftController;
      
      private var var_479:ClubBuyController;
      
      public function HabboCatalog(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_110 = new Purse();
      ...
      {
         var _loc4_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_110.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_110.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_209 == null)
            {
               this.var_209 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_209.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_479.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_329.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_87)
         {
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_110.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_110.getActivityPointsForType(Purse.const_480)));
         var _loc1_:int = 0;
         if(!this.var_110.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_110.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_110.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_110.clubPeriods));
         }
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_634)
         {
            if(!this.var_370.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this._mainContainer.visible)
         {
            ...
            if(this.var_89 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_89.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_89.active && this._mainContainer.visible);
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_328.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_329 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_328 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_328.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_81:
               this.var_1727 = param1.session.isPrivateRoom;
               if(this.var_89 != null)
               {
                  this.var_89.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_89:
               ...
               if(this.var_89 != null)
               {
                  this.var_89.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_89 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_124 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1082 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_479 == null)
         {
            this.var_479 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_329.buildCatalogIndex(_loc2_);
         if(this.var_704 && this.var_704 != "")
         {
            this.var_329.openPage(this.var_704);
            this.var_704 = "";
            this.var_895 = -1;
         }
         else if(this.var_895 > -1)
         {
            this.var_329.openPageById(this.var_895,this.var_1726);
            this.var_895 = -1;
            this.var_1726 = -1;
            this.var_704 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_328.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_328.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_110.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2396 && this.var_582 != null)
         {
            this.var_582.playSound(HabboSoundTypesEnum.const_1017);
         }
         this.var_2396 = false;
         if(this.var_282 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_110.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2397 && this.var_582 != null)
         {
            this.var_582.playSound(HabboSoundTypesEnum.const_972);
         }
         this.var_2397 = false;
         if(this.var_282 != null)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_110.activityPoints = _loc2_.points;
         this.updatePurse();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_110.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_110.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_110.isVIP = _loc2_.isVIP;
         this.var_110.pastClubDays = _loc2_.pastClubDays;
         this.var_110.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1082.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_89 == null)
         {
            return;
         }
         this.var_89.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_89.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_89.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_328.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_124 != null)
         {
            this.var_124.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_124 != null)
         {
            this.var_124.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_124 != null)
         {
            this.var_124.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2395 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_124.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_282 == null)
         {
            this.var_282 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_282.showChargeInfo(_loc2_);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "ClubGiftController" == this._configuration.getKey("client.credits.embed.enabled"))
            {
