package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2744:String = "magic.credits";
      
      private var var_2703:String = "magic.pixels";
      
      private var var_2702:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         this.var_314 = [];
         this.var_53 = this._container.findChildByName("navigationList") as IItemListWindow;
         var _loc3_:IWindow = this._container.findChildByName("creditsContainer");
         var _loc4_:IWindow = this._container.findChildByName("pixelsContainer");
         var _loc5_:IWindow = this._container.findChildByName("clubContainer");
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in this._index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(this.var_53);
            }
         }
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_314.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_314)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_314.indexOf(_loc6_);
            this.var_314.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_314.indexOf(param1) == -1)
         {
      ...
      {
         var _loc2_:* = null;
         if(this._catalog == null || this._catalog.configuration == null)
         {
            return;
         }
         var _loc1_:* = this._catalog.configuration.getKey("client.credits.embed.enabled","false") == "ClubGiftController";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this._catalog.configuration.getKey("link.format.credits","/credits");
            this._catalog.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      {
         this.openPage(this.var_2703);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2702,true);
      }
