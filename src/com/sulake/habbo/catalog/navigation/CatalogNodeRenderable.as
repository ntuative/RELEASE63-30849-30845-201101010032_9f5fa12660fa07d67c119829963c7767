package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1176:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1330:XML;
      
      private static var var_1332:XML;
       
      
      private var var_1675:Number = 4.294967295E9;
      ...
      public function addToList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            ...
            param1.addListItem(this.var_53);
         }
      }
      ...
      public function removeFromList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            param1.removeListItem(this.var_53);
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1675 == 4294967295)
            {
               this.var_1675 = _loc1_.color;
            }
            _loc1_.color = const_1176;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1330;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1371;
            }
         }
      }
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(this.var_53);
            }
         }
         if(this.var_53 != null)
         {
            this.var_53.visible = true;
            this.var_53.height = this.var_53.numListItems * 21;
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_53);
            }
         }
         if(this.var_53 != null)
         {
            this.var_53.height = 0;
      ...
      {
         this.var_53 = navigator.catalog.windowManager.buildFromXML(var_1332) as IItemListWindow;
         if(this.var_53 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1330) as IWindowContainer;
         }
         else
         {
         ...
         if(disabled)
         {
            if(_loc1_ != null)
            {
               _loc1_.caption = localization + " " + this.getLocalizationKey("catalog.comingsoon");
            }
            if(_loc2_ != null)
            {
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_30,this.onIconImageReady);
      }
