package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_833:int = 0;
      
      private static const const_387:int = 1;
      
      private static const const_832:int = 2;
      ...
      {
         return this.var_556 != const_833;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1604 != RecyclerStatusMessageEvent.const_989;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_556 == const_387;
      }
      ...
      {
         this.var_556 = const_832;
         this.var_107 = new Array(const_189);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_189)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_556 = const_833;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1422:
               this.var_556 = const_387;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_989:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_958:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1465:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_107.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_189)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_107.length < const_189)
         {
            return false;
         }
         var _loc1_:int = 0;
