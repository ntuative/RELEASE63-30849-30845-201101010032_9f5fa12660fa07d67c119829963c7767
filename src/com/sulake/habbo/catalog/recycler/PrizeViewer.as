package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_267:IBitmapWrapperWindow;
      ...
      {
         var _loc8_:* = null;
         this.var_267 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_267 != null && !this.var_267.disposed)
         {
            ...
            this.var_267.bitmap = new BitmapData(this.var_267.width,this.var_267.height,true,16777215);
            this.var_267.bitmap.fillRect(this.var_267.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_267.width - param1.width) / 2,(this.var_267.height - param1.height) / 2);
            this.var_267.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
