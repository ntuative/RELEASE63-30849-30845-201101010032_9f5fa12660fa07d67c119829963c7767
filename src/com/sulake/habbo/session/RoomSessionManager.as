package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_190)
         {
            while(this.var_190.length > 0)
            {
               _loc1_ = this.var_190.getKey(0) as String;
               _loc2_ = this.var_190.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_79)
         {
            ...
            {
               _loc4_ = this.var_79[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      private function createHandlers() : void
      {
         ...
         this.var_79.push(new RoomSessionHandler(this._connection,this));
         this.var_79.push(new RoomChatHandler(this._connection,this));
         this.var_79.push(new RoomUsersHandler(this._connection,this));
         this.var_79.push(new RoomPermissionsHandler(this._connection,this));
         this.var_79.push(new AvatarEffectsHandler(this._connection,this));
         this.var_79.push(new RoomDataHandler(this._connection,this));
         this.var_79.push(new PresentHandler(this._connection,this));
         this.var_79.push(new PlaceObjectErrorHandler(this._connection,this));
         this.var_79.push(new TeleportErrorHandler(this._connection,this));
         this.var_79.push(new GenericErrorHandler(this._connection,this));
         this.var_79.push(new PollHandler(this._connection,this));
         this.var_79.push(new VoteHandler(this._connection,this));
         this.var_79.push(new LidoHandler(this._connection,this));
         this.var_79.push(new RoomDimmerPresetsHandler(this._connection,this));
         this.var_79.push(new ViralFurniHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1512)
         {
            this.gotoRoom(this.var_2056,this.var_2058,this.var_1511);
            this.var_1512 = false;
            this.var_1511 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         this.var_1242 = true;
         if(this.var_190.getValue(_loc6_) != null)
         {
         ...
         this.var_190.add(_loc6_,_loc7_);
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_212,_loc7_));
         return true;
      }
      ...
      public function startSession(param1:IRoomSession) : Boolean
      {
         ...
         {
            this.var_1242 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_81,param1));
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_190.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_190.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_190.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_190.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_190.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_89,_loc4_));
            _loc4_.dispose();
         }
      }
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 != null && this.var_79 != null)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_79.length)
            {
               _loc3_ = this.var_79[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
