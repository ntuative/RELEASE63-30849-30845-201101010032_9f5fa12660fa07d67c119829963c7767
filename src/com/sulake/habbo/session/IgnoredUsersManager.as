package com.sulake.habbo.session
{
   ...
   public class IgnoredUsersManager
   {
      ...
      private var var_29:SessionDataManager;
      ...
      {
         var _loc1_:IConnection = this.var_29.communication.getHabboMainConnection(null);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         var _loc1_:IConnection = this.var_29.communication.getHabboMainConnection(null);
         _loc1_.send(new GetIgnoredUsersMessageComposer(this.var_29.userName));
      }
      ...
      private function onIgnoreResult(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:String = String(this.var_1366.shift());
      ...
      public function ignoreUser(param1:String) : void
      {
         ...
         var _loc2_:IConnection = this.var_29.communication.getHabboMainConnection(null);
