package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1206:int = 2;
      
      private static const const_1578:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1205);
      }
      
      public function getUserDataByType(param1:int, param2:int) : IUserData
      {
         var _loc3_:* = null;
         var _loc4_:Map = this.var_711.getValue(param2);
         if(_loc4_ != null)
         {
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_902.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      public function setUserData(param1:IUserData) : void
      {
         ...
         var _loc2_:Map = this.var_711.getValue(param1.type);
         if(_loc2_ == null)
         {
            _loc2_ = new Map();
            this.var_711.add(param1.type,_loc2_);
         }
      ...
      public function removeUserDataByIndex(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_711.getValue(_loc2_.type);
            if(_loc3_ != null)
            {
      ...
      {
         this.var_902.remove(param1);
         this.var_902.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1206);
      }
