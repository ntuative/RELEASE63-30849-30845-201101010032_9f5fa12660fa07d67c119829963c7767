      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.errorCode)
         {
            case PlaceObjectErrorEnum.const_215:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_250:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_225:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_184:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_232:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_222:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_205:
               _loc4_ = "null";
               break;
            default:
               return;
