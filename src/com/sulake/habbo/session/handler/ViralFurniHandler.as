package com.sulake.habbo.session.handler
{
   ...
   public class ViralFurniHandler extends BaseHandler
   {
      ...
      private function onViralFurniStatus(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_526,_loc6_);
      ...
      private function onViralGiftReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_502,_loc6_);
         _loc7_.firstClickUserName = _loc3_.firstClickUserName;
         if(listener && false)
         {
            listener.events.dispatchEvent(_loc7_);
