package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_288:IItemListWindow;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_754)
         {
            _loc1_.dispose();
         }
         this.var_754 = [];
      ...
      private function reset() : void
      {
         ...
         if(this.var_349)
         {
            ...
            {
               this.var_288.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_349 = null;
            this.var_288.destroyListItems();
            this.var_288.removeListItems();
         }
         this.var_503 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1165 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1426 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_288 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.id + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1426.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1426.findChildByName("currency.amount").caption = "${quest_" + this.id + ".currency}";
         ...
         this.var_1164 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1164)
         {
            this.var_1164.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1164.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1164.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_163)
         {
            this.var_1165.addChild(this.var_163.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1593);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1426.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_349.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_349)
         {
            this.var_288.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_40 || _loc4_.status == QuestStatusEnum.const_524))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_288.maxScrollV > 0)
            {
               this.var_288.scrollV = _loc3_.view.y / this.var_288.maxScrollV;
            }
         }
         else if(this.var_349.length > 0)
         {
            this.activateListItem(this.var_349[0]);
         }
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_289 = new QuestView(this,param1);
         this.var_1165.addChild(this.var_289.view);
         this.var_289.init();
      }
      ...
      public function method_2(param1:QuestMessageData) : void
      {
         this.modifyQuestData(param1);
         this.var_754.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_754)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_754.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_754.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_349[_loc3_] = _loc5_;
            _loc6_ = this.var_288.getListItemIndex(_loc2_.view);
            this.var_288.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_288.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_288.addListItem(_loc5_.view);
            }
