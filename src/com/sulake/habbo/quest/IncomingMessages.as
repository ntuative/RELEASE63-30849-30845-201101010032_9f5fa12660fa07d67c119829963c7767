package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages
   {
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this._questEngine.controller.method_2(_loc2_.campaignId,_loc2_.questData);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(this._questEngine.toolbar != null && this._questEngine.configuration != null)
         {
            ...
            {
               this._questEngine.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      private function onRoomExit(param1:IMessageEvent) : void
      {
         ...
         this._questEngine.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.QUESTS));
      }
