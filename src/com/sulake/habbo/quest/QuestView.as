package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_66:QuestCampaign;
      ...
      private var var_2256:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_108.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               this._view = this.var_66.controller.questEngine.getXmlWindow("QuestTypeFindStuff");
               this.var_2256 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_108)
         {
            this.var_66.controller.activateQuest(this.var_108);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_66.id,this.var_108.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_66.id,"type_" + this.var_108.type.toLowerCase()].join(".");
         var _loc3_:String = "quest_" + this.var_66.id;
         ...
         {
            _loc32_ = this.var_66.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_108.roomItemTypeName);
            if(_loc32_)
            {
               _loc33_ = this.var_66.controller.questEngine.roomEngine.getFurnitureImage(_loc32_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1642 = _loc33_.id;
               if(_loc33_ && _loc33_.data)
               {
                  this.imageReady(_loc33_.id,_loc33_.data);
               }
               this.var_66.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc32_.title);
            }
         }
         else if(this.var_108.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            _loc34_ = this.find("quest.image") as IBitmapWrapperWindow;
            this.var_66.controller.questEngine.setImageFromAsset(_loc34_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else
         {
            this.var_1642 = -1;
         ...
         switch(this.var_108.status)
         {
            ...
            case QuestStatusEnum.const_177:
               ...
               _loc18_ = 4290822336;
               break;
            case QuestStatusEnum.const_772:
         ...
         this.var_66.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_108.rewardCurrencyAmount.toString());
         ...
         this.var_66.controller.questEngine.localization.registerParameter("quest.available","day",_loc19_.toString());
         this.var_66.controller.questEngine.localization.registerParameter("quest.available","month",_loc20_.toString());
         this.var_66.controller.questEngine.localization.registerParameter("quest.available","year",_loc21_.toString());
         this.var_66.controller.questEngine.localization.registerParameter("quest.available","12h",this.pad(_loc24_));
         this.var_66.controller.questEngine.localization.registerParameter("quest.available","24h",this.pad(_loc23_));
         this.var_66.controller.questEngine.localization.registerParameter("quest.available","ampm",_loc25_);
         this.var_66.controller.questEngine.localization.registerParameter("quest.available","minute",this.pad(_loc22_));
         ...
         var _loc29_:String = "header_" + this.var_66.id;
         this.var_66.controller.questEngine.setImageFromAsset(_loc28_,_loc29_,this.onHeaderImageReady);
         var _loc30_:IBitmapWrapperWindow = this.find("quest.reward.icon") as IBitmapWrapperWindow;
         var _loc31_:String = "icon_" + this.var_66.id + "_reward_" + this.var_108.rewardCurrencyAmount;
         this.var_66.controller.questEngine.setImageFromAsset(_loc30_,_loc31_,this.onRewardImageReady);
         this.updateMargins();
      }
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_66.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onRewardImageReady);
         }
      }
      ...
      private function onHeaderImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_66.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onHeaderImageReady);
         }
      }
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_66.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onPreviewImageReady);
         }
      }
