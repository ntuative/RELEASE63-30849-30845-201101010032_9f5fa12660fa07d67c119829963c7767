package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1478 = param1.roomItemTypeName;
         this.var_1477 = param1.rewardCurrencyAmount;
         this.var_1493 = new Date();
         this.var_1493.setTime(param1.endDateTimeStamp);
      ...
      private function createView() : void
      {
         switch(this._status)
         {
            case QuestStatusEnum.const_40:
               this._view = this.var_66.controller.questEngine.getXmlWindow("QuestEntityAccepted") as IWindowContainer;
               break;
            case QuestStatusEnum.const_524:
               this._view = this.var_66.controller.questEngine.getXmlWindow("QuestEntityAvailable") as IWindowContainer;
               break;
            case QuestStatusEnum.const_177:
               this._view = this.var_66.controller.questEngine.getXmlWindow("QuestEntityExpired") as IWindowContainer;
               break;
            case QuestStatusEnum.const_772:
               this._view = this.var_66.controller.questEngine.getXmlWindow("QuestEntityCompleted") as IWindowContainer;
               break;
            case QuestStatusEnum.const_180:
               this._view = this.var_66.controller.questEngine.getXmlWindow("QuestEntityPreview") as IWindowContainer;
               break;
            default:
               this._view = this.var_66.controller.questEngine.getXmlWindow("QuestEntityExpired") as IWindowContainer;
         }
      ...
      private function updateView() : void
      {
         ...
         {
            case QuestStatusEnum.const_40:
               _loc2_ = ["icon",this.var_66.id,"active"].join("_");
               this.var_66.controller.questEngine.setImageFromAsset(_loc1_,_loc2_,this.onPreviewImageReady);
               break;
            case QuestStatusEnum.const_524:
               break;
            case QuestStatusEnum.const_177:
               break;
            case QuestStatusEnum.const_772:
               this.var_66.controller.questEngine.setImageFromAsset(_loc1_,"icon_complete",this.onPreviewImageReady);
         }
         var _loc3_:String = ["quest",this.var_66.id,this._localizationCode].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            this.var_66.activateListItem(this);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_184)
            {
               this.var_790.style = this.var_2020;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_184)
            {
               this.var_790.style = this.var_2021;
            }
         }
      }
