package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotificationBonus
   {
      ...
      public function AchievementNotificationBonus(param1:int, param2:String, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager)
      {
         ...
         if(param2 && param2 != "")
         {
            this._localizations.registerParameter("notifications.achievement.bonus_received.name","realname",param2);
            this.setText("bonus_info",this._localizations.getKey("notifications.achievement.bonus_received.name"));
         }
         var _loc7_:BitmapData = (param3.getAssetByName(this.const_1857) as BitmapDataAsset).content as BitmapData;
