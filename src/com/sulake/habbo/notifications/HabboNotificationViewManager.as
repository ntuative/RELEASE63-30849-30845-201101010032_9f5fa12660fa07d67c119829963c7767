package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_550:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2292,this.var_399,this._toolbar);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_761 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_550;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_205.length)
         {
            _loc3_ = this.var_205[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_761 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_761 + const_550;
            _loc2_++;
         }
         return _loc1_;
      }
