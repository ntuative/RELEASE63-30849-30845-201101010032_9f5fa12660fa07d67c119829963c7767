package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1156:String = "pixelbalance";
      
      private static const const_1157:String = "badges";
      
      private static const const_1158:String = "selectbadge";
      
      private static const const_1161:String = "inventory";
      
      private static const const_1159:String = "selectfurni";
      
      private static const const_1160:String = "credits";
      
      private static const const_1155:String = "friendlist";
      
      private static const const_1162:String = "pet_inventory";
      ...
      private var var_672:IHabboToolbar;
      ...
      private var var_443:HabboNotificationViewManager;
      
      private var var_198:HabboAlertDialogManager;
      
      private var var_671:ParkBusDialogManager;
      
      private var var_2172:Boolean;
      
      private var var_833:ClubGiftNotification;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_672)
         {
            this.var_672.release(new IIDHabboToolbar());
            this.var_672 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         this.var_1010.push(_loc8_);
         return this.var_1010.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1010.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_198 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_672 = IHabboToolbar(param2);
         this.var_672.events.addEventListener(HabboToolbarEvent.const_67,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_67)
         {
            ...
            this.var_443 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_836["styles"],this.var_836["view"],this.var_672);
            ...
            registerUpdateReceiver(this.var_443,1);
            registerUpdateReceiver(this,2);
            this.var_370.events.addEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImage);
            this.var_672.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1278[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_370);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1278[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1278[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1523);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_370.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1020);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1020);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1337);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_431.createAvatarImage(param2,AvatarScaleType.const_49);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               if(_loc8_.productType == CatalogPageMessageProductData.const_87)
               {
                  _loc9_ = this.var_370.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_79)
               {
                  _loc9_ = this.var_370.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_370.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1289,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            case CatalogPageMessageProductData.const_87:
            ...
            case CatalogPageMessageProductData.const_79:
               ...
               break;
            case CatalogPageMessageProductData.const_234:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_958)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1420);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1369)
         {
      ...
      private function onInfoFeedEnable(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1574 = !_loc2_.enabled;
         }
      }
      
      public function update(param1:uint) : void
      {
         if(this.var_443.isSpaceAvailable() && this.var_1010.length > 0)
         {
            this.var_443.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1162:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_157);
               }
               break;
            case const_1159:
               break;
      ...
      {
         if(param1 != null && this.var_443 != null)
         {
            this.var_443.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_368;
            }
            if(param2 == 4057)
            {
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_198 == null)
         {
            return;
         }
         this.var_198.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_198.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_198.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_198.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_198.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_671 == null)
         {
            this.var_671 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_671 != null)
         {
            this.var_671.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_431.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_33,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_43);
         _loc4_.dispose();
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_985,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_431.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_49);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2172)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_927);
            this.var_2172 = true;
      ...
      {
         if(param2.type == WindowEvent.const_167 || param2.type == WindowEvent.const_677)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_833 && this.var_833.visible)
         {
            return;
         }
         this.var_833 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_927,_loc6_);
      }
   }
}
