package com.sulake.habbo.navigator
{
   ...
   public class GuestRoomDoorbell
   {
      ...
      private var var_1088:GuestRoomData;
      ...
      {
         this.show(this.var_1088,null,true);
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window = (this._navigator.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML,2) as IFrameWindow;
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc3_:IButtonWindow = this._window.findChildByName("cancel") as IButtonWindow;
         if(_loc3_ != null)
         {
      ...
      {
         this._navigator.goToRoom(this.var_1088.flatId,true);
         this.hide();
      }
