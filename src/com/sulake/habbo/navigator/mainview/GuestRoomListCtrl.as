package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_440:RoomPopupCtrl;
      
      private var var_512:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_440 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_512 = IScrollbarWindow(this.var_165.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_512.scrollV = 0;
         }
         this.var_165.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_53.numListItems)
         {
            if(this.var_53.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_36,true);
         _loc2_.setParamFlag(HabboWindowParam.const_1343,true);
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_53.getListItemAt(param2));
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_185,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_106,null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_161)
         {
            this.checkFastHorizontalMove(param1);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(this.var_440.visible && this.var_2157)
            {
               return;
            }
            ...
            this.var_440.room = _loc4_;
            this.var_440.showPopup(param2);
         }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1267.tags[0];
            this.var_1267.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2158 - _loc2_.stageX);
         this.var_2158 = _loc2_.stageX;
         this.var_2157 = _loc3_ > 2;
      }
   }
}
