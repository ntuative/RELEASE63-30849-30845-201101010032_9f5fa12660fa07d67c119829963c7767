package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_656:int = 2;
      
      public static const const_1730:int = 3;
      
      public static const const_925:int = 4;
      
      private static const const_842:int = 1;
      
      private static const const_552:int = 2;
      
      private static const const_841:int = 3;
      
      private static const const_1179:int = 4;
      ...
      private var var_883:PopularTagsListCtrl;
      
      private var var_884:GuestRoomListCtrl;
      
      private var var_1070:OfficialRoomListCtrl;
      ...
      private var var_1071:Boolean = true;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_883 = new PopularTagsListCtrl(this._navigator);
         this.var_884 = new GuestRoomListCtrl(this._navigator);
         this.var_1070 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_251 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_251)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_165 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         this.var_207 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_183 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_242 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1341 = this.var_16.findChildByName("loading_text");
         ...
         {
            _loc3_ = this.var_251.getTabItemByID(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_813,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1288,true);
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_183.y;
         Util.moveChildrenToColumn(this.var_165,["custom_content","list_content"],this.var_207.y,8);
         this.var_183.height = this.var_183.height + _loc1_ - this.var_183.y - this.var_242.height + this.var_2344;
         Util.moveChildrenToColumn(this.var_165,["list_content","custom_footer"],this.var_183.y,0);
         this.var_2344 = this.var_242.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_251.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1697 = true;
            this.var_251.selector.setSelected(_loc1_.button);
         }
      }
      ...
      private function refreshCustomContent() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(this.var_207);
         if(Util.hasVisibleChildren(this.var_207))
         {
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_242);
         if(Util.hasVisibleChildren(this.var_242))
         {
      ...
      {
         Util.hideChildren(this.var_183);
      ...
      {
         this.refreshList(param1,param2,this.var_884,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_883,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1070,"official_rooms");
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         {
            _loc5_ = this.var_183.getChildByName(param4);
      ...
      public function startSearch(param1:int, param2:int, param3:String = "-1", param4:int = 1) : void
      {
         ...
         {
            this.open();
            this.var_574 = const_552;
            this.var_183.blend = 0;
            if(this.var_207.visible)
            {
               this.var_207.blend = 0;
               this.var_242.blend = 0;
            }
         }
         else
         {
            this.var_574 = const_842;
         }
         this.var_1340 = 0;
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_574 == const_842)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_183.blend - _loc2_));
            this.var_183.blend = _loc3_;
            this.var_207.blend = !!this.var_1071 ? Number(_loc3_) : Number(1);
            this.var_242.blend = !!this.var_1071 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_574 = const_552;
            }
         }
         else if(this.var_574 == const_552)
         {
            if(this.var_1340 % 10 == 1)
            {
               this.var_1341.visible = !this.var_1341.visible;
            }
            ++this.var_1340;
            if(!this._navigator.data.isLoading())
            {
               this.var_574 = const_841;
            }
         }
         else if(this.var_574 == const_841)
         {
            this.refresh();
            this.var_574 = const_1179;
         }
         else
         {
            this.var_1341.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_183.blend + _loc2_));
            this.var_183.blend = _loc3_;
            this.var_207.blend = !!this.var_1071 ? Number(_loc3_) : Number(1);
            this.var_242.blend = !!this.var_1071 ? Number(_loc3_) : Number(1);
            if(this.var_183.blend >= 1)
            {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_884);
      }
