package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2742:IWindowContainer;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_455 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_455.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_455 == null ? 0 : int(this.var_455.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         this._navigator.mainViewCtrl.startSearch(Tabs.const_277,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_727;
         }
         if(param1 == 2)
         {
            return Tabs.const_639;
         }
         if(param1 == 3)
         {
            return Tabs.const_634;
         }
         if(param1 == 4)
         {
            return Tabs.const_640;
         }
         return Tabs.const_221;
      }
   }
}
