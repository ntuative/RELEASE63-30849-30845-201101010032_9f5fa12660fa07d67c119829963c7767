package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_342:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_342 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      public function prepareRoomCategories() : void
      {
         ...
         this.var_342.procedure = null;
         this.var_342.populate(_loc1_);
         this.var_342.selection = 0;
         this.var_342.procedure = this.onChangeFilter;
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_342 == null ? 0 : int(this.var_342.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_254,Tabs.const_323);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_254,Tabs.const_674);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_254,Tabs.const_323,"" + _loc3_);
         }
      }
   }
}
