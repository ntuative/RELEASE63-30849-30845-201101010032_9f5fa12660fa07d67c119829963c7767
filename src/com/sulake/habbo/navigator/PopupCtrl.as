package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_394 = new Timer(500,1);
         this.var_323 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1254 = param4;
         this.var_2124 = param2;
         this._popupIndentLeft = param3;
         this.var_394.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_323.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_323)
         {
            this.var_323.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_323.reset();
            this.var_323 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_49 == null)
         {
            this.var_49 = IWindowContainer(this._navigator.getXmlWindow(this.var_1254));
         ...
         this.var_49.x = _loc2_.x + this.var_2124 + param1.width;
