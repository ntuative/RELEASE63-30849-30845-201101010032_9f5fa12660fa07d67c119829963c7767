package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_266:MainViewCtrl;
      
      private var var_542:RoomInfoViewCtrl;
      
      private var var_997:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_404:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2736:Dictionary;
      ...
      private var var_2114:RoomThumbnailRenderer;
      
      private var var_841:GuestRoomPasswordInput;
      
      private var var_338:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_266 = new MainViewCtrl(this);
         this.var_542 = new RoomInfoViewCtrl(this);
         this.var_997 = new RoomCreateViewCtrl(this);
         this.var_2114 = new RoomThumbnailRenderer(this);
         this.var_841 = new GuestRoomPasswordInput(this);
         this.var_338 = new GuestRoomDoorbell(this);
         this.var_404 = new Tabs(this);
      ...
      public function goToRoom(param1:int, param2:Boolean, param3:String = "") : void
      {
         ...
         if(this.var_17)
         {
            ...
            this.var_542.close();
            this.var_17.gotoRoom(false,param1,param3);
         }
      }
      ...
      public function goToPublicSpace(param1:int, param2:String) : void
      {
         ...
         {
            this.var_542.close();
            this.var_17.gotoRoom(true,param1,"",param2);
         }
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_294,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_542.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_266.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_266.startSearch(Tabs.const_249,Tabs.const_341,param1);
         this.var_266.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_266.startSearch(Tabs.const_277,Tabs.const_221);
         this.var_404.getTab(Tabs.const_277).tabPageDecorator.tabSelected();
      }
