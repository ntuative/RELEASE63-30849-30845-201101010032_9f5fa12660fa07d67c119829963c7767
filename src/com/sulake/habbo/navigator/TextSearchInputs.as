package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      private var var_2753:IButtonWindow;
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:Boolean, param3:IWindowContainer)
      {
         ...
         this.var_757 = new TextFieldManager(this._navigator,ITextFieldWindow(param3.findChildByName("search_str")),25,this.searchRooms,this._navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = this.var_757.getText();
         if(_loc1_ == "")
         {
            return;
         }
         this._navigator.mainViewCtrl.startSearch(Tabs.const_249,Tabs.const_202,_loc1_);
      }
