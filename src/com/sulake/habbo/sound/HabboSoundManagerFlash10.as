package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1084,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_934.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1119:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1294:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1427:
                  _loc3_ = "sound_console_new_message";
                  break;
               case HabboSoundTypesEnum.const_1459:
                  _loc3_ = "sound_message_sent";
                  break;
               case HabboSoundTypesEnum.const_972:
                  _loc3_ = "sound_catalogue_pixels";
                  break;
               case HabboSoundTypesEnum.const_1017:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1266:
            ...
            this.var_934.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_618.add(_loc4_,param1);
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_932.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_932 = IHabboNotifications(param2);
      }
      ...
      {
         if(this._configuration == null || this._connection == null || this._roomEngine == null || this.var_619 != null)
         {
            return;
         }
         this.var_619 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_618.getValue(_loc2_);
         ...
         this.var_618.remove(_loc2_);
         this.var_751.add(_loc3_,_loc6_);
         if(this.var_618.length == 0 && this.var_750 != -1)
         {
            this.var_933.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1084,this.var_750));
            this.var_750 = -1;
            this.var_933 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_619.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1448,this.var_750));
         this.var_750 = -1;
         this.var_933 = null;
      }
      ...
      {
         this.var_501 = param1;
         this.var_619.updateVolume(this.var_501);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_96,HabboToolbarIconEnum.SOUNDS);
