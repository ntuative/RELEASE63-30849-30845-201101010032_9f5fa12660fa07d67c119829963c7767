package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1860:String = "type_sound_machine";
      
      private const const_1574:String = "type_jukebox";
      
      private var var_582:HabboSoundManagerFlash10;
      
      private var _connection:IConnection;
      
      private var _events:IEventDispatcher;
      
      private var var_85:IEventDispatcher;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_767,this.onSongFinishedPlayingEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_605,this.onSoundMachinePlayEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_768,this.onSoundMachineStopEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_782,this.onJukeboxInitEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_530,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_767,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_85)
            {
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_605,this.onSoundMachinePlayEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_768,this.onSoundMachineStopEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_782,this.onJukeboxInitEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_530,this.onDisposeEvent);
               this.var_85 = null;
            }
            if(this.var_393)
            {
      ...
      {
         this.startPlaying(this.const_1860);
      }
      ...
      {
         this.startPlaying(this.const_1574);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_279 = _loc2_.id;
            this.playSong(this.var_279);
         }
      }
      
      public function checkSongPlayState(param1:int) : void
      {
         if(this.var_279 == param1)
         {
            this.playSong(this.var_279);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_393[this.var_279] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_393.getValue(this.var_279) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_279 = param1;
         var _loc2_:IHabboSound = this.var_393.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_582.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_582.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_279)
         {
            _loc6_ = this.var_393[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1693 == this.const_1574)
         {
            this.var_73.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_573.indexOf(param1) == -1)
         {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_573 = this.var_573.splice(this.var_573.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_393[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_582.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_393.add(_loc3_.id,_loc7_);
            }
