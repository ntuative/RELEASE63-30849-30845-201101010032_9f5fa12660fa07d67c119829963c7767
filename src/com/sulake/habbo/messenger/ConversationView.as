package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1214:int = 10;
      
      private static const const_858:int = 100;
      
      private static const const_1213:int = 20;
       
      
      private var var_127:HabboMessenger;
      
      private var var_2519:IScrollbarWindow;
      
      private var var_1784:IContainerButtonWindow;
      
      private var var_53:IItemListWindow;
      
      private var var_487:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_127 = param1;
         this.var_1784 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_53 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2519 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_858 + const_1213)
         {
            this.refreshList();
            this.method_3();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1214;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_487 == null || _loc1_.id != this.var_487.id)
         {
            this.var_487 = _loc1_;
            this.refreshList();
            this.method_3();
      ...
      {
         if(this.var_487.followingAllowed)
         {
            this.var_1784.enable();
         }
         else
         {
            this.var_1784.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_53.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_487.messages.length - const_858);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_487.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_487.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_760 || param3.type == Message.const_714 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_487.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_127.send(new FollowFriendMessageComposer(this.var_487.id));
      }
