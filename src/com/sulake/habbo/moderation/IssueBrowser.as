package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1868:String = "my_issues";
      
      private const const_1867:String = "open_issues";
      
      private const const_1866:String = "picked_issues";
      
      private const const_1877:String = "closed_issues";
      ...
      private var var_336:IIssueBrowserView;
      
      private var var_1765:IIssueBrowserView;
      
      private var var_1763:IIssueBrowserView;
      
      private var var_1764:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_251 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_251.numTabItems)
            {
               _loc5_ = this.var_251.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_59,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_251 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_251 == null || this.var_251.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_251.selector.getSelectableByName("open_issues");
         this.var_251.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_336 == _loc2_)
         {
            return;
         }
         ...
         this.var_336.view.width = this.var_251.container.width;
         this.var_336.view.height = this.var_251.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1868:
               ...
               {
                  this.var_1765 = new MyIssuesView(this.issueManager,this,this.var_251.container);
               }
               return this.var_1765;
            case this.const_1867:
               if(this.var_1763 == null)
               {
                  this.var_1763 = new OpenIssuesView(this.issueManager,this,this.var_251.container);
               }
               return this.var_1763;
            case this.const_1866:
               if(this.var_1764 == null)
               {
                  this.var_1764 = new PickedIssuesView(this.issueManager,this,this.var_251.container);
               }
