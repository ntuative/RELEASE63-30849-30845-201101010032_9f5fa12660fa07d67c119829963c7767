package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1521;
      ...
      {
         return WindowTracker.const_1429;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_47.initMsg.messageTemplates[this.var_1033.selection];
         if(_loc3_ != null)
         {
            this.var_610 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.connection.send(new ModMessageMessageComposer(this.var_1245,this.var_430.text,this.var_1246));
         this.dispose();
      }
