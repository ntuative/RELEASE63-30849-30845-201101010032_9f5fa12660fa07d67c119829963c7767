package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_890:Array = [];
      
      private static var var_1708:int = 200;
      ...
      {
         this.var_698 = IWindowContainer(this.var_47.getXmlWindow("roomvisits_row"));
         this.var_449 = new Timer(300,1);
         this.var_449.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this.var_47.messageHandler.addRoomVisitsListener(this);
         this.var_47.connection.send(new GetRoomVisitsMessageComposer(this._userId));
         this._frame = IFrameWindow(this.var_47.getXmlWindow("roomvisits_frame"));
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         this.var_47.messageHandler.removeRoomVisitsListener(this);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1394;
      }
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         new OpenRoomTool(this._frame,this.var_47,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(this.var_47,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_53);
      }
      
      private function addRoomRowToList(param1:IWindowContainer, param2:IItemListWindow) : void
      {
         param2.addListItem(param1);
         this.var_1349.push(param1);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_890.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_698.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_890.length < var_1708)
         {
            ...
            param1.width = this.var_698.width;
            param1.height = this.var_698.height;
            var_890.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1349)
         {
