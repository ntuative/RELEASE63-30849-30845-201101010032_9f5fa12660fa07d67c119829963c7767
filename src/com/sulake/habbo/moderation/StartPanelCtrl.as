package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      public function show() : void
      {
         if(this._frame == null)
         {
            this._frame = IFrameWindow(this.var_47.getXmlWindow("start_panel"));
            ...
            this._frame.findChildByName("room_tool_but").disable();
            this._frame.findChildByName("chatlog_but").disable();
            this.var_47.disableButton(this.var_47.initMsg.cfhPermission,this._frame,"ticket_queue_but");
      ...
      {
         if(this.var_47.initMsg.chatlogsPermission)
         {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1510 ? 0 : 1,this._roomId),this.var_47,WindowTracker.const_762,this._roomId),this._frame,false,false,true);
      }
