package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_885:int = 60;
      
      private static const const_882:int = 3600;
      
      private static const const_884:int = 86400;
      
      private static const const_883:int = 31536000;
      ...
      private var var_1160:IWindowContainer;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_47 = param2;
         this.var_1246 = param3;
         this.var_1159 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_885)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_882)
         {
            return Math.round(param1 / const_885) + " mins ago";
         }
         if(param1 < 2 * const_884)
         {
            return Math.round(param1 / const_882) + " hours ago";
         }
         if(param1 < 2 * const_883)
         {
            return Math.round(param1 / const_884) + " days ago";
         }
         return Math.round(param1 / const_883) + " years ago";
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         this._data = null;
         this.refresh();
         this.var_47.messageHandler.addUserInfoListener(this);
         this.var_47.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_47.messageHandler.removeUserInfoListener(this);
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1160.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_47.getXmlWindow("user_info"));
            this.var_1160.addChild(_loc1_);
            this.var_47.disableButton(this.var_47.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            this.var_47.disableButton(this.var_47.initMsg.alertPermission,_loc1_,"message_but");
            this.var_47.disableButton(this.var_47.initMsg.alertPermission || this.var_47.initMsg.kickPermission || this.var_47.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_47,WindowTracker.const_1100,this._data.userId),this._callerFrame,this.var_1159,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new RoomVisitsCtrl(this.var_47,this._data.userId),this._callerFrame,this.var_1159,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.openHkPage("habboinfotool.url",this._data.userName);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new SendMsgsCtrl(this.var_47,this._data.userId,this._data.userName,this.var_1246),this._callerFrame,this.var_1159,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new ModActionCtrl(this.var_47,this._data.userId,this._data.userName,this.var_1246),this._callerFrame,this.var_1159,false,true);
      }
      ...
      {
         this.var_47.openHkPage("moderatoractionlog.url",this._data.userName);
      }
   }
}
