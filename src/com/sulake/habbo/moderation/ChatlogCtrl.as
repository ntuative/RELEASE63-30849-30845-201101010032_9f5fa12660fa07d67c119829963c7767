package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_787:Array = [];
      
      private static var var_1467:int = 1000;
      
      private static var var_786:Array = [];
      
      private static var var_1469:int = 200;
      ...
      private var var_636:IWindowContainer;
      
      private var var_635:IWindowContainer;
      
      private var var_1470:Dictionary;
      
      private var var_449:Timer;
      
      private var var_1214:Map;
      ...
      {
         this.var_636 = IWindowContainer(this.var_47.getXmlWindow("chatlog_roomheader"));
         this.var_635 = IWindowContainer(this.var_47.getXmlWindow("chatlog_chatline"));
         this.var_449 = new Timer(1000,1);
         ...
         this.var_47.connection.send(this.var_1468);
      ...
      private function populate() : void
      {
         ...
         for each(_loc1_ in this.var_100)
         {
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         this.addHeaderLineToList(_loc2_,this.var_53);
         var _loc4_:* = true;
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_787.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_635.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_787.length < var_1467)
         {
            ...
            param1.width = this.var_635.width;
            param1.height = this.var_635.height;
            var_787.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_786.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_636.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_786.length < var_1469)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_636.width;
            param1.height = this.var_636.height;
            var_786.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1470[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1214.getValue(param2.chatterName))
            {
               this.var_1214.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1214.getValue(_loc2_);
         this.var_47.windowTracker.show(new UserInfoFrameCtrl(this.var_47,_loc3_),this._frame,false,false,true);
      }
      ...
      private function refreshListDims() : void
      {
         ...
         var _loc2_:* = null;
         this.var_53.autoArrangeItems = false;
         var _loc3_:int = this.var_53.numListItems;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc1_ = IWindowContainer(this.var_53.getListItemAt(_loc4_));
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1213)
         {
