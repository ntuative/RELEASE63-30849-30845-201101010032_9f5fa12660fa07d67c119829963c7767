package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_986:int = 3;
      
      public static const const_762:int = 4;
      
      public static const const_1100:int = 5;
      
      public static const const_1394:int = 6;
      
      public static const const_1278:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1342:int = 9;
       
      
      private var var_1565:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1565 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1565[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1565[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
