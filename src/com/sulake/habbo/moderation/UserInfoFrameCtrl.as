package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_999:UserInfoCtrl;
      ...
      {
         this._frame = IFrameWindow(this.var_47.getXmlWindow("user_info_frame"));
         this._frame.caption = "User Info";
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_999 = new UserInfoCtrl(this._frame,this.var_47,"",true);
         this.var_999.load(this._frame.content,this._userId);
