package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1099:String = "issue_bundle_open";
      
      public static const const_720:String = "issue_bundle_my";
      
      public static const const_902:String = "issue_bundle_picked";
      
      public static const const_1367:int = 15000;
       
      
      private var var_59:ModerationManager;
      
      private var var_543:IssueBrowser;
      
      private var _issues:Map;
      
      private var var_94:Map;
      
      private var var_828:Map;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_94 = new Map();
         this.var_828 = new Map();
         this.var_543 = new IssueBrowser(this,this.var_59.windowManager,this.var_59.assets);
         this.var_1003 = [];
         this.var_1004 = [];
         this.var_827 = new Map();
         this.var_2131 = parseInt(this.var_59.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1560 = new Timer(const_1367,0);
         this.var_1560.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1560.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1003 = this.var_1003.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_147 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_332 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_59.soundManager.playSound(HabboSoundTypesEnum.const_1119);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_828.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_828.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1281)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_94)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_828.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2130++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_828.add(param1.issueId,_loc2_);
         ...
         {
            _loc6_ = this.getBundles(const_720);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1004.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2131);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_827.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_827.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_828.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_94.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
         ...
         for each(_loc4_ in this.var_94)
         {
            switch(param1)
            {
               case const_1099:
                  ...
                  break;
               case const_720:
                  if(_loc4_.state == IssueMessageData.const_332 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_827.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_827.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_332 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_827.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
