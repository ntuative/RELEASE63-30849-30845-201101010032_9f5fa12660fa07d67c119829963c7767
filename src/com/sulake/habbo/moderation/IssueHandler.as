package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_139:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_433:UserInfoCtrl;
      
      private var var_987:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_44,this.onResized);
         }
         ...
         var _loc3_:IssueMessageData = this.var_139.getHighestPriorityIssue();
         this.var_433 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
         this.var_987 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
         this.var_433.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_139.reportedUserId > 0)
         {
            this.var_987.load(_loc4_,this.var_139.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_139.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_139.issues;
         var _loc3_:int = 0;
         var _loc5_:int = _loc1_.numListItems;
         var _loc6_:int = _loc2_.length;
         if(_loc5_ < _loc6_)
         {
            _loc9_ = this.var_59.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
            if(_loc9_ == null || _loc9_.content == null)
            {
               return;
            }
            _loc4_ = this.var_59.windowManager.buildFromXML(_loc9_.content as XML) as IWindowContainer;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      private function updateMessages() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc8_ = this.var_59.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
            if(_loc8_ == null || _loc8_.content == null)
            {
               return;
            }
            _loc4_ = this.var_59.windowManager.buildFromXML(_loc8_.content as XML) as ITextWindow;
            if(_loc4_ == null)
            {
               return;
            }
            ...
            while(_loc3_ < _loc6_ - _loc5_)
            {
               _loc9_ = _loc4_.clone() as IWindowContainer;
               if(_loc9_ == null)
               {
                  return;
               }
      ...
      {
         if(this.var_59 != null && this.var_59.issueManager != null && this.var_139 != null)
         {
            this.var_59.issueManager.removeHandler(this.var_139.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_139.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_139.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_139.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.releaseBundle(this.var_139.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_139.getHighestPriorityIssue().issueId;
         this.var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_59,WindowTracker.const_986,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_139.getHighestPriorityIssue();
            this.var_433 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
            this.var_433.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
