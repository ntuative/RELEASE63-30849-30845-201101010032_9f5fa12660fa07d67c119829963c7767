package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1219:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1220:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         var _loc2_:RoomWidgetClothingChangeUpdateEvent = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_349);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_731,RoomWidgetClothingChangeMessage.const_361,RoomWidgetAvatarEditorMessage.const_366];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_731:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc8_)
                     {
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_370,_loc6_.id,_loc6_.category,_loc6_.roomId,_loc6_.roomCategory);
            ...
            case RoomWidgetClothingChangeMessage.const_361:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     this.var_327 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1015);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1219;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1046);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1220;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_218,AvatarEditorFigureCategory.const_756],true))
                     {
                        _loc11_ = 0;
                        this._container.avatarEditor.loadAvatarInEditor(_loc10_,_loc9_,_loc11_);
                        _loc2_ = _loc4_.getString(RoomObjectVariableEnum.const_92);
                        if(_loc2_ == null)
                        {
                           _loc2_ = "";
                        }
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_370,_loc7_.objectId,_loc7_.objectCategory,_loc7_.roomId,_loc7_.roomCategory);
                        this._container.events.dispatchEvent(_loc5_);
                     }
                  }
               }
            ...
            case RoomWidgetAvatarEditorMessage.const_366:
               _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_349);
               this._container.events.dispatchEvent(_loc5_);
         }
         return null;
      }
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         this._container.roomSession.sendUpdateClothingChangeFurniture(this.var_327,param2,param1);
