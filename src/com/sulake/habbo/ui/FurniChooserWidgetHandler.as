package com.sulake.habbo.ui
{
   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_477;
      }
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         var _loc3_:* = [];
         var _loc9_:int = this._container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            _loc8_ = this._container.roomEngine.getRoomObjectWithIndex(_loc1_,_loc2_,_loc4_,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_334);
               ...
               _loc3_.push(new ChooserItem(_loc8_.getId(),RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE,_loc7_));
            }
            _loc4_++;
         }
         _loc9_ = this._container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.const_27);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
         ...
         this._container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_568,_loc3_,this._container.sessionDataManager.isAnyRoomController));
      }
