package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_435;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_155,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_149,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_155,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_149,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_699.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_699.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_606);
         _loc1_.push(RoomWidgetUserActionMessage.const_578);
         _loc1_.push(RoomWidgetUserActionMessage.const_709);
         _loc1_.push(RoomWidgetUserActionMessage.const_684);
         _loc1_.push(RoomWidgetUserActionMessage.const_500);
         _loc1_.push(RoomWidgetUserActionMessage.const_700);
         _loc1_.push(RoomWidgetUserActionMessage.const_628);
         _loc1_.push(RoomWidgetUserActionMessage.const_730);
         _loc1_.push(RoomWidgetUserActionMessage.const_613);
         _loc1_.push(RoomWidgetUserActionMessage.const_783);
         _loc1_.push(RoomWidgetFurniActionMessage.const_281);
         _loc1_.push(RoomWidgetFurniActionMessage.const_821);
         _loc1_.push(RoomWidgetFurniActionMessage.const_803);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_615);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_792);
         _loc1_.push(RoomWidgetUserActionMessage.const_409);
         _loc1_.push(RoomWidgetUserActionMessage.const_668);
         _loc1_.push(RoomWidgetUserActionMessage.const_532);
         _loc1_.push(RoomWidgetUserActionMessage.const_1344);
         _loc1_.push(RoomWidgetPetCommandMessage.const_571);
         _loc1_.push(RoomWidgetPetCommandMessage.const_644);
         _loc1_.push(RoomWidgetUserActionMessage.const_463);
         _loc1_.push(RoomWidgetUserActionMessage.const_333);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_630);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_409)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_333 || param1.type == RoomWidgetUserActionMessage.const_463 || param1.type == RoomWidgetUserActionMessage.const_532)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_581:
               ...
               break;
            case RoomWidgetUserActionMessage.const_606:
               this._container.sessionDataManager.giveRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_463:
               this._container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_578:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_921,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_684:
               ...
               break;
            case RoomWidgetUserActionMessage.const_500:
               this._container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_700:
            ...
            case RoomWidgetUserActionMessage.const_628:
               ...
               break;
            case RoomWidgetUserActionMessage.const_730:
            ...
            case RoomWidgetUserActionMessage.const_333:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_615:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_792:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_645);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_933);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1050);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_248)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_344)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1014)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_450);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_178)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_203)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_670);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1484;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_953;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_935;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1276);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = this._container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_49,_loc18_);
               if(_loc19_ != null)
               {
                  _loc19_.setDirection(AvatarSetType.const_33,4);
                  _loc13_.image = _loc19_.getImage(AvatarSetType.const_33,true);
                  _loc19_.dispose();
               }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_119];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_119:
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_49,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_699.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_49);
            this.var_699.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_670);
