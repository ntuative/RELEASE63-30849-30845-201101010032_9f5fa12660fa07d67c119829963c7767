package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_788:Map = null;
      
      private var _connection:IConnection = null;
      
      private var var_966:Number = 0.0;
      
      private var var_637:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_359 != null)
         {
            ...
            {
               _loc2_ = this.var_359.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_360.length)
            {
               _loc2_ = this.var_360.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_806,RoomWidgetChatSelectAvatarMessage.const_773];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_806:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     switch(_loc3_.chatType)
                     {
                        case RoomWidgetChatMessage.const_126:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_113:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_773:
      ...
      {
         return [RoomSessionChatEvent.const_165];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_165:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_248)
                           {
                              _loc13_ = this.var_360.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_359.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_788.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_248:
                                       _loc17_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc16_,AvatarScaleType.const_82,this);
                                       if(_loc17_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_82,null,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_248)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_360.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_359.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_788.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_966 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_966);
            }
            if(this.var_637 == null)
            {
               ...
               this.var_426.y = 0;
               this.var_426.z = 0;
               this.var_637 = _loc4_.getScreenPoint(this.var_426);
               this.var_966 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_426.x = 0;
            this.var_426.y = 0;
            this.var_426.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_426);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_637.x || _loc8_.y != this.var_637.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_637,_loc5_));
