package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1032:IRoomWidgetFactory;
      
      private var var_370:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_431:IAvatarRenderManager;
      ...
      private var var_1627:IHabboAvatarEditor = null;
      ...
      private var var_1037:IHabboHelp;
      
      private var var_857:IHabboModeration;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_582:IHabboSoundManager;
      ...
      {
         this.var_1304 = RoomDesktop.const_519;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1032.release(new IIDHabboRoomWidget());
            this.var_1032 = null;
         }
         ...
         {
            this.var_582.release(new IIDHabboSoundManager());
            this.var_582 = null;
         }
         ...
         {
            this.var_431.release(new IIDAvatarRenderManager());
            this.var_431 = null;
         }
         ...
         {
            this.var_1037.release(new IIDHabboHelp());
            this.var_1037 = null;
         }
         ...
         {
            this.var_857.release(new IIDHabboModeration());
            this.var_857 = null;
         }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1032 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_431 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1627 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_273.events.addEventListener(AdEvent.const_481,this.adEventHandler);
            this.var_273.events.addEventListener(AdEvent.const_497,this.adEventHandler);
            this.var_273.events.addEventListener(AdEvent.const_399,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1037 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_857 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_857);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_582 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_17)
         {
            this.var_17.events.addEventListener(RoomSessionEvent.const_212,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionEvent.const_81,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionEvent.const_89,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionChatEvent.const_165,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionChatEvent.const_466,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionUserBadgesEvent.const_119,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDoorbellEvent.const_102,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDoorbellEvent.const_138,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDoorbellEvent.const_40,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionPresentEvent.const_279,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionViralFurniStatusEvent.const_526,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionViralFurniStatusEvent.const_502,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_215,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_250,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_676,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_1065,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_1094,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_225,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_232,this.roomSessionDialogEventHandler);
            ...
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_226,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_216,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_812,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_696,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_184,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_654,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_759,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionQueueEvent.const_476,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionVoteEvent.const_135,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionVoteEvent.const_122,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionPollEvent.const_120,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionPollEvent.const_64,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionPollEvent.const_133,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDimmerPresetsEvent.const_405,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionFriendRequestEvent.const_116,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_212:
            ...
            case RoomSessionEvent.const_89:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.ZOOM));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.MEMENU));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_654:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_759:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_703,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_643,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_776,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_482,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_422,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_57,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_611,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_607,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_489,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_296,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_713,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_396,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_703)
         {
            if(this.var_17 != null)
            {
               this.var_17.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_422 || param1.type == RoomEngineEvent.const_482)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_643:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_775);
               if(!_loc5_)
               {
                  _loc3_.createWidget(RoomWidgetEnum.const_477);
               }
               _loc3_.createWidget(RoomWidgetEnum.const_273);
               if(this.var_1304 != RoomDesktop.const_519)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_273,this.var_1304);
               }
               if(this.var_273 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_776:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_611:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1032;
         _loc3_.sessionDataManager = this.var_370;
         _loc3_.roomSessionManager = this.var_17;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_431;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this._toolbar;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1627;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_273;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1037;
         _loc3_.moderation = this.var_857;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_582;
