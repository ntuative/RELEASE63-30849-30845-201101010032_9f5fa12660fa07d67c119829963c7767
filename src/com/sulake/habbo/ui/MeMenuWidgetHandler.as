   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_771,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_511,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_109,this.onHelpTutorialEvent);
            }
            this._container = null;
         }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_771,this.onFigureUpdate);
            this._container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_168,this.onCreditBalance);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_964,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1117,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_511,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_109,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1363)
            {
               _loc4_ = this._container.sessionDataManager.gender;
               _loc5_ = this._container.avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_49,_loc4_,this);
               if(_loc5_ != null)
               {
               ...
               this.var_1363 = _loc3_;
               this.var_1728 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1728;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1042,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_753);
         _loc1_.push(RoomWidgetDanceMessage.const_601);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_661);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_637);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_818);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_785);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_701);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_633);
         _loc1_.push(RoomWidgetStopEffectMessage.const_784);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1495);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_967);
         _loc1_.push(RoomWidgetToolbarMessage.const_810);
         _loc1_.push(RoomWidgetToolbarMessage.const_651);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_366);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1385);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1068);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_811);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_564);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_636);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1473);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_758);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_603);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_655);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_564:
               ...
               break;
            case RoomWidgetWaveMessage.const_753:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_601:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_661:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_637:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_818:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_633:
            ...
            case RoomWidgetOpenInventoryMessage.const_701:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_948:
                        this._catalog.openCatalogPage(CatalogPageName.const_1478,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_942:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_262);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_784:
            ...
            case RoomWidgetNavigateToRoomMessage.const_967:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_811:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_810:
               ...
               if(this._toolbar)
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                     if(this._container != null && this._container.sessionDataManager != null)
               ...
               break;
            case RoomWidgetToolbarMessage.const_651:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_455,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_366:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_417));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_636:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_379,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_758:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_379,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_603:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_379,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_655:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_507));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_361:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_592));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_734));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_109:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_109));
               break;
            case HabboHelpTutorialEvent.const_511:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_457));
         }
      }
