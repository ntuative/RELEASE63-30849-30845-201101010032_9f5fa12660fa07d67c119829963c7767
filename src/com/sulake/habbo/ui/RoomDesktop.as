package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1032:IRoomWidgetFactory = null;
      
      private var var_370:ISessionDataManager = null;
      
      private var var_17:IRoomSessionManager = null;
      
      private var var_431:IAvatarRenderManager = null;
      ...
      private var var_1037:IHabboHelp = null;
      ...
      private var var_200:IToolTipWindow;
      
      private var var_2230:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_346,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_512,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_642,this.onRoomContentLoaded);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_454.length)
            {
               _loc6_ = this.var_454.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_346,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_512,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_642,this.onRoomContentLoaded);
         }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_29 != null)
         {
            this.var_679 = this._roomEngine.loadRoomResources(this.var_29.roomResources);
            if(this.var_679.length > 0)
            {
               this.var_1617 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_99));
            }
         }
         if(this.var_273 != null && this.var_29.state == RoomSessionEvent.const_212)
         {
            this.var_1616 = !this.var_273.showInterstitial();
         }
      ...
      {
         if(this.var_679 == null || this.var_679.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_679.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_679.splice(_loc2_,1);
         }
         if(this.var_679.length == 0)
         {
            this.var_1617 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1032.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         switch(param1)
         {
            ...
            case RoomWidgetEnum.const_411:
               ...
               break;
            case RoomWidgetEnum.const_775:
               _loc3_ = new ConversionPointWidgetHandler();
         }
         if(_loc3_ != null)
         {
            _loc3_.container = this;
            if(!this.var_454.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_678.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_678.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_680.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_680.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_678.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_680.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_607:
               ...
               if(this.var_857 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc7_ = this.var_29.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_344)
                  {
                     this.var_857.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_296:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_489:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_245,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_713:
               if(!this.var_29.isRoomController && !this.var_370.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_117:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_635,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_127:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1021,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_482:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_111,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_422:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_1088,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc5_:int = 0;
         if(this.var_271.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_563);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_694);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_808);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_683);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_161,this.canvasMouseHandler);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_169,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2230);
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_271[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_200 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_200.width / 2,15);
            this.var_200.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_29.roomId,this.var_29.roomCategory,this.var_271[0],_loc2_.width,_loc2_.height);
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1618) / 1000);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < this.var_454.length)
         {
            _loc2_ = this.var_454.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         if(this.var_17 != null && this.var_29 != null && this.var_1616 && this.var_1617)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_360);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_462:
               ...
               this.var_200 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_375,WindowStyle.const_739,WindowParam.const_91) as IToolTipWindow;
               this.var_200.setParamFlag(WindowParam.const_28,false);
               this.var_200.visible = true;
               this.var_200.center();
               break;
            case RoomEngineObjectEvent.const_396:
               if(this.var_200 == null)
