package com.sulake.habbo.ui
{
   ...
   public class VoteWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetVoteMessage.const_107];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetVoteMessage.const_107:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionVoteEvent.const_135);
         _loc1_.push(RoomSessionVoteEvent.const_122);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionVoteEvent.const_135:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_135,_loc2_.question,_loc2_.choices);
               break;
            case RoomSessionVoteEvent.const_122:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_122,_loc2_.question,_loc2_.choices,_loc2_.votes,_loc2_.totalVotes);
         }
         if(_loc3_ == null)
         {
            return;
