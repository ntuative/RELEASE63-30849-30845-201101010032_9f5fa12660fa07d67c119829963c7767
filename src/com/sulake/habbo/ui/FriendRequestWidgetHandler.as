package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_598);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_769);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_574);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_598:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_769:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_574:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_116);
         _loc1_.push(FriendRequestEvent.const_40);
         _loc1_.push(FriendRequestEvent.const_260);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_116:
               ...
               break;
            case FriendRequestEvent.const_40:
            case FriendRequestEvent.const_260:
