package com.sulake.habbo.ui
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_402,RoomWidgetPollMessage.const_626];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_626:
               this._container.roomSession.sendPollStartMessage(_loc2_.id);
               break;
            case RoomWidgetPollMessage.const_402:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionPollEvent.const_133);
         _loc1_.push(RoomSessionPollEvent.const_64);
         _loc1_.push(RoomSessionPollEvent.const_120);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionPollEvent.const_133:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_133);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_64:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_64);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_120:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_120);
