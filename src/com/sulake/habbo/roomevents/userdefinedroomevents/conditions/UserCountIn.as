package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_970:SliderWindowController;
      
      private var var_971:SliderWindowController;
      ...
      {
         return ConditionCodes.var_1897;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_970.getValue());
         _loc2_.push(this.var_971.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_85 = param2;
         this.var_970 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_970.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_970.setValue(1);
         this.var_971 = new SliderWindowController(param2,this.method_6(param1),param2.assets,1,50,1);
         this.var_971.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_971.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_970.setValue(_loc3_);
         this.var_971.setValue(_loc4_);
      }
      ...
      private function method_6(param1:IWindowContainer) : IWindowContainer
      {
      ...
      private function onMinSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc4_ = int(_loc3_);
               this.var_85.localization.registerParameter("wiredfurni.params.usercountmin","value","" + _loc4_);
            }
         }
      }
      ...
      private function onMaxSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               _loc3_ = _loc2_.getValue();
               _loc4_ = int(_loc3_);
               this.var_85.localization.registerParameter("wiredfurni.params.usercountmax","value","" + _loc4_);
            }
         }
      }
   }
