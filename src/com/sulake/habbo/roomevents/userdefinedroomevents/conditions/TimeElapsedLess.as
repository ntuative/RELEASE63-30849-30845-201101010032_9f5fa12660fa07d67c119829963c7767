package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class TimeElapsedLess implements ConditionType
   {
      ...
      {
         return ConditionCodes.var_1892;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         var _loc3_:int = this.var_960.getValue();
      ...
      {
         this.var_85 = param2;
         this.var_960 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,1200,1);
      ...
      private function onSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_85.localization.registerParameter("wiredfurni.params.allowbefore","seconds",_loc5_);
            }
         }
      }
   }
