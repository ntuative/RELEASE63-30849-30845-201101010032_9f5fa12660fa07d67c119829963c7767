package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1052:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1052,param1);
         this.var_865 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_865);
         }
      ...
      {
         return int(this.var_1547 * (Number(param1 - this._minValue) / (this.var_1052 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1547 * (this.var_1052 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_866)
         {
            if(param1.type == WindowMouseEvent.const_55 || param1.type == WindowMouseEvent.const_169)
            {
               this.var_866 = false;
            }
         }
         if(!this.var_866 || param1.type != WindowEvent.const_377)
         {
            return;
         }
         if(this.var_569 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_569) * this.var_569;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_569 != 0)
            {
               _loc3_ = this.var_865 + this.var_569;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_662 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_662.width,this.var_662.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_662,this.var_662.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_661 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_661.width,this.var_661.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_661,this.var_661.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1547 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_662 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_661 = BitmapData(_loc2_.content);
      }
   }
}
