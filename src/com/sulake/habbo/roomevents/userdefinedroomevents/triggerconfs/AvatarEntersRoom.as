package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class AvatarEntersRoom implements TriggerConf
   {
      ...
      {
         return TriggerConfCodes.var_1893;
      }
      ...
      {
         this._cont = param1;
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_419,this.onCertainAvatarSelect);
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_614,this.onCertainAvatarUnselect);
      }
