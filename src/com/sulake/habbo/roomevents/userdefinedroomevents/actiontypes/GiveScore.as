package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_960:SliderWindowController;
      
      private var var_1161:SliderWindowController;
      ...
      {
         return ActionTypeCodes.var_1915;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_960.getValue());
         _loc2_.push(this.var_1161.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_85 = param2;
         this.var_960 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_960.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_960.setValue(1);
         this.var_1161 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1161.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_1161.setValue(1);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_960.setValue(_loc3_);
         this.var_1161.setValue(_loc4_);
      }
