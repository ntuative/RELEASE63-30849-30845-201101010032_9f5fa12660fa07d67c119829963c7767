package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_45:IHabboCommunicationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_17:IRoomSessionManager;
      
      private var var_472:IKeyExchange;
      
      private var var_886:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2350:PseudoRandom;
      ...
      private var var_208:HabboHotelView;
      
      private var var_1344:String = "";
      
      private const const_1575:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_577 = param1;
            this.var_45.initConnection(HabboConnectionType.const_213);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_89,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_45 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_45.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_45.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_45.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_45.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_45.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_45.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_45.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
            this.var_45.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_45.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_45.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_45.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_45.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_45.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.method_7));
            this.var_45.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_45.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_45 && this._habboConfiguration && this.var_17 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_208 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this._habboConfiguration.getKey("client.hotel_view.image");
         var _loc2_:String = this._habboConfiguration.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_208.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this._habboConfiguration.getKey("use.sso.ticket") == "1";
         this.var_577 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1702 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2349 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_208 == null)
         {
            this.var_208 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_45.mode = HabboConnectionType.const_111;
            if(this.var_577)
            {
               this.var_45.initConnection(HabboConnectionType.const_213);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_503,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_45.mode = HabboConnectionType.const_977;
            }
         }
         this.var_45.initConnection(HabboConnectionType.const_213);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_45.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_629);
            _loc3_ = new InitCryptoMessageComposer(this.var_45.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2350 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_45.mode)
         {
            case HabboConnectionType.const_111:
               _loc6_ = "";
               ...
               this.var_208.loadBannerImage(_loc7_ + "?token=" + this.var_1344,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_977:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1340:
               this.var_886 = this.generateRandomHexString(30);
               this.var_472 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_472.init(this.var_886);
               _loc8_ = this.var_472.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_45.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_472.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_472.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2350);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1343 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_199);
         connection.send(new VersionCheckMessageComposer(401,this.var_1702,this.var_2349));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1575,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_577 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_577);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_166);
         }
      ...
      {
         var _loc4_:IConnection = this.var_45.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_251);
      }
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_217);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1343)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_164);
         }
         if(param1.type == Event.CLOSE && !this.var_2348)
         {
            _loc2_ = this._habboConfiguration.getKey("logout.disconnect.url");
            if(this._habboConfiguration.keyExists("facebook.user"))
            {
      ...
      private function method_7(param1:RoomEntryInfoMessageEvent) : void
      {
         if(this.var_208)
         {
            if(!this.var_208.disposed)
            {
               this.var_208.hide();
            }
         }
      ...
      {
         if(!this.var_17.sessionStarting)
         {
            this.showHotelView();
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1344);
         ...
         var _loc9_:IConnection = this.var_45.getHabboMainConnection(null);
         ...
         this.var_472 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_472.init(_loc14_);
            _loc15_ = this.var_472.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_886 = _loc14_;
            }
