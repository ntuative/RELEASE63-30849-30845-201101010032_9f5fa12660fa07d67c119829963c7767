package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1137:Function;
      
      private var var_1138:Function;
      
      private var var_734:IAssetLibrary;
      
      private var var_1136:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_734.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_734.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         if(param1.type == AssetLoaderEvent.const_42)
         {
            ...
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_64));
            }
         }
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_479));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this._window && !this._window.disposed)
            {
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_734.loadAssetFromFile("hotel_view_banner_" + this.var_1136,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_745));
            }
