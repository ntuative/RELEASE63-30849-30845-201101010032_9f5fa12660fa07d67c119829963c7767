   ...
   public class RoomQueueStatusMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc5_ < _loc2_)
         {
            ...
            while(_loc8_ < _loc3_)
            {
               _loc4_.method_4(param1.readString(),param1.readInteger());
               _loc8_++;
            }
            this.var_873.add(_loc4_.target,_loc4_);
            _loc5_++;
         }
         return true;
      }
      ...
      {
         return this.var_873.getKeys();
      }
      
      public function getQueueSet(param1:int) : RoomQueueSet
      {
         return this.var_873.getValue(param1) as RoomQueueSet;
      }
   }
}
