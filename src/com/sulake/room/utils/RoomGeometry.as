package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_610:Number = 64;
      
      public static const const_1072:Number = 32;
       
      
      private var var_144:int = 0;
      ...
      private var var_1655:Number = 1.0;
      
      private var var_1654:Number = 1.0;
      
      private var var_1653:Number = 1.0;
      
      private var var_72:Vector3d;
      
      private var var_240:Vector3d;
      
      private var var_2697:Number = -500.0;
      
      private var var_2696:Number = 500.0;
      
      private var _width:Number;
      
      private var var_467:Map = null;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1653 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_72.x * this.var_384,this.var_72.y * this.var_385,this.var_72.z * this.var_386);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_240.x,this.var_240.y,this.var_240.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_384 != param1 * this.var_1655)
         {
            this.var_384 = param1 * this.var_1655;
            ++this.var_144;
         }
      }
      ...
      {
         if(this.var_385 != param1 * this.var_1654)
         {
            this.var_385 = param1 * this.var_1654;
            ++this.var_144;
         }
      }
      ...
      {
         if(this.var_386 != param1 * this.var_1653)
         {
            this.var_386 = param1 * this.var_1653;
            ++this.var_144;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_72.x /= this.var_384;
         this.var_72.y /= this.var_385;
         this.var_72.z /= this.var_386;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_240.x;
         var _loc3_:Number = this.var_240.y;
         var _loc4_:Number = this.var_240.z;
         this.var_240.assign(param1);
         if(this.var_240.x != _loc2_ || this.var_240.y != _loc3_ || this.var_240.z != _loc4_)
         {
            ++this.var_144;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_467 != null)
         {
            ...
            this.var_467.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_467.add(_loc3_,_loc4_);
            ++this.var_144;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_467 != null)
         {
            ...
            return this.var_467.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1051.assign(_loc22_);
         }
         else
         {
            this.var_1051.assign(_loc17_);
         }
         ++this.var_144;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_384;
         _loc2_.y *= this.var_385;
         _loc2_.z *= this.var_386;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1051);
         if(_loc3_ < this.var_2697 || _loc3_ > this.var_2696)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_385;
            _loc2_.z *= this.var_386;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1051);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_72.x * this.var_384,this.var_72.y * this.var_385,this.var_72.z * this.var_386);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_160;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_384,param2.y * this.var_385,param2.z * this.var_386);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_384,param3.y * this.var_385,param3.z * this.var_386);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_384,param4.y * this.var_385,param4.z * this.var_386);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1072;
         }
         else
         {
            this.scale = const_610;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_610;
      }
