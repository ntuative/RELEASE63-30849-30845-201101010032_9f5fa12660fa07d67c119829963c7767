package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_351:IRoomObject;
      
      private var var_1244:IGraphicAssetCollection;
      
      protected var var_417:int = -1;
      
      protected var var_218:int = -1;
      
      protected var var_217:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_178.length > 0)
            {
               _loc1_ = this.var_178[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_178.length > param1)
         {
            _loc2_ = this.var_178[this.var_178.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_178.length)
         {
      ...
      {
         this.var_417 = 4294967295;
         this.var_218 = 4294967295;
         this.var_217 = -1;
      }
