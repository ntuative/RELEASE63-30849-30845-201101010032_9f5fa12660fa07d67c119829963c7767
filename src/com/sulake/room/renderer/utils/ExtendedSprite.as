package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1237:int = 128;
      
      private var var_1236:Boolean = false;
      
      private var var_2691:Point;
      ...
      {
         if(param1 != this.var_1503 || param2 != this.var_1502)
         {
      ...
      {
         if(this.var_1237 > 255 || bitmapData == null)
         {
            return false;
         }
