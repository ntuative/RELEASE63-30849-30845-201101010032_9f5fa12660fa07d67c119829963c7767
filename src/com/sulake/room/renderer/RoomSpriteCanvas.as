package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_234:Sprite;
      
      private var var_120:Sprite;
      
      private var var_51:Sprite;
      
      private var var_551:Map;
      
      private var var_442:Point;
      ...
      private var var_1272:IRoomRenderingCanvasMouseListener = null;
      
      private var _id:String = "";
      
      private var var_303:Map = null;
      ...
      private var var_2161:Number = -1.0E7;
      
      private var var_2159:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_234 = new Sprite();
         this.var_234.mouseEnabled = false;
         this.var_51 = new Sprite();
         this.var_51.name = "canvas";
         this.var_51.mouseEnabled = false;
         this.var_234.addChild(this.var_51);
         this.var_51.mouseEnabled = true;
         this.var_51.doubleClickEnabled = true;
         this.var_51.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_51.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
         this._geometry = new RoomGeometry(param5,new Vector3d(-135,30,0),new Vector3d(11,11,5),new Vector3d(-135,0.5,0));
         this.var_235 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
      ...
      {
         this.var_442.x -= param1 - this.var_547;
         this.var_547 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_442.y -= param1 - this.var_548;
         this.var_548 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_839 = true;
            if(this.var_120 != null && !this.var_234.contains(this.var_120))
            {
               this.var_234.addChild(this.var_120);
               this.var_51.mask = this.var_120;
            }
         }
         else if(!param1 && this.var_839)
         {
            this.var_839 = false;
            if(this.var_120 != null && this.var_234.contains(this.var_120))
            {
               this.var_234.removeChild(this.var_120);
               this.var_51.mask = null;
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_234.numChildren > 0)
            {
               this.var_234.removeChildAt(0);
            }
            this.var_234 = null;
         }
         this.var_51 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_550.length)
            {
               this.cleanSprite(this.var_550[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_550 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_120 != null)
         {
            this.var_120.graphics.clear();
         }
         else
         {
            this.var_120 = new Sprite();
            this.var_120.name = "mask";
            if(this.var_839)
            {
               this.var_234.addChild(this.var_120);
               this.var_51.mask = this.var_120;
         ...
         this.var_120.graphics.beginFill(0);
         this.var_120.graphics.drawRect(0,0,param1,param2);
         this.var_668 = param1;
         this._ht = param2;
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(param1 == this.var_2163)
         {
            return;
         }
         this.var_235.compress();
         ...
         if(this.var_668 != this.var_2162 || this._ht != this.var_2160)
         {
            _loc9_ = true;
         }
         if(this.var_51.x != this.var_547 || this.var_51.y != this.var_548)
         {
            this.var_51.x = this.var_547;
            this.var_51.y = this.var_548;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_441.sortOn("z",0 | 0);
         if(_loc5_ < this.var_441.length)
         {
            this.var_441.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_441[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2162 = this.var_668;
         this.var_2160 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_547;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_548;
                  if(_loc19_ < this.var_668 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_441.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_547;
                     _loc17_.y = _loc20_ - this.var_548;
      ...
      {
         if(param1 < 0 || param1 >= this.var_51.numChildren)
         {
            return null;
         }
         return this.var_51.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_550.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_51.numChildren)
         {
            this.var_51.addChild(_loc3_);
         }
         else
         {
            this.var_51.addChildAt(_loc3_,param2);
         }
         ++this.var_669;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         var _loc6_:* = null;
         if(param1 >= this.var_51.numChildren)
         {
            this.createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = this.var_51.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_51.removeChildAt(param1);
                  this.var_550.push(_loc4_);
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_669 || this.var_669 == 0)
         {
            _loc5_ = this.var_51.numChildren - 1;
            while(_loc5_ >= param1)
            {
               _loc3_ = this.var_51.getChildAt(_loc5_);
      ...
      {
         if(param1 < 0 || param1 >= this.var_441.length)
         {
            return null;
         }
         return this.var_441[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_235.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_235.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_235.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_235.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_547;
         param2 -= this.var_548;
         this.var_442.x = param1;
         this.var_442.y = param2;
         if(this.var_1009 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1572;
         }
         this.var_1572 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1009;
         return this.var_1572;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_668 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1573,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseClickHits(param1:Number, param2:Number, param3:Boolean, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         var _loc13_:* = [];
         var _loc14_:int = 0;
         _loc14_ = this.var_669 - 1;
         while(_loc14_ >= 0)
         {
            _loc10_ = this.var_51.getChildAt(_loc14_) as ExtendedSprite;
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_551.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_551.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2161 || param2 != this.var_2159)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_551.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_551.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_303 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_303.length)
         {
            _loc2_ = this.var_303.getKey(_loc1_);
            _loc3_ = this.var_303.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1272.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1009 == 0)
         {
            this.checkMouseHits(this.var_442.x,this.var_442.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1009 = 0;
         ++this.var_1573;
      }
