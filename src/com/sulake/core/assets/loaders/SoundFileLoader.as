package com.sulake.core.assets.loaders
{
   ...
   public class SoundFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function SoundFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this._type = param1;
         this.var_36 = new Sound(null,null);
         this.var_36.addEventListener(Event.ID3,loadEventHandler);
         this.var_36.addEventListener(Event.OPEN,loadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.var_36.removeEventListener(Event.ID3,loadEventHandler);
            this.var_36.removeEventListener(Event.OPEN,loadEventHandler);
