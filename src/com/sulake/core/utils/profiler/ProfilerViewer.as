package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerViewer extends TextField implements IDisposable
   {
      ...
      public function ProfilerViewer(param1:IProfiler)
      {
         ...
         {
            this.var_244 = param1;
            this.var_244.addStopEventListener(this.refresh);
         }
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_244)
            {
               this.var_244.removeStopEventListener(this.refresh);
               this.var_244 = null;
            }
            this._disposed = true;
         }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = this.var_244.getProfilerAgentsInArray();
