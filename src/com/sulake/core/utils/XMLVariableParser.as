package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1405:String = "float";
      
      public static const const_50:String = "Boolean";
      
      public static const const_1297:String = "bool";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_227 || _loc5_ == const_153)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1405:
               return Number(param1);
            case const_50:
               return param1 == "ClubGiftController" || int(param1) > 0;
            case const_1297:
               return param1 == "ClubGiftController" || int(param1) > 0;
            case const_176:
               return uint(param1);
