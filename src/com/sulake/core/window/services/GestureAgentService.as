package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_185:Timer;
      
      protected var var_1442:uint = 0;
      
      protected var var_260:Function;
      
      protected var var_1184:int;
      
      protected var var_1185:int;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_185 = new Timer(40,0);
            this.var_185.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_185.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1184 *= 0.75;
         this.var_1185 *= 0.75;
         if(Math.abs(this.var_1184) <= 1 && Math.abs(this.var_1185) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_260 != null)
         {
            this.var_260(this.var_1184,this.var_1185);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_185.stop();
            this.var_185.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_185 = null;
         }
         if(this._working)
         {
