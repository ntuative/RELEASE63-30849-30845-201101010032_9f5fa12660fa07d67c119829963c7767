package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_912:String = "_EXCLUDE";
      
      public static const const_1702:String = "_INCLUDE";
      
      public static const const_1792:String = "_TEMP";
      
      private static const const_1200:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1201:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var _typeStringToCodeTable:Dictionary;
      
      protected var var_1196:Dictionary;
      
      protected var var_952:Dictionary;
      
      protected var var_1447:Dictionary;
      
      protected var var_1930:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1196);
         this.var_952 = new Dictionary();
         this.var_1447 = new Dictionary();
         ParamCodeTable.fillTables(this.var_952,this.var_1447);
         this.var_1930 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1201,"");
         return param1.replace(const_1200,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1196)
            {
               delete this.var_1196[_loc1_];
            }
            for(_loc1_ in this.var_952)
            {
               delete this.var_952[_loc1_];
            }
            for(_loc1_ in this.var_1447)
            {
               delete this.var_1447[_loc1_];
            }
            this.var_1930.dispose();
            this.var_1930 = null;
            this.var_15 = null;
            this._disposed = true;
         }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = this.parseAttribute(xml,"visible",variables,visible.toString()) == "ClubGiftController";
         ...
         window = this.var_15.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child("variables")[0]),tags) as WindowController;
         ...
         background = this.parseAttribute(xml,"background",variables,window.background.toString()) == "ClubGiftController";
         blend = Number(this.parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "ClubGiftController";
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_160)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1196[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_912) == -1)
                  {
