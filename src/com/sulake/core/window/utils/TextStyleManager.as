package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_371:String = "regular";
      ...
      private static const const_554:String = "}";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_371],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_371] = _loc5_[0];
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "ClubGiftController" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_554);
         if(countSubStrings(param1,TAG_OPEN) != countSubStrings(param1,const_554))
         {
            throw new Error("Mismatching amount of \"" + TAG_OPEN + "\" versus \"" + const_554 + "\", please check the CSS!");
         }
