package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_812:String = LinkTarget.const_31;
      
      private static const const_827:Array = [LinkTarget.const_31,LinkTarget.const_1339,LinkTarget.PARENT,LinkTarget.SELF,LinkTarget.TOP];
       
      
      private var var_813:String = null;
      ...
      {
         return this.var_813 == LinkTarget.const_31 ? defaultLinkTarget : this.var_813;
      }
      ...
      override public function set text(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_35);
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("link_target",this.var_813,PropertyStruct.const_84,this.var_813 != null,const_827));
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_813 = _loc2_.value as String;
               break;
            }
         }
