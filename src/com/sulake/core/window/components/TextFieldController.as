package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_634:Boolean = false;
      ...
      {
         this.var_1190 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_20)
         {
            var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_944,var_11);
         }
         return var_20;
      }
      ...
      {
         var_15.getWindowServices().getFocusManagerService().removeFocusWindow(this);
         this.var_1181 = false;
         if(_field)
         {
            if(this.focused)
      ...
      {
         if(param1.type == WindowTouchEvent.const_464)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_634 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_15.handleError(WindowContext.const_347,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",this.var_1181,PropertyStruct.const_50,this.var_1181 != false));
         _loc1_.push(new PropertyStruct("selectable",_field.selectable,PropertyStruct.const_50,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_50,true));
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(_loc2_.key == "focus_capturer")
            {
               ...
               if(this.var_1181)
               {
                  var_15.getWindowServices().getFocusManagerService().registerFocusWindow(this);
               }
            }
            else if(_loc2_.key == "selectable")
            {
               _field.selectable = _loc2_.value as Boolean;
            }
            else if(_loc2_.key == "display_as_password")
            {
