package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1689:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_73))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_392)
         {
            this.var_392.removeEventListener(WindowEvent.const_297,this.scrollBarEventProc);
            this.var_392.removeEventListener(WindowEvent.const_233,this.scrollBarEventProc);
            this.var_392 = null;
         }
         if(this.var_1066)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1066)
         {
            this.var_1066 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_392)
         {
            ...
            if(this.var_392)
            {
               this.var_392.addEventListener(WindowEvent.const_297,this.scrollBarEventProc);
               this.var_392.addEventListener(WindowEvent.const_233,this.scrollBarEventProc);
            }
         }
         return this.var_392;
      }
      ...
      {
         if(param1.type == WindowEvent.const_297)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_233)
         {
            this.hideScrollBar();
         }
      }
      ...
      private function hideScrollBar() : void
      {
         if(this._scrollBar.visible)
         {
            ...
            this._itemList.width = var_11.width;
         }
      }
      ...
      private function showScrollBar() : void
      {
         if(this._scrollBar.visible == false)
         {
            ...
            this._itemList.width = 0 - this._scrollBar.width;
         }
      }
