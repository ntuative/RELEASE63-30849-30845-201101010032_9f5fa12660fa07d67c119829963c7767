package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      public function ItemGridController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _horizontal = param2 != WindowType.const_451;
         var_515 = true;
         if(!_horizontal)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         switch(param2.type)
         {
            ...
            case WindowMouseEvent.const_276:
               if(_horizontal)
               {
                  scrollV -= WindowMouseEvent(param2).delta * 0.01;
               }
               else
               {
                  scrollH -= WindowMouseEvent(param2).delta * 0.01;
               }
               _loc3_ = true;
         }
         return _loc3_;
      ...
      protected function resolveColumnForNextItem(param1:IWindow) : IItemListWindow
      {
         ...
         if(_loc2_ > 0)
         {
            _loc4_ = this.resolveColumnByIndex(_loc2_ > 0 ? uint(_loc2_ - 1) : uint(0));
      ...
      {
         var _loc2_:IItemListWindow = var_15.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_342,WindowStyle.const_739,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),this.listEventProc,null,numListItems,null,[WindowController.TAG_INTERNAL,WindowController.TAG_EXCLUDE]) as IItemListWindow;
      ...
      protected function offsetGridItemsForwards(param1:IWindow, param2:uint) : void
      {
         ...
         else
         {
            ...
            {
               _loc7_ = this.getGridItemAt(_loc4_);
               _loc8_ = uint(this.getRowNumberByItemIndex(_loc4_ + 1));
