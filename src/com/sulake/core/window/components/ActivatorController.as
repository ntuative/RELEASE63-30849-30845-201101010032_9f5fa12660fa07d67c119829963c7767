package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         else if(param2.type == WindowNotifyEvent.const_609)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_775;
         if(this.var_775 != param1)
         {
            if(this.var_775 != null)
            {
               if(!this.var_775.disposed)
               {
                  this.var_775.deactivate();
               }
            }
            this.var_775 = param1;
