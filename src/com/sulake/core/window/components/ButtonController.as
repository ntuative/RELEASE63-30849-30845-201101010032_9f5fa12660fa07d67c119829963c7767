package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_384:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(getChildByName(const_384));
         if(_loc2_ != null)
         {
            _loc2_.text = caption;
         }
         ...
         if(event is WindowNotifyEvent)
         {
            switch(event.type)
            {
               ...
               case WindowNotifyEvent.const_688:
                  try
                  {
                     getChildByName(const_384).blend = getChildByName(const_384).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_969:
                  type = "null";
                  break;
               case WindowTouchEvent.const_464:
                  type = "null";
            }
