package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1241:String = "_SELECTOR";
      
      private static const const_1242:String = "_CONTENT";
       
      
      protected var var_953:ITabSelectorWindow;
      
      protected var var_1942:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_953 = findChildByTag(const_1241) as ITabSelectorWindow;
            if(this.var_953 != null)
            {
               this.var_953.procedure = this.selectorEventProc;
            }
         }
         return this.var_953;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1942 = findChildByTag(const_1242) as IWindowContainer;
         }
      ...
      {
         return !!this.var_634 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_953.numSelectables;
      }
