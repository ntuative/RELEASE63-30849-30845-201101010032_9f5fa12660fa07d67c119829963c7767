package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_184:ISelectableWindow;
      
      protected var var_1932:Boolean = true;
      ...
      {
         return this.var_184 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         if(param1 != null)
         {
            if(param1 != this.var_184)
            {
               if(this.var_184 != null)
               {
                  this.var_184.unselect();
               }
               this.var_184 = param1;
               this.var_184.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_329,this,this.var_184));
               }
            }
         }
      }
