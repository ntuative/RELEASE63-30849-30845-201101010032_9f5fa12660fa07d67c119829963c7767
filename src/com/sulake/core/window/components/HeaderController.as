package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1223:String = "_CONTROLS";
      ...
      {
         return findChildByTag(const_1224) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(const_1223) as IItemListWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1126,_loc2_,true);
