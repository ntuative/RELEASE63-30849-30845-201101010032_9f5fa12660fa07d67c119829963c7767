package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1152:String = "increment";
      
      private static const const_1151:String = "decrement";
      
      private static const const_829:String = "slider_track";
      
      private static const const_546:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_626:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_153 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_539;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_19.removeEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_19.removeEventListener(WindowEvent.const_501,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_501,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_823 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_829) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_546) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_546:
               if(param2.type == WindowNotifyEvent.const_267)
               {
                  if(!this.var_993)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_431)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_276)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_626;
                  }
                  else
                  {
                     this.scrollV -= this.var_626;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_39 || param1.type == WindowTouchEvent.const_464)
         {
            ...
            else if(param2.name == const_1151)
            {
               if(this.var_19)
               {
                  this.var_993 = true;
            ...
            else if(param2.name == const_829)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_546).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_276)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_823) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_823) as IScrollableWindow;
               if(_loc1_)
               {
