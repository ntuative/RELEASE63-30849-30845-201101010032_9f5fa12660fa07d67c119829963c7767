package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1129:String = "tool_tip_caption";
      
      protected static const const_822:String = "";
      
      protected static const KEY_TOOLTIP_DELAY:String = "tool_tip_delay";
      
      protected static const const_1543:uint = 500;
      
      protected static var var_261:Array;
       
      
      protected var var_2676:uint = 0;
      
      protected var var_418:Array;
      
      protected var var_1446:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_418[0] = MouseCursorType.const_369;
         this.var_418[1] = MouseCursorType.const_31;
         this.var_418[2] = MouseCursorType.const_369;
         this.var_418[3] = MouseCursorType.const_369;
         this.var_418[4] = MouseCursorType.const_31;
         this.var_418[5] = MouseCursorType.const_31;
         this.var_418[6] = MouseCursorType.const_369;
         if(var_261 == null)
         {
            var_261 = new Array();
            var_261[0] = WindowState.const_97;
            var_261[1] = WindowState.const_76;
            var_261[2] = WindowState.WINDOW_STATE_HOVERING;
            var_261[3] = WindowState.const_61;
            var_261[4] = WindowState.const_47;
            var_261[5] = WindowState.const_80;
            var_261[6] = WindowState.const_73;
         }
      ...
      public static function processInteractiveWindowEvents(param1:IInteractiveWindow, param2:Event) : void
      {
         if(param1.toolTipCaption != const_822)
         {
            ...
            else if(param2.type != WindowMouseEvent.const_161)
            {
      ...
      {
         param2.push(new PropertyStruct(const_1129,param1.toolTipCaption,PropertyStruct.const_84,param1.toolTipCaption != const_822));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_263,param1.toolTipDelay != const_1543));
         return param2;
      }
