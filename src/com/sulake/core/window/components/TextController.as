package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1125:Dictionary = createPropertySetterTable();
      
      protected static const ZERO_RECT:Rectangle = new Rectangle();
      
      protected static const const_1537:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1539:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1538:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
       
      
      protected var _field:TextField;
      
      protected var var_773:Number;
      
      protected var var_512:Number;
      
      protected var var_511:Boolean;
      
      protected var var_77:TextMargins;
      
      protected var var_416:String = "none";
      
      protected var var_114:Boolean = false;
      
      protected var var_950:Boolean = false;
      
      private var var_366:String = "regular";
      
      private var var_196:TextStyle;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_366,this.var_196);
      ...
      private static function setAntiAliasType(param1:TextController, param2:String) : void
      {
         ...
         param1.var_196.antiAliasType = param2;
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.var_196.fontWeight = TextStyle.BOLD;
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_196.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_196.fontSize = param2;
      }
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_114)
         {
            param1.context.removeLocalizationListener(param1.var_35,param1);
            param1.var_114 = false;
         }
         param1.var_35 = param2;
         if(param1.var_35.charAt(0) == "$" && param1.var_35.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_35.slice(2,param1.var_35.indexOf("}")),param1);
            param1.var_114 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_35;
            param1.refreshTextImage();
         }
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_196.fontStyle = !!param2 ? "null" : TextStyle.NORMAL;
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc4_);
         param1.defaultTextFormat = _loc3_;
         param1.var_196.letterSpacing = param2;
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_366 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_366,param1.var_196);
            param1.refreshTextImage();
         }
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_196.textDecoration = !!param2 ? "null" : TextStyle.NONE;
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_371);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_904 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_366);
      }
      ...
      {
         this.var_773 = param1;
         this._field.scrollH = this.var_773 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_512)
         {
            this.var_512 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_512)
         {
            this.var_512 = param1;
      ...
      {
         return new Rectangle(this.var_773 * this.maxScrollH,this.var_512 * this.maxScrollV,width,height);
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         if(this.var_114)
         {
            context.removeLocalizationListener(var_35,this);
            this.var_114 = false;
         }
         var_35 = param1;
         if(var_35.charAt(0) == "$" && var_35.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_35.slice(2,var_35.indexOf("}")),this);
            this.var_114 = true;
         }
         else if(this._field != null)
         {
            this._field.text = var_35;
            this.refreshTextImage();
         }
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_773 = this.var_773;
         _loc1_.var_512 = this.var_512;
         _loc1_.var_77 = this.var_77.clone(_loc1_.setTextMargins);
         _loc1_.var_416 = this.var_416;
         _loc1_.var_114 = this.var_114;
         return _loc1_;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_511)
         {
            if(param2.type == WindowNotifyEvent.const_170)
            {
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_511 = true;
         var _loc2_:int = this.var_77.left + this.var_77.right;
         var _loc3_:int = this.var_77.top + this.var_77.bottom;
         ...
         if(_loc6_ != _loc4_)
         {
            if(this.var_416 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
            else if(this.var_416 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
            else if(this.var_416 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_416 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_366);
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_84,this.defaultTextFormat.font != _loc2_.fontFamily));
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_263,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_176,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_84,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1537));
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_50,this._field.alwaysShowSelection != false));
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_50,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_176,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_50,this._field.condenseWhite != false));
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_84,this._field.gridFitType != GridFitType.PIXEL,const_1539));
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_51,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",this._field.mouseWheelEnabled,PropertyStruct.const_50,this._field.mouseWheelEnabled != false));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_50,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_84,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_231,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_366,PropertyStruct.const_84,this.var_366 != TextStyleManager.const_371,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_231,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_50,this._field.wordWrap != false));
         ...
         _loc1_.push(new PropertyStruct("auto_size",this.var_416,PropertyStruct.const_84,this.var_416 != TextFieldAutoSize.NONE,const_1538));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_50,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_50,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_50,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_50,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_231,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
