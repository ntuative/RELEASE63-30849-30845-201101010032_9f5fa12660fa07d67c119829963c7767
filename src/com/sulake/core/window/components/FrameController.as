package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1236:String = "_HEADER";
      
      private static const const_1238:String = "_CONTENT";
      
      private static const const_1237:String = "_SCALER";
      
      private static const const_874:String = "margin_left";
      
      private static const const_873:String = "margin_top";
      
      private static const const_876:String = "margin_right";
      
      private static const const_875:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_1416:IHeaderWindow;
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1224) as ITextWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1416 = findChildByTag(const_1236) as IHeaderWindow;
            if(!this.var_1416)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_165 = findChildByTag(const_1238) as IWindowContainer;
            if(!this.var_165)
            {
      ...
      {
         return findChildByTag(const_1237) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1126,_loc2_,false);
      ...
      {
         return this.content != null && this.var_954 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_252);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_237);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_252,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_252,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_291,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_874,_loc3_.left,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_873,_loc3_.top,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_876,0 - _loc3_.right,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_875,0 - _loc3_.bottom,PropertyStruct.const_51,_loc2_));
         return _loc1_;
      }
