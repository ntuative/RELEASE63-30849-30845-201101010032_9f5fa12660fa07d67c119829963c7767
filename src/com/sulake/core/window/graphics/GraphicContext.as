package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_590:uint = 1;
      
      public static const const_944:uint = 2;
      
      public static const const_715:uint = 4;
      
      public static const const_1398:uint = 8;
      
      public static const const_1328:uint = 16;
      
      public static const const_1726:uint = 64;
      
      public static const const_1759:uint = 128;
      
      public static const const_918:uint = 256;
      
      protected static var var_519:uint = 0;
      
      protected static var var_294:uint = 0;
       
      
      protected var var_188:DisplayObjectContainer;
      
      protected var var_1923:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_944:
               ...
               break;
            case GraphicContext.const_1398:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1328:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_715:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_918:
               break;
            case GraphicContext.const_1456:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_188.numChildren > 0)
               {
                  this.var_188.removeChildAt(0);
               }
            }
            this.var_188 = null;
            while(numChildren > 0)
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_172)
            {
               this.var_172 = new Shape();
               this.var_172.visible = false;
               this.var_172.cacheAsBitmap = true;
               super.addChild(this.var_172);
            }
            this.var_172.graphics.clear();
            this.var_172.graphics.beginFill(255);
            this.var_172.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_172.graphics.endFill();
            this.getDisplayObject().mask = this.var_172;
         }
         else if(this.var_172)
         {
            super.removeChild(this.var_172);
            this.var_172.graphics.clear();
            this.var_172 = null;
         ...
         if(this.var_774)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_294 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1923,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1923,16777215);
                  }
                  var_294 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_774)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_294 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_188 == null)
         {
            this.var_188 = new Sprite();
            this.var_188.name = this.name + " - Child Container";
            this.var_188.mouseEnabled = false;
            addChild(this.var_188);
         }
         return this.var_188;
      }
      ...
      {
         return this.var_188 != null ? int(this.var_188.numChildren) : 0;
      }
