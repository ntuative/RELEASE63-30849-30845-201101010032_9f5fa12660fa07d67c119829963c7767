package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_861:uint = 1;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1392 = 4294967295;
         this.var_915 = 0;
         this.var_1786 = new ColorTransform();
         this.var_949 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_860) : uint(const_555);
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_861)
               {
                  ...
                  if(this.var_601)
                  {
                     ...
                     _loc7_.draw(param1,this.var_96,this.var_96.rect,this.var_915,false);
                  ...
                  {
                     this.var_949.tx = param2.x;
                     this.var_949.ty = param2.y;
                     this.var_1786.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_96,this.var_949,this.var_1786,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc2_ = this._skinContainer.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_264);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1392;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_475:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  _loc4_ = true;
               }
               ...
               break;
            case WindowRedrawFlag.const_1069:
               this.var_915 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_915 != this.var_1392)
               {
                  this.var_601 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1057:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_601 = true;
                  _loc4_ = true;
