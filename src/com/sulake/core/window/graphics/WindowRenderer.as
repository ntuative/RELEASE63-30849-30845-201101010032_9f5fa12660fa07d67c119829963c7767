package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1672:Point;
      
      private var var_1326:Rectangle;
      
      private var var_276:Rectangle;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_312:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_690 = new Array();
         this.var_1672 = new Point();
         this.var_1326 = new Rectangle();
         this.var_276 = new Rectangle();
         this.var_312 = new Dictionary(true);
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_690 = null;
            for(_loc1_ in this.var_312)
            {
               delete this.var_312[_loc1_];
            }
            this.var_312 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_276.x = param2.x - param1.x;
            this.var_276.y = param2.y - param1.y;
            this.var_276.width = param2.width;
            this.var_276.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  this.var_276.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_276,WindowRedrawFlag.const_965);
            if(this.var_690.indexOf(param1) == -1)
            {
               this.var_690.push(param1);
            }
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            this.addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_72);
         }
      }
      
      protected function getWindowRendererItem(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = this.var_312[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_312[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_312[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_583,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_583,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_312[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_312[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_690.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_690.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_276.x = _loc3_.dirty.x;
               this.var_276.y = _loc3_.dirty.y;
               this.var_276.width = _loc3_.dirty.width;
               this.var_276.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_276,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1672,this.var_1326))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1672,this.var_1326))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_32))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1326);
