package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_886:uint = 8;
      
      private static const const_1253:String = "skin";
      
      private static const const_1250:String = "bitmap";
      
      private static const const_1255:String = "fill";
      
      private static const const_1252:String = "text";
      
      private static const const_1249:String = "shape";
      
      private static const const_1254:String = "unknown";
      
      private static const const_1251:String = "com.sulake.habbo.session.furniture";
      ...
      private var var_936:Dictionary;
      
      private var var_504:Dictionary;
      
      private var var_1867:Dictionary;
      
      private var var_2652:Dictionary;
      
      private var var_2650:Dictionary;
      
      private var var_2651:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_936 = new Dictionary();
         this.var_1867 = new Dictionary();
         this.var_2652 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1867,this.var_2652);
         this.var_2650 = new Dictionary();
         this.var_2651 = new Dictionary();
         StateCodeTable.fillTables(this.var_2650,this.var_2651);
         this.var_504 = new Dictionary();
         this.var_504[const_1253] = BitmapSkinRenderer;
         this.var_504[const_1250] = BitmapDataRenderer;
         this.var_504[const_1255] = FillSkinRenderer;
         this.var_504[const_1252] = TextSkinRenderer;
         this.var_504[const_1249] = ShapeSkinRenderer;
         this.var_504[const_1254] = SkinRenderer;
         this.var_504[const_1251] = NullSkinRenderer;
         if(var_295 == null)
         {
            var_295 = new Array();
            var_295.push(WindowState.const_61);
            var_295.push(WindowState.const_73);
            var_295.push(WindowState.const_80);
            var_295.push(WindowState.const_47);
            var_295.push(WindowState.WINDOW_STATE_HOVERING);
            var_295.push(WindowState.const_76);
            var_295.push(WindowState.const_97);
            var_295.push(WindowState.const_88);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "ClubGiftController" : false;
                  ...
                  this.addSkinRenderer(this.var_1867[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_937[param1] = new Array(const_886);
         }
         this.var_937[param1][param2] = param3;
         if(this.var_936[param1] == null)
         {
            this.var_936[param1] = new Array(const_886);
         }
         this.var_936[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_937[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_936[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_264)
