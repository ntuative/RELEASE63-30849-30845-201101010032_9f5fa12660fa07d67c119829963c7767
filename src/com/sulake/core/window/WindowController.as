package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1126:String = "_COLORIZE";
      
      protected static const const_1540:String = "_IGNORE_INHERITED_STYLE";
      ...
      protected var var_627:Function;
      
      protected var var_153:Boolean = true;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!this.var_20)
         {
            this.var_20 = this.getGraphicContext(!testParamFlag(WindowParam.const_32));
         }
         this._events = new EventDispatcher(this);
         this._children = new Array();
         this.var_308 = new Rectangle();
         if(_loc12_ != null)
         {
            var_354 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_56 = var_354.clone();
            var_11 = var_354.clone();
         ...
         if(_loc13_)
         {
            var_715 = _loc13_.blend;
            var_414 = _loc13_.treshold;
            if(var_413 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_216 != _loc13_.color)
            {
      ...
      public static function expandToAccommodateChild(param1:WindowController, param2:IWindow) : void
      {
         ...
         if(_loc8_)
         {
            _loc9_ = param1.getParamFlag(WindowParam.const_62);
            param1.setParamFlag(WindowParam.const_62,false);
            ...
            if(_loc9_)
            {
               param1.setParamFlag(WindowParam.const_62,true);
            }
         }
      }
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         var _loc11_:Boolean = param1.getParamFlag(WindowParam.const_62);
         if(param2)
         {
            _loc3_ = 0;
      ...
      {
         return this.var_627 != null ? this.var_627 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_413 = param1;
         var_216 = !!var_413 ? uint(var_216 | var_510) : uint(var_216 & 16777215);
         this.var_153 = this.var_153 || param1;
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_72);
      }
      ...
      {
         var_769 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_403,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_510 = param1 & 4278190080;
         var_216 = !!var_413 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_72);
      }
      ...
      {
         var_510 = param1 << 24;
         var_216 = !!var_413 ? uint(var_510 | var_216) : uint(16777215 & var_216);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_72);
      }
      
      public function set blend(param1:Number) : void
      {
         var_715 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_1057);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_454,this,null));
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_76 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_531,this,null));
         }
      }
      ...
      {
         var_414 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_308 = this._parent.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
            ...
            else
            {
               this.var_308.x = 0;
               this.var_308.y = 0;
               this.var_308.width = 0;
               this.var_308.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_973,this,_loc2_));
            }
         }
      }
      ...
      {
         return this.var_20 != null || !testParamFlag(WindowParam.const_32);
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_590,var_11);
            this.var_20.visible = var_353;
         }
         return this.var_20;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_76,var_18,var_15,var_11,null,this.var_627,this.properties,var_770.concat(),_id) as WindowController;
         _loc2_.var_414 = var_414;
         _loc2_.var_153 = this.var_153;
         _loc2_._debug = this._debug;
         _loc2_.var_308 = this.var_308.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_354 = var_354.clone();
         _loc2_.var_56 = var_56.clone();
         _loc2_.var_130 = !!var_130 ? var_130.clone() : null;
         _loc2_.var_129 = !!var_129 ? var_129.clone() : null;
         _loc2_.var_70 = !!var_70 ? var_70.clone(_loc2_) : null;
         _loc2_.var_15 = var_15;
         _loc2_.var_216 = var_216;
         _loc2_.var_510 = var_510;
         _loc2_.var_769 = var_769;
         _loc2_.var_353 = var_353;
         _loc2_.var_715 = var_715;
         _loc2_.var_18 = var_18;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_35;
         _loc2_.background = var_413;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2252 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_15.invalidate(this,param1,WindowRedrawFlag.const_72);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_504)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_508)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_18 & 0);
            if(_loc7_ == WindowParam.const_516)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_410)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1074,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_732,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_491,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_170,this,null));
            }
         }
      }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_130 != null)
         {
            param3.x = var_130.x;
            param3.y = var_130.y;
            param3.width = var_130.width;
            param3.height = var_130.height;
         }
         if(param4 != null && var_129 != null)
         {
            param4.x = var_129.x;
            param4.y = var_129.y;
            param4.width = var_129.width;
            param4.height = var_129.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            if(var_129 == null)
            {
               var_129 = new Rectangle();
            }
            var_129.x = param3.x;
            var_129.y = param3.y;
            var_129.width = param3.width;
            var_129.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            if(var_130 == null)
            {
               var_130 = new Rectangle();
            }
            var_130.x = param2.x;
            var_130.y = param2.y;
            var_130.width = param2.width;
            var_130.height = param2.height;
         }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_698))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_39:
                  ...
                  _loc4_.begin(this);
                  _loc4_.eventTypes.push(WindowMouseEvent.const_55);
                  _loc4_.areaLimit = MouseListenerType.const_1029;
                  if(testParamFlag(WindowParam.const_351))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        ...
                        {
                           var_15.getWindowServices().getMouseDraggingService().begin(_loc3_);
                           break;
                        }
                  ...
                  if((var_18 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        ...
                        {
                           var_15.getWindowServices().getMouseScalingService().begin(_loc3_,var_18 & 0);
                           break;
                        }
                        _loc3_ = _loc3_.parent;
                     }
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_170:
                  var_15.invalidate(this,var_11.union(var_56),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_424,this,null));
                     if(testParamFlag(WindowParam.const_160,WindowParam.const_158))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_187,WindowParam.const_150))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc9_ = uint(var_18);
                        var_18 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_443))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_468))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_18 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.WINDOW_NOTIFY_CHILD_RESIZED,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_491:
                  var_15.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_475);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1052,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_267,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_380:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_609,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_206,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_454:
                  var_15.invalidate(this,var_11,WindowRedrawFlag.const_1069);
                  break;
               case WindowNotifyEvent.const_531:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1540) == -1)
                     {
                        _loc8_.style = var_76;
                     }
                  }
               ...
               case WindowNotifyEvent.const_403:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        var_15.invalidate(this,var_11,WindowRedrawFlag.const_475);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_424:
                  this._parent.getRegionProperties(null,this.var_308);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_338:
                  if(testParamFlag(WindowParam.const_62))
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_380:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1112:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1387:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1447:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_809:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_724:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_403:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_609:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_206:
               _loc2_ = "null";
         ...
         if(_loc2_ == WindowEvent.const_144)
         {
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_414);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_414);
      }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc8_:Boolean = this.getParamFlag(WindowParam.const_62);
         ...
         if(_loc7_)
         {
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_62,false);
            }
            ...
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_62,true);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_132,WindowParam.const_158);
         var _loc2_:* = !testParamFlag(WindowParam.const_124,WindowParam.const_150);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_308.width;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.WINDOW_PARAM_RELATIVE_HORIZONTAL_SCALE_STRECH)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_340)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_160)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_308.height;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_325)
               {
      ...
      {
         if(_state == WindowState.const_471)
         {
            return true;
         }
         _state = WindowState.const_471;
         ...
         _loc1_.type = WindowNotifyEvent.const_1027;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_61,true);
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_936,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1062,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         }
         this.setStateFlag(WindowState.const_61,false);
         _loc1_.type = WindowNotifyEvent.const_1047;
         this.update(this,_loc1_);
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1058,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_380;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1112,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         if(this.getStateFlag(WindowState.const_61))
         {
            return true;
         }
         ...
         this.setStateFlag(WindowState.const_61,true);
         _loc1_.type = WindowNotifyEvent.const_1039;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_688;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_974,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_998,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_941;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1046 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_338,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1046 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_718,this,param1));
         return param1;
      }
