package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_383:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_1612:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_923:uint = 4;
      ...
      private var var_462:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_462 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_462.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_462.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1183 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1183);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1442 & const_923)
         {
            if(_loc3_ == 0)
            {
               if(this.var_462.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_855 = false;
            this._events.dispatchEvent(new LockEvent(const_383,this));
         }
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_462.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_462.getStructByIndex(_loc8_);
