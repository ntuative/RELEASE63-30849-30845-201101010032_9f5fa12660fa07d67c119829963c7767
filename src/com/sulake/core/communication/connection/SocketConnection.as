package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1458:int = 10000;
      ...
      private var var_482:ByteArray;
      
      private var var_1092:IEncryption;
      
      private var var_709:IProtocol;
      
      private var _id:String;
      
      private var var_1091:IMessageClassManager;
      
      private var var_262:ICoreCommunicationManager;
      
      private var var_481:IConnectionStateListener;
      
      private var var_331:Timer;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_262 = param2;
         this.var_482 = new ByteArray();
         this.var_1091 = new MessageClassManager();
         this.var_75 = new Socket();
         this.var_331 = new Timer(const_1458,1);
         this.var_331.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_481)
         {
            this.var_481.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_331.start();
         this.var_708 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1091.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_709.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_481)
         {
            this.var_481.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1092 != null)
         {
            _loc3_ = this.var_1092.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1091.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_709.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_709.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1092 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_709.getMessages(this.var_482,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_481)
               {
                  this.var_481.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1091.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_482,offset);
               this.var_482 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_482.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_482.writeByte(this.var_75.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_331.stop();
         this.var_1743 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_708));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1743 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_708));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_708));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_708));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_708));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_708));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_331.delay + " ms). Possible Firewall.";
