package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         this.var_145 = new ByteArray();
         this.var_109 = 0;
         while(this.var_109 < this.psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = this.var_109++;
            this.var_145[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            this.var_145[_loc4_ = this.var_109++] = _loc2_ & 255;
         }
         this.var_109 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         this.var_145[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_109++;
         this.var_145[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_145[_loc4_ = this.var_109++] = this.var_145[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_145[_loc5_ = this.var_109++] = this.var_145[_loc5_] ^ param1 >> 24 & 255;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_145[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         this.var_145.length = 0;
         this.var_145 = null;
