package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_17:String = "client.init.start";
      ...
      public static const const_12:String = "error_ctx";
      
      public static const const_19:String = "flash_version";
      
      public static const const_16:String = "avg_update";
      
      public static const const_18:String = "debug";
      ...
      public static const const_9:String = "byteBarSprite";
      
      public static const const_5:String = "background";
      
      public static const const_4:String = "habboLogo";
      
      public static const const_10:String = "textField";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_18] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
      ...
      private function onPreLoadingCompleted(param1:Event) : void
      {
         ...
         catch(error:Error)
         {
            ...
            reportCrash("Failed to finalize main swf preloading: " + error.message,const_6,error);
         }
      }
      ...
      {
         trackLoginStep(const_8);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + this.var_8,const_6,null);
      }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc10_:Sprite = _loc9_.getChildByName(const_9) as Sprite;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
      ...
      private function positionLoadingScreenDisplayElements(param1:DisplayObjectContainer) : void
      {
         ...
         var _loc5_:TextField = param1.getChildByName(const_10) as TextField;
         if(_loc5_)
         {
